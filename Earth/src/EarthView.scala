...
case class EarthView (latLong: LatLong, scale: Metre, up: Boolean)
...
object EarthView
{
  ...
  implicit object EarthViewPersist extends Persist3[LatLong, Double, Boolean, EarthView]("EarthView", "latLong", _.latLong,
    "scale", _.scale.metres / 1000, "up", _.up, (ll: LatLong, d: Double, b: Boolean) => EarthView(ll, Metre(d * 1000), b))
}