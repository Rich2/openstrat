...
{ val liverpool: LatLong = 53.44 ll -3.02
  ...
  val polygonLL: PolygonLL = PolygonLL(liverpool, chepstow, nashPoint, stDavids, aberaeron, criccieth, mynydd, anglesey)
}
...
object England extends EArea2("England",  52.73 ll -1.26, plain)
{
  ...
  val polygonLL: PolygonLL = PolygonLL(penzance, trevoseHead, nwDevon, parrettMouth, Wales.chepstow,  Wales.liverpool,  kentMouth, sBarrow,
     stBeesHead, Scotland.solwayMouth, Scotland.tyneMouth, scarborough, flamborough, holbeach, ouseMouth, hunstanton, cromer, horsey, lowestoft, foulness, nwGrain,
     nekent, dover, dungeness, beachyHead, ventnor, bournemouth, swanage, ePortland, charmouth, exeMouth, startPeninsular, stAustell, lizard)
