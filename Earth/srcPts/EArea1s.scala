...
object AmericasFarNorth extends EArea1("Far North\nAmerica", 61 ll -109)
{
  ...
  override val a2Arr: RArr[EArea2] = lakes ++
    RArr(Alaska, NorthWestCanada, NorthWestCanada, GreatBearLake, GreatSlaveLake, Nunavut, SouthWestCanada, CentralCanada, BanksIsland, MelvilleIsland, VictoriaIsland, PrinceWalesIsland,
