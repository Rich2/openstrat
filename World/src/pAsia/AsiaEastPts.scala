...
{ val binhai = AsiaWestPts.persiaN ll 117.66
  ...
  val seAsia: WldArea2 = WldArea2("SEAsia", degs(20.0, 104.0), plain, binhai, rongcheng, haitzhou, putuo, longhai, hongKong, xuwen,
  ...
  val ceAsia: WldArea2 = WldArea2("CEAsia", degs(47, 115), plain, khabarovsk, chongpyong, busan, jindo, ryongyon, jinzhou, binhai,
  ...
  val neAsia: WldArea2 = WldArea2("NEAsia", degs(64, 113), taiga, krasnoyarsk, bukhta, ustYansky, okhotsky, khabarovsk,
  ...
  val feAsia: WldArea2 = WldArea2("FEAsia", degs(66.22,159.68), taiga, ustYansky, sakha, iultinsky, eSiberia, seProvidensky, sKamchatka,
  ...
  val japan: WldArea2 = WldArea2("Japan", degs(36.28, 138.71), plain, sKyshu, neKyushu, kashiwazaki, nHokaido, eHokaido, choshi)
}