...
{ /** South West Turkey */
  ...
  val arabia: WldArea2 = WldArea2("Arabia", degs(25, 45.0), desert, Anatolia.damascus, alFaw, salwa, nQatar, doha, alGharbia, icad, kumzar,
     alKhaburah, eOman, mirbat, dhahawnMouth, haswayn, sYemen, sharmas, Anatolia.eilat)
   
  val mahshahr = 30.22.north * Caucasus.asiaMinorE

  val iraq: WldArea2 = WldArea2("Iraq", 34.0 ll 44.5, desert, Anatolia.damascus, Anatolia.cizre, Caucasus.caspianSW, mahshahr, alFaw)
  ...
  val persia: WldArea2 = WldArea2("Persia", degs(32.4, 60), hills, mahshahr, Caucasus.caspianSW, caspianSE, persiaCaspianN, persiaNE,
  ...
  val kazak: WldArea2 = WldArea2("Kazak", degs(47, 60), plain, RusNorth.kazakNE, persiaNE, persiaCaspianN, kendirliBay, bautino, mangystau,
     caspianNE, caspianN, volodarsky, Ukraine.caspianW, Baltland.southEast)
  
  val caspianSea: WldArea2 = WldArea2("CaspianSea", degs(42.10, 50.64), sea, caspianN, caspianNE, persiaCaspianN, caspianSE,
     Caucasus.caspianSW)
  ...
  val india: WldArea2 = WldArea2("India", degs(20.85, 78.68), jungle, mianiHor, indiaNE, indiaNE, magdhara, balasore, ongale, kattupali,
  ...
  val sriLanka: WldArea2 = WldArea2("SriLanka", 7.47 ll 80.78, jungle, dodanduwa, wSriLanka, nwSrilanka, neSrilanka, oiluvil, dondra)
   
  val cAsiaSE = AsiaWestPts.persiaN * RusNorth.indiaE

   val himalayas: WldArea2 = WldArea2("Himalayas", degs(32, 75), mtain, cAsiaSE, AsiaWestPts.persiaNE, AsiaWestPts.mianiHor,
      AsiaWestPts.indiaNE)
