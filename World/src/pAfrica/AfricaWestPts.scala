...
{ val southLine = 17.north
  ...
  val latLongs: LatLongs = LatLongs(southWest, nouakchott,nouadhibouBay, nouadhibou, nou2, boujdour, agadir, rabat, tangierW, ceuta, alHoceima, tunis,
...
{ //val wAfricaE = 16.75.east
  ...
  val latLongs: LatLongs = LatLongs(cAfricaNW, sangana, aiyetoro, capeThreePoints, liberia, sierraLeone, dakar, keurMassene, SaharaWest.southWest,
