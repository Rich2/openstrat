...
object AfricaSouthern extends WldArea1("AfricaSouthern", -16.14 ll 24.36)
{
  ...
  override val a2Arr: Arr[WldArea2] = Arr(sAfrica, cAfrica, sEAfrica, madagascar)
...
{ val cAfricaN = 4.42.north
  ...
  val madagascar = WldArea2("Madagascar", degs(-19.42, 46.57), plain, madagascarN, madagascarE, madagascarSE, madagascarS, tambohorano)
}