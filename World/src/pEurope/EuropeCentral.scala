...
object Alpsland extends WldArea2("Alpsland", 45.93 ll 10.49, mtain)
{
...
object Italy extends WldArea2("Italy", 42.25 ll 13.39, plain)
{  
...
object Corsica extends WldArea2("Corsica", 42.18 ll 9.17, hills)
{   
...
object Sardina extends WldArea2("Sardina", 40.12 ll 9.07, hills)
{
   ...
   val latLongs = LatLongs(calaCaterina, perdaLonga, capoTeulada, portscuso, capoFalcone, platamona, north, east)   
}
