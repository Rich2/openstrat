...
object EuropeSW extends WldArea1("EuropeSw", 20 ll 0)
{//top = 45.59N * 2 - 46.21 = 44.97
  //override def fill = false
  override val a2Arr: Arr[WldArea2] = Arr(FranceSouth, Iberia, Sardina, Italy, Corsica)
...
object FranceSouth extends WldArea2("FranceSouth", 44.54 ll 2.53, plain)
{
...
object Iberia extends WldArea2("Iberia", 41 ll -3.5, hills)
{
