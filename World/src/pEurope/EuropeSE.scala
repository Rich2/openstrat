...
{       
   ...
   val latLongs = LatLongs( Balkans.istanbul, sinopeN, surmene, cizre, damascus,
...
{   
   ...
   val latLongs = LatLongs(Anatolia.surmene, blackSeaE, Ukraine.asiaMinorNM, Ukraine.caspianW,
         sumqayit, baku, sangachal, caspianSW, Anatolia.cizre)   
}
