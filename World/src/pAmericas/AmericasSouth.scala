...
{      
   ...
   val fSAmerica = WldArea2("FSAmerica", degs(-33.51, -65.36), plain, sChile, sSAmericaNW, nwSAmericaES, sSAmericaNE,
   ...
   val wSAmerica = WldArea2("WSAmerica", degs(-10.42, -47.78), jungle,
