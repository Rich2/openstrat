...
object AmericasSouth extends WldArea1("SAmericas", -6.52 ll -62.28)
{ val swArgentine = -54.28 ll -65.06
  ...
  val fSAmerica: WldArea2 = WldArea2("FSAmerica", degs(-33.51, -65.36), plain,
  ...
  val wSAmerica: WldArea2 = WldArea2("WSAmerica", degs(-10.42, -47.78), jungle,
  ...
  val eSAmerica = WldArea2("ESAmerica", degs(-2.04, -70.81), jungle, nwSAmericaEN, nAmapa, amazonMouthS, paraiba, sSAmericaNE, nwSAmericaES)
   
  override val a2Arr: Arr[WldArea2] = Arr(fSAmerica, wSAmerica, eSAmerica)
}