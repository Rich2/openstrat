...
{   
   ...
   val cAfrica =  Area2('CAfrica, -7 ll 25, jungle, sAfricaNW, baiaFarta, luanda, wAfricaEquator, bouemba,
         AfricaMidWest.cAfricaNW, AfricaMidWest.southEast, AfricaNorthEast.cAfricaNE, katongaMouth, lakeVictoriaSW, cAfricaSE)   
   ...
   val sEAfrica = Area2('SEAfrica, -2.17 ll 36.64, plain,
         cAfricaSE, lakeVictoriaSW, lakeVictoriaSE, lakeVictoriaE, lakeVictoriaN, katongaMouth, AfricaNorthEast.cAfricaNE,
               AfricaNorthEast.southEast, eAfricaEquator, mombassa, seNacala, sAfricaNE)
   ...
   val sAfrica = Area2('SAfrica, -25 ll 24, plain, agulhas, capeTown, nNamibia, sAfricaNW, cAfricaSE, sAfricaNE,
         beira, inhambane, maputo, richardsBay, portLiz) 
