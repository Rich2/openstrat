...
{ 
  ...
  gs(4, 4, WheatField * 2)
  gs(2, 6, WheatField)  
  placeSquads((Germany, 18, 6), (Germany, 30, 6), (Britain, 10, 10))
  val g1 = placeSquad(Germany, 38, 6)
  g1.setMove(40 cc 8, 42 cc 10)
  val g2 = placeSquad(Britain, 22, 10)
  g2.setMove(20 cc 8, 18 cc 6, 16 cc 4)
  val b1 = placeSquad(Britain, 30, 10)
  b1.action = Fire(22 cc 14)
}