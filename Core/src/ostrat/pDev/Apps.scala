...
object Apps
{
  val theMap: Map[Int, (CanvasPlatform => Unit, String)] = Map(
      ...
      (31, (learn.LessonA1(_), "ScalaFx Demonstration Canvas 1")),
      ...
      (51, (learn.LessonC1(_), "ScalaFx Demonstration Interactive Canvas 1")),
      ...
      (55, (learn.LessonC6(_), "ScalaFx Demonstration Interactive Canvas 6")),
  )
