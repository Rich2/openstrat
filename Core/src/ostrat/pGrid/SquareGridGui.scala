...
abstract class SquareGridGui[TileT <: GridElem, SideT <: GridElem, GridT <: SquareGrid[TileT, SideT]](
      val canv: pCanv.CanvasPlatform, val grid: GridT) extends TileGridGui[TileT, SideT, GridT]
{
   ...
   def ofSTilesDisplayFold(f: OfSquareReg[TileT, SideT, GridT] => Disp2): Disp2 = ofSTilesFold[Disp2](f, _ ++ _, Disp2.empty)
} 