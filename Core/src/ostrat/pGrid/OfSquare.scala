...
trait OfSquare[TileT <: Tile, SideT <: Side, GridT <: SquareGrid[TileT, SideT]] extends OfTile[TileT, SideT, GridT]
{
...
case class OfSquareReg[TileT <: Tile, SideT <: Side, GridT <: SquareGrid[TileT, SideT]](tile: TileT, grid: GridT, gGui: TileGridGui[TileT, SideT, GridT])
extends OfSquare[TileT, SideT, GridT] with OfTileReg[TileT, SideT, GridT]

object OfSquareReg
{
   implicit def implicitBuilder[TileT <: Tile, SideT <: Side, GridT <: SquareGrid[TileT, SideT]]
