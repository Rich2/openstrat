...
{ def typeSym: Symbol
  ...
  def persist[T1](v1: T1)(implicit ev1: Persist[T1]): String = typeStr + ev1.persist(v1).enParenth
  ...
  def persist4[T1, T2, T3, T4](v1: T1, v2: T2, v3: T3, v4: T4)(implicit ev1: Persist[T1], ev2: Persist[T2], ev3: Persist[T3], ev4: Persist[T4]): String =
    typeStr + ev1.persist(v1).semicolonAppend(ev2.persist(v2), ev3.persist(v3), ev4.persist(v4)).enParenth
