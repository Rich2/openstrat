...
<br>libraryDependencies += "com.richstrat" % "rutil" % "0.4.0"
<br>libraryDependencies += "com.richstrat" % "geom" % "0.4.0"
<br>libraryDependencies += "com.richstrat" % "geomfx" % "0.4.0"
<br>libraryDependencies += "com.richstrat" % "tiling" % "0.4.0"
<br>libraryDependencies += "com.richstrat" % "egrid" % "0.4.0"
<br>libraryDependencies += "com.richstrat" % "rutiljs" % "0.4.0"
<br>libraryDependencies += "com.richstrat" % "geomjs" % "0.4.0"
<br>libraryDependencies += "com.richstrat" % "geomfx" % "0.4.0"
