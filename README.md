...
<p>Scala currently set to 3.5.0 Jdk 11+, 21 preferred. Scala.Js set to 1.16.0 Scala Native set to 0.4.16 Sbt currently set to 1.10.1 Git Bash. Update your Mill
  to 0.11.6</p>
