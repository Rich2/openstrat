...
<p>Scala currently set to 3.2.1. Jdk 11+, 11 preferred. Scala.Js set to 1.13.0. Scala Native set to 0.4.7. Sbt currently set to 1.8.2, Sbt will not work running on Windows in
