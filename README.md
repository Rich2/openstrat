...
Scala currently set to 2.13.1. Scala.Js set to 0.6.29. Sbt currently set to 1.3.2 (uses the build.sbt file). Update your Mill to 0.5.1 (uses the build.sc file). Run:
