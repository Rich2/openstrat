...
<p>Scala currently set to 3.6.2 Jdk 11+, 21 preferred. Scala.Js set to 1.18.1 Scala Native set to 0.5.6 Sbt currently set to 1.10.7 Git Bash. Update your Mill
  to 0.12.5</p>
