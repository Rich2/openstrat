...
<p>Scala currently set to 3.2.1. Jdk 11+, 11 prefered. Scala.Js set to 1.10.1. Scala Native set to 0.4.7. Sbt currently set to 1.8.0, Sbt will not work running on Windows in
