...
<p>Scala currently set to 3.1.3. Jdk 11+, 11 prefered. Scala.Js set to 1.10.1. Scala Native set to 0.4.7. Sbt currently set to 1.7.1, Sbt will not work running on Windows in
