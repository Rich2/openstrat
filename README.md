...
Modified on my laptop from new clone.
...
Scala currently set to 2.12.8, except for Scala-native build set to 2.11.12. Sbt currently set to 1.2.7. Update your Mill to 0.3.5. Run:
