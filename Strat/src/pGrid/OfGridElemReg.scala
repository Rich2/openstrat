...
trait OfGridElemReg[TileT <: TileOld, SideT <: TileSideOld, GridT <: TileGridReg[TileT, SideT]] extends OfGridElem[TileT, SideT, GridT]
{
...
trait OfTileReg[TileT <: TileOld, SideT <: TileSideOld, GridT <: TileGridReg[TileT, SideT]] extends OfTile[TileT, SideT, GridT] with
...
trait OfSideReg[TileT <: TileOld, SideT <: TileSideOld, GridT <: TileGridReg[TileT, SideT]] extends OfSide[TileT, SideT, GridT] with
OfGridElemReg[TileT, SideT, GridT]
{
   def sideCen: Vec2
}