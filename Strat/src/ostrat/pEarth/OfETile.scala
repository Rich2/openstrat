...
trait OfEElem[TileT <: Tile, SideT <: GridElem] extends OfGridElem[TileT, SideT, EGrid[TileT, SideT]]
{
   val eg: EarthGui
...
class OfETile[TileT <: Tile, SideT <: GridElem](val eg: EarthGui, val eGrid: EGrid[TileT, SideT], val tile: TileT) extends
...
class OfESide[TileT <: Tile, SideT <: GridElem](val eg: EarthGui, val eGrid: EGrid[TileT, SideT], val side: SideT) extends
