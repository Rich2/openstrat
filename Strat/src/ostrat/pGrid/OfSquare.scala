...
trait OfSquare[TileT <: GridElem, SideT <: GridElem, GridT <: SquareGridComplex[TileT, SideT]] extends OfTile[TileT, SideT, GridT]
{
...
case class OfSquareReg[TileT <: GridElem, SideT <: GridElem, GridT <: SquareGridComplex[TileT, SideT]](
...
object OfSquareReg
{
   implicit def implicitBuilder[TileT <: GridElem, SideT <: GridElem, GridT <: SquareGridComplex[TileT, SideT]]
