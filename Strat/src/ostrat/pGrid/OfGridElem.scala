...
trait OfGridElem[TileT <: Tile, SideT <: GridElem, GridT <: TileGrid[TileT, SideT]]
{ def grid: GridT
  def cood: Cood   
...
trait OfTile[TileT <: Tile, SideT <: GridElem, GridT <: TileGrid[TileT, SideT]] extends OfGridElem[TileT, SideT, GridT]
{ def tile: TileT    
...
trait OfSide[TileT <: Tile, SideT <: GridElem, GridT <: TileGrid[TileT, SideT]] extends OfGridElem[TileT, SideT, GridT]
{ def side: SideT    
