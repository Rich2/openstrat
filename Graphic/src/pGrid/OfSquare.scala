...
trait OfSquare[TileT <: Tile, SideT <: TileSide, GridT <: SquareGridOld[TileT, SideT]] extends OfTile[TileT, SideT, GridT]
{
   ...
   override def ownSideLines: ArrOld[Line2] = ArrOld(sideUpLine, sideRightLine)
}

case class OfSquareReg[TileT <: Tile, SideT <: TileSide, GridT <: SquareGridOld[TileT, SideT]](tile: TileT, grid: GridT,
    gGui: TileGridGui[TileT, SideT, GridT]) extends OfSquare[TileT, SideT, GridT] with OfTileReg[TileT, SideT, GridT]

object OfSquareReg
{
   implicit def implicitBuilder[TileT <: Tile, SideT <: TileSide, GridT <: SquareGridOld[TileT, SideT]]
