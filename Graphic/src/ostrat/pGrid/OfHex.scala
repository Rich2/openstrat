...
trait OfHex[TileT <: Tile, SideT <: TileSide, GridT <: HexGrid[TileT, SideT]] extends OfTile[TileT, SideT, GridT]
{
   ...
   override def ownSideLines: ArrOld[Line2] = Arr(sideURLine, sideRightLine, sideDRLine)
}
...
case class OfHexReg[TileT <: Tile, SideT <: TileSide, GridT <: HexGridReg[TileT, SideT]](tile: TileT, grid: GridT,
...
object OfHexReg
{
   implicit def implicitBuilder[TileT <: Tile, SideT <: TileSide, GridT <: HexGridReg[TileT, SideT]](tile: TileT, grid: GridT,
