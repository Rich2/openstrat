...
trait CanvasTopLeft extends CanvasPlatform
{
  ...
  final override def circleFillOld(cf: CircleFill): Unit = tlCircleFillOld(cf.reflectX.slate(width / 2, height / 2))
  ...
  protected[this] def tlCircleFillOld(cf: CircleFill): Unit
