...
{ override def getTime: Long = 0
  override protected def tlPolyFill(poly: PolygonClass, colour: Colour): Unit = {}
  override protected def tlPolyDraw(poly: PolygonClass, lineWidth: Double, colour: Colour): Unit = {}
...
//   override protected def tlCircleFill(x: Double, y: Double, radius: Double, colour: Colour): Unit = {}
   ...
   override protected def tlClip(pts: PolygonClass): Unit = {}
