...
trait PolyCurveElem extends GraphicFullElem with DisplayBoundedFull
{ type SimerT <: PolyCurveElem
  def shape: PolyCurve
...
{ override type SimerT = PolyCurveFill
...
{ override type SimerT = PolyCurveDraw
...
{ override type SimerT = PolyCurveFillDraw
...
{ override type SimerT = PolyCurveFillDrawText
...
{ override type SimerT = PolyCurveAll
