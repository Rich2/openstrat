...
final case class CArcDraw(arc: CArc, lineWidth: Double = 2.0, lineColour: Colour = Black) extends DisplayElem with TransSimElem
{ type ThisT = CArcDraw
  ...
  def cenText: TextGraphic = TextGraphic(clkStr, 10, arc.pCen, lineColour)
