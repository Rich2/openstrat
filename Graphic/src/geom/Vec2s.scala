...
class Vec2s(val arrayUnsafe: Array[Double]) extends AffinePreserve with Vec2sLikeProdDbl2 with ArrProdDbl2[Vec2]
{ type ThisT = Vec2s
  //type ThisT = Vec2s
  ...
  @inline def toPolygon: Polygon = new Polygon(arrayUnsafe)
