...
{ def cen: Vec2
  ...
  def topLeft: GraphicSubject = this.slate(boundingRect.bottomRight)
  def topRight: GraphicSubject = this.slate(boundingRect.bottomLeft)
  def bottomLeft: GraphicSubject = this.slate(boundingRect.topRight)
  def bottomRight: GraphicSubject = this.slate(boundingRect.topLeft)
  def width: Double = boundingRect.width
