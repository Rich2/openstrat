...
@deprecated case class PolyParentOld(cen: Vec2, poly: Polygon, evObj: AnyRef, elems: ArrOld[PaintElem]) extends GraphicParentOld with PolyActiveTr
{
...
{
  def fill(cen: Vec2, poly: Polygon, evObj: AnyRef, colour: Colour) = new PolyParentOld(cen, poly, evObj, ArrOld(poly.fill(colour)))
