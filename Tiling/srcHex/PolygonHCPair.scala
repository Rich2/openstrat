...
{ def a1: PolygonHC = new PolygonHC(a1ArrayInt)
  def polygonPair(f: HCoord => Pt2): PolygonGenPair[A2] = new PolygonGenPair[A2](a1.toPolygon(f).arrayUnsafe, a2)
}
...
object PolygonHCPair {
  implicit def buildImplicit[A2](implicit ct: ClassTag[A2]): BuilderMapArr[PolygonHCPair[A2], PolygonHCPairArr[A2]] = new PolygonHCPairBuild[A2]
}

/** An Arr of  [[PolygonHC]] pairs. A Polygon with the vertices defined in [[HCoord]]s paired with an object of type A2. */
final class PolygonHCPairArr[A2](val a1ArrayArrayInts: Array[Array[Int]], val a2Array: Array[A2]) extends
...
{ override type ThisT = PolygonHCPairArr[A2]
  ...
  override def a1Arr: PolygonHCArr = new PolygonHCArr(a1ArrayArrayInts)
  ...
  override def a1FromArrayArrayInt(array: Array[Int]): PolygonHC = new PolygonHC(array)
...
final class PolygonHCPairBuild[A2](implicit val b2ClassTag: ClassTag[A2], @unused notB: Not[SpecialT]#L[A2]) extends
  BuilderMapArrPairSeqLikeIntN[HCoord, PolygonHC, PolygonHCArr, A2, PolygonHCPair[A2], PolygonHCPairArr[A2]]
{ override type BuffT = PolygonHCPairBuff[A2]
  ...
  override def indexSet(seqLike: PolygonHCPairArr[A2], index: Int, newElem: PolygonHCPair[A2]): Unit =
  { seqLike.a1ArrayArrayInts(index) = newElem.a1ArrayInt ; seqLike.a2Array(index) = newElem.a2 }
  ...
  override def b1ArrBuilder: BuilderMapArr[PolygonHC, PolygonHCArr] = ???
...
{ override type ThisT = PolygonHCPairBuff[A2]
  ...
  override def elem(index: Int): PolygonHCPair[A2] = new PolygonHCPair[A2](b1Buffer(index), b2Buffer(index))
}