...
{ override def fromArray(array: Array[Int]): HStepLikeArr = new HStepLikeArr(array)
  ...
  implicit val flatBuilder: FlatBuilderArr[HStepLikeArr] = new Int1ArrFlatBuilder[HStepLikeArr]
...
{ override type ThisT = HStepArr
  ...
  def segHCsMap[B, ArrB <: Arr[B]](start: HCen)(f: LineSegHC => B)(implicit build: MapBuilderArr[B, ArrB], gridSys: HGridSys): ArrB =
    segHCsMap(start.r, start.c)(f)(build, gridSys)

  def segHCsMap[B, ArrB <: Arr[B]](startR: Int, startC: Int)(f: LineSegHC => B)(implicit build: MapBuilderArr[B, ArrB], grider: HGridSys): ArrB = {
...
{ override def fromArray(array: Array[Int]): HStepArr = new HStepArr(array)
  ...
  implicit val flatBuilder: FlatBuilderArr[HStepArr] = new Int1ArrFlatBuilder[HStepArr]
  { override type BuffT = HStepBuff
    override def fromIntArray(array: Array[Int]): HStepArr = new HStepArr(array)
    override def fromIntBuffer(buffer: ArrayBuffer[Int]): HStepBuff = new HStepBuff(buffer)
  }
