...
{ type SysT <: HGridSys
  ...
  def hCenFlatMap[ArrB <: Arr[_]](f: HCen => ArrB)(implicit build: BuilderFlatArr[ArrB]): ArrB = gChild.flatMap(f)
  ...
  def hCensIfPtFlatMap[ArrB <: Arr[_]](f1: HCen => Boolean)(f2: (HCen, Pt2) => ArrB)(implicit build: BuilderFlatArr[ArrB]): ArrB =
  ...
  def sidesOptMap[B, ArrB <: Arr[B]](f: HSide => Option[B])(implicit build: BuilderMapArr[B, ArrB]): ArrB = gChild.sidesOptMap(f)

  def linksOptMap[B, ArrB <: Arr[B]](f: HSide => Option[B])(implicit build: BuilderMapArr[B, ArrB]): ArrB = gChild.linksOptMap(f)

  def linkLineSegsOptMap[B, ArrB <: Arr[B]](f: (HSide, LineSeg) => Option[B])(implicit build: BuilderMapArr[B, ArrB]): ArrB =
