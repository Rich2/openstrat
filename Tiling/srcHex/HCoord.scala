...
{ /** Factory apply method for creating [[HCoord]]s .Creates an [[HCen]], an [[HSep]], an [[HVert]] or an [[HCoordOther]] depending on the values of
  ...
  implicit val polygonBuildEv: PolygonInt2BuilderMap[HCoord, PolygonHC] = new PolygonInt2BuilderMap[HCoord, PolygonHC]
  { override type BuffT = HCoordBuff
...
trait HCoordSeqLike extends Any with SlImutInt2[HCoord]
...
trait HCoordSeqSpec extends Any with HCoordSeqLike with SsInt2[HCoord]
