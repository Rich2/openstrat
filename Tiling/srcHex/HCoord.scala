...
{ /** Factory apply method for creating [[HCoord]]s .Creates an [[HCen]], an [[HSep]], an [[HVert]] or an [[HCoordOther]] depending on the values of
  ...
  /** Implicit type class instance / evidence for the [[HCoord]] type class instance of [[BuilderPolygonLikeMap]]. */
  implicit val polygonBuildEv: BuilderPolygonInt2Map[HCoord, PolygonHC] = new BuilderPolygonInt2Map[HCoord, PolygonHC]
  { override type BuffT = HCoordBuff
...
trait HCoordSeqLike extends Any with SeqLikeImutInt2[HCoord]
