...
class HSidePairArr[A2](val a1ArrayInt: Array[Int], val a2Array: Array[A2]) extends ArrPairInt2[HSep, HSepArr, A2, HSepPair[A2]]
...
class HSidePairArrMapBuilder[B2](implicit ct: ClassTag[B2]) extends BuilderArrPairInt2Map[HSep, HSepArr, B2, HSepPair[B2], HSidePairArr[B2]]
