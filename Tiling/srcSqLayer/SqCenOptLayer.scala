...
{override type ThisT = SqCenOptLayer[A]
  ...
  def scSomesFlatMap[ArrB <: Arr[?]](f: (SqCen, A) => ArrB)(implicit gridSys: SqGridSys, build: BuilderFlatArr[ArrB]): ArrB =
  ...
  def someSCOptFlatMap[ArrB <: Arr[?]](f: (A, SqCen) => Option[ArrB])(implicit gridSys: SqGridSys, build: BuilderFlatArr[ArrB]): ArrB =
  { val buff = build.newBuff()
