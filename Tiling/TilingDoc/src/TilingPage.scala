...
import geom.*, prid.phex.*, pweb.*, WebExts.*, Colour.*
...
object TilingJsPommer extends OsModuleJsVerless(DirsRel("TilingJs"), "tilingjs", RArr(UtilJsPommer, GeomJsPommer), RArr(ScalaDomDep()))
...
{ override def titleStr: String = "Tiling Module"
  ...
  def turnRes: Section = new Section
  {
...
object CoordSystem extends Section
{
