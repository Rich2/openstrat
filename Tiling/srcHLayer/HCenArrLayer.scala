...
{ /** The [[HGridSys]] hex grid system that is the key to this tile data layer */
  ...
  def mapHcFlatMap[ArrT <: Arr[_]](f: (A, HCen) => ArrT)(implicit build: FlatBuilderArr[ArrT]): ArrT = {
...
trait HCenArrLayerLowPrioity
{
  ...
  { override val arrBBuild: MapBuilderArr[B, RArr[B]] = MapBuilderArr.rMapImplicit
...
{ def arrBBuild: MapBuilderArr[B, ArrB]
