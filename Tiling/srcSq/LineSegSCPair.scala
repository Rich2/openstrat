...
class LineSegSCPairArrMapBuilder[B2](implicit ct: ClassTag[B2]) extends BuilderMapArrPairInt4[LineSegSC, LineSegSCArr, B2, LineSegSCPair[B2], LineSegSCPairArr[B2]]
