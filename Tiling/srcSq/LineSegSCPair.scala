...
class LineSegSCPair[A2](val a1Int1: Int, val a1Int2: Int, val a1Int3: Int, val a1Int4: Int, val a2: A2) extends LineSegLikeInt4Pair[SqCoord, LSegSC, A2]
{ /** The first component of this pair. */
  override def a1: LSegSC = new LSegSC(a1Int1, a1Int2, a1Int3, a1Int4)
}

class LineSegSCPairArr[A2](val a1ArrayInt: Array[Int], val a2Array: Array[A2]) extends LineSegLikeInt4PairArr[SqCoord, LSegSC, LineSegSCArr, A2, LineSegSCPair[A2]]
{ override type ThisT = LineSegSCPairArr[A2]
  ...
  override def elemFromInts(int1: Int, int2: Int, int3: Int, int4: Int, a2: A2): LineSegSCPair[A2] = new LineSegSCPair[A2](int1, int2, int3, int4, a2)
  override def a1FromInts(int1: Int, int2: Int, int3: Int, int4: Int): LSegSC = new LSegSC(int1, int2, int3, int4)
...
class LineSegSCPairBuff[B2](val b1IntBuffer: ArrayBuffer[Int], val b2Buffer: ArrayBuffer[B2]) extends BuffPairInt4[LSegSC, B2, LineSegSCPair[B2]]
{ override type ThisT = LineSegSCPairBuff[B2]
  override def typeStr: String = "LineSegSCPairBuff"
  override def elemFromInts(int1: Int, int2: Int, int3: Int, int4: Int, a2: B2): LineSegSCPair[B2] = new LineSegSCPair[B2](int1, int2, int3, int4, a2)
}

class LineSegSCPairArrMapBuilder[B2](implicit ct: ClassTag[B2]) extends BuilderMapArrPairInt4[LSegSC, LineSegSCArr, B2, LineSegSCPair[B2], LineSegSCPairArr[B2]]
{ override type BuffT = LineSegSCPairBuff[B2]
  ...
  override def b1ArrBuilder: BuilderArrMap[LSegSC, LineSegSCArr] = LSegSC.arrMapBuilderEv
