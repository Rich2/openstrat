...
{ override type ThisT = LineSegSCPairArr[A2]
  ...
  override def a1FromInts(int1: Int, int2: Int, int3: Int, int4: Int): LineSegSC = new LineSegSC(int1, int2, int3, int4)
...
class LineSegSCPairArrMapBuilder[B2](implicit ct: ClassTag[B2]) extends BuilderArrPairInt4Map[LineSegSC, LineSegSCArr, B2, LineSegSCPair[B2], LineSegSCPairArr[B2]]
{ override type BuffT = LineSegSCPairBuff[B2]
  ...
  override def b1ArrBuilder: BuilderArrMap[LineSegSC, LineSegSCArr] = LineSegSC.arrMapBuilderEv
