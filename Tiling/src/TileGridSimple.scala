...
trait TileGridSimple
{
  ...
  def activeTiles: Arr[PolygonActiveOnly]
  ...
  final def cenSideVertRoordText: Arr[DisplayAffineElem] = cenRoordTexts() ++ sideRoordTexts() ++ vertRoordTexts()
