...
/** The new 80 Km grid for North West Europe. The c or column offset is 512 which is G0 in base 32. The c oofset for North West Europe will be 1536 or
 * 1G0 in base 32. Current y offset is 300 for the equator. */
