...
{
  val antartica: EarthLevel2 = EarthLevel2("Antartic", -89.91 ll 0, ice, -70.7 ll 4.77, -66.38 ll 53.46, -71.39 ll 71.22, -66.48 ll 102.33,
   ...
   override val a2Arr: Arr[EarthLevel2] = Arr(antartica)
}