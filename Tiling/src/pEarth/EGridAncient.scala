...
trait EGridMaker
{
  def apply[TileT <: TileAncient, SideT <: TileSideAncient]
...
class EGridAncient[TileT <: TileAncient, SideT <: TileSideAncient](bounds: Array[Int], val name: String, val cenLong: Longitude, val scale: Metres, val xOffset: Int,
