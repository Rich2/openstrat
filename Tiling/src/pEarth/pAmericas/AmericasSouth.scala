...
{ val swArgentine = -54.28 ll -65.06
  ...
  val fSAmerica: EArea2 = EArea2("FSAmerica", degs(-33.51, -65.36), plain,
  ...
  val wSAmerica: EArea2 = EArea2("WSAmerica", degs(-10.42, -47.78), jungle,
  ...
  val eSAmerica = EArea2("ESAmerica", degs(-2.04, -70.81), jungle, nwSAmericaEN, nAmapa, amazonMouthS, paraiba, sSAmericaNE, nwSAmericaES)
   
  override val a2Arr: Arr[EArea2] = Arr(fSAmerica, wSAmerica, eSAmerica)
}