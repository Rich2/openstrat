...
{ /** Factory apply method for creating [[HCoord]]s .Creates an [[HCen]], an [[HSide]], an [[HVert]] or an [[HCoordOther]] depending on the values of
  ...
  /** Implicit type class instance / evidence for the [[HCoord]] type class instance of [[PolygonLikeBuilder]]. */
...
trait HCoordSeqDef extends Any with HCoordSeqLike with Int2SeqDef[HCoord]
