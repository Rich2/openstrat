...
{ /** Factory apply method for creating [[HCoord]]s .Creates an [[HCen]], an [[HSide]], an [[HVert]] or an [[HCoordOther]] depending on the values of
  ...
  implicit val persistImplicit: PersistShowInt2[HCoord] = new PersistShowInt2[HCoord]("HCoord", "r", "c", HCoord(_, _))
...
/** Companion object for [[HCenOrSide]] trait, contains factory apply method and implicit [[PersistPrec]] instance. */
object HCenOrSide
