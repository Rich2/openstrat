...
{ override type BuffT = PolygonHCPairBuff[A2]
  ...
  override def buffToBB(buff: PolygonHCPairBuff[A2]): PolygonHCPairArr[A2] = new PolygonHCPairArr[A2](buff.b1Buffer.toArray, buff.b2Buffer.toArray)
...
{ override type ThisT = PolygonHCPairBuff[A2]
  override def unsafeSetElem(i: Int, value: PolygonHCPair[A2]): Unit = { b1Buffer(i) = value.a1ArrayInt; b2Buffer(i) = value.a2 }
  override def fElemStr: PolygonHCPair[A2] => String = _.toString
