...
trait TGridSys extends Any
{
  ...
  final def mapRows[B, BB <: Arr[B]](f: Int => B)(implicit build: BuilderMapArr[B, BB]): BB =
  ...
  final def flatMapRows[ArrT <: Arr[_]](f: Int => ArrT)(implicit build: BuilderFlatArr[ArrT]): ArrT =
