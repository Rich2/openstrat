...
class EGrid160Long(rBottomCen: Int, rTopCen: Int, cenLongInt: Int) extends
  EGridLongFull(rBottomCen, rTopCen, cenLongInt, 40.kMetres, 200)

object EGrid160Long
{ def apply(rBottomCen: Int, rTopCen: Int, cenLongInt: Int) = new EGrid160Long(rBottomCen, rTopCen, cenLongInt)
}
...
{ /** Factory method for creating a main Earth grid centred on 0 degrees east of scale cScale 40Km or hex scale 160km. */
  ...
  def e150(rBottomCen: Int = 276, rTopCen: Int = 320): EGrid160Long = EGrid160Long(rBottomCen, rTopCen, 5)
  def e180(rBottomCen: Int = 276, rTopCen: Int = 320): EGrid160Long = EGrid160Long(rBottomCen, rTopCen, 6)
  def w150(rBottomCen: Int = 276, rTopCen: Int = 320): EGrid160Long = EGrid160Long(rBottomCen, rTopCen, 7)
  def w120(rBottomCen: Int = 276, rTopCen: Int = 320): EGrid160Long = EGrid160Long(rBottomCen, rTopCen, 8)
  def w90(rBottomCen: Int = 276, rTopCen: Int = 320): EGrid160Long = EGrid160Long(rBottomCen, rTopCen, 9)
