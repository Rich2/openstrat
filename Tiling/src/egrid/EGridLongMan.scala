...
trait EGridLongMan extends EGridMan
{
  override def sys: EGridLongMulti
  def rowSidesForeach(r: Int)(f: HSide => Unit): Unit
...
case class EGridLongStartMan(sys: EGridLongMulti) extends EGridLongMan
{
...
/** Manages an [[EGridLong]]. */
case class EGridLongMiddleMan(thisInd: Int, sys: EGridLongMulti) extends EGridLongMan
{
  def rowSidesForeach(r: Int)(f: HSide => Unit): Unit = r match
  { case r if r == grid.topSideR | r ==grid.bottomSideR => grid.rowForeachSide(r)(f)
...
/** Manages an [[EGridLong]]. */
case class EGridLongEndMan(thisInd: Int, sys: EGridLongMulti) extends EGridLongMan
{
  def rowSidesForeach(r: Int)(f: HSide => Unit): Unit = r match
  { case r if r == grid.topSideR | r ==grid.bottomSideR => grid.rowForeachSide(r)(f)
