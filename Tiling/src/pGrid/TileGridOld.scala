...
trait TileGridOld[TileT <: TileOld, SideT <: TileSideOld]
{
  ...
  final def tilesMapAll[B, BB <: ArrBase[B]](f: TileT => B)(implicit build: ArrBuild[B, BB]): BB =
  {
  ...
  def tilesFlatMapAll[B, BB <: ArrBase[B]](f: TileT => BB)(implicit build: ArrBuild[B, BB]): BB =
  {
  ...
  final def tilesMapOptionAll[A, AA <: ArrBase[A]](f: TileT => Option[A])(implicit build: ArrBuild[A, AA]): AA =
