...
trait TileGridAncient[TileT <: TileAncient, SideT <: TileSideAncient]
{
  ...
  final def tilesMapAll[B, BB <: SeqImut[B]](f: TileT => B)(implicit build: SeqBuild[B, BB]): BB =
  {
  ...
  def tilesFlatMapAll[B, BB <: SeqImut[B]](f: TileT => BB)(implicit build: SeqBuild[B, BB]): BB =
  {
  ...
  final def tilesMapOptionAll[A, AA <: SeqImut[A]](f: TileT => Option[A])(implicit build: SeqBuild[A, AA]): AA =
