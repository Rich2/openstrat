...
{ /** Returns an [[RArr]] sequence of 320km full earth grids. */
  ...
  def scen0: EScenBasic = EScenBasic(Terr320E0.grid, Terr320E0.terrs, Terr320E0.sTerrs, Terr320E0.sTerrsDepr, Terr320E0.corners, "320km 0E")

  def scen1: EScenBasic = EScenBasic(Terr320E30.grid, Terr320E30.terrs, Terr320E30.sTerrs, Terr320E30.sTerrsDepr, Terr320E30.corners, "320km 30E")

  def scen2: EScenBasic =
  { val grid: EGridLongFull = Terr320E60.grid
    EScenBasic(grid, Terr320E60.terrs, Terr320E60.sTerrs, Terr320E60.sTerrsDepr, Terr320E60.corners, "320km 60E")
  }

  def scen3: EScenBasic =
  { val grid: EGridLongFull = Terr320E90.grid
    EScenBasic(grid, Terr320E90.terrs, Terr320E90.sTerrs, Terr320E90.sTerrsDepr, Terr320E90.corners, "320km 90E")
  }

  def scen4: EScenBasic =
  { val grid: EGridLongFull = Terr320E120.grid
    EScenBasic(grid, Terr320E120.terrs, Terr320E120.sTerrs, Terr320E120.sTerrsDepr, Terr320E120.corners, "320km 120E")
  }

  def scen5: EScenBasic =
  { val grid: EGridLongFull = Terr320E150.grid
    EScenBasic(grid, Terr320E150.terrs, Terr320E150.sTerrs, Terr320E150.sTerrsDepr, Terr320E150.corners, "320km 150E")
  }

  def scen6: EScenBasic =
  { val grid: EGridLongFull = Terr320E180.grid
    EScenBasic(grid, Terr320E180.terrs, Terr320E180.sTerrs, Terr320E180.sTerrsDepr, Terr320E180.corners, "320km 180E")
  }

  def scen7: EScenBasic =
  { val grid: EGridLongFull = Terr320W150.grid
    EScenBasic(grid, Terr320W150.terrs, Terr320W150.sTerrs, Terr320W150.sTerrsDepr, Terr320W150.corners, "320km 150W")
  }

  def scen8: EScenBasic =
  { val grid: EGridLongFull = Terr320W120.grid
    EScenBasic(grid, Terr320W120.terrs, Terr320W120.sTerrs, Terr320W120.sTerrsDepr, Terr320W120.corners, "320km 120W")
  }

  def scen9: EScenBasic =
  { val grid: EGridLongFull = Terr320W90.grid
    EScenBasic(grid, Terr320W90.terrs, Terr320W90.sTerrs, Terr320W90.sTerrsDepr, Terr320W90.corners, "320km 90W")
  }

  def scen10: EScenBasic =
  { val grid: EGridLongFull = Terr320W60.grid
    EScenBasic(grid, Terr320W60.terrs, Terr320E60.sTerrs, Terr320W60.sTerrsDepr, Terr320W60.corners, "320km 60W")
  }

  def scen11: EScenBasic =
  { val grid: EGridLongFull = Terr320W30.grid
    EScenBasic(grid, Terr320W30.terrs, Terr320W30.sTerrs, Terr320W30.sTerrsDepr, Terr320W30.corners, "320km 30W")
  }
}