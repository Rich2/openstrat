...
object Terr320W90 extends Long320Terrs
{
  ...
  { val res: HSideOptLayer[WSide] = grid.newSideOpts[WSide]
    res.setTruesInts(Sea, 142,9736,  143,9735,  144,9734,  152,9730,  152,9734,  153,9731,  155, 9731,  156,9730,  157,9729,  158,9724,  158,9728,  159,9725)
    res.setTruesInts(Lake,  136,9730, 137,9727,  137, 9733)
    res
  }
