...
class EGrid320Main (rBottomCen: Int, rTopCen: Int, cenLongInt: Int, cOffset: Int) extends
  EGridMain(rBottomCen, rTopCen, cenLongInt, 80.kMetres, 100, cOffset)
...
{ /** Factory method for creating a main Earth grid centred on 0 degrees east of scale cScale 20Km or hex scale 80km. */
  def w30(rBottomCen: Int = 138, rTopCen: Int = 160): EGrid320Main = new EGrid320Main(rBottomCen, rTopCen,-1, t"BG0" /* 11776 */)
  def e0(rBottomCen: Int = 138, rTopCen: Int = 160): EGrid320Main = new EGrid320Main(rBottomCen, rTopCen, 0, t"G0" /* 512 */)
  def e30(rBottomCen: Int = 138, rTopCen: Int = 160): EGrid320Main = new EGrid320Main(rBottomCen, rTopCen,  1, t"1G0" /* 1536 */)
  def e60(rBottomCen: Int = 138, rTopCen: Int = 160): EGrid320Main = new EGrid320Main(rBottomCen, rTopCen, 2, t"2G0" /* 2560 */)
