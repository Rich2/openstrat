...
object Terr320W120 extends Warm320Terrs
{
  override implicit val grid: EGrid320LongFull = EGrid320.w120(138)
  ...
  { implicit val grid: EGrid320LongFull = EGrid320.e0(138)
