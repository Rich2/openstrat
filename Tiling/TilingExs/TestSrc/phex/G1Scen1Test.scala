...
{ val os1: G1HScen1.type = G1HScen1
  ...
  val tests = Tests {
    ...
    test("os1")
    { g1.str ==> g1Str
      g1Str.asType[HGridRect] ==> Right(g1)
      lr1.numTiles ==> 2
      ...
      "HRow(4; CounterA; CounterB; CounterC)".asType[LayerHcOptRow[Counter]] ==> Right(hr2)
      assert("HRow(4; CounterA; CounterB; CounterD)".asType[LayerHcOptRow[Counter]] != Right(hr2))
