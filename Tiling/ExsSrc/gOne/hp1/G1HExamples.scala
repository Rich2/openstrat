...
{ override def turn: Int = 0
  ...
  players.unsafeSetSomes((4, 8, PlayerB), (6, 10, PlayerC))
}
...
{ override def turn: Int = 0
  ...
  val players: HCenOptLayer[Player] = gridSys.newHCenOptLayer
  players.unsafeSetSome(6, 38, PlayerA)
  players.unsafeSetSomes((4, 40, PlayerB), (6, 42, PlayerC))
}
...
{ override def turn: Int = 0
  ...
  val players: HCenOptLayer[Player] = gridSys.newHCenOptLayer
  players.unsafeSetSomes((4, 4, PlayerA), (10, 6, PlayerB), (8, 8, PlayerC))
}
...
{ override def turn: Int = 0
  ...
  val players: HCenOptLayer[Player] = gridSys.newHCenOptLayer
  players.unsafeSetSomes((4, 4, PlayerA), (8, 4, PlayerB), (6, 6, PlayerC))
}
