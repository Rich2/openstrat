...
{ override def turn: Int = 0
  ...
  val players: HCenOptLayer[Counter] = HCenOptLayer()
  players.setSomeMut(4, 4, CounterA)
  players.setSomesMut((4, 8, CounterB), (6, 10, CounterC))
}
...
{ override def turn: Int = 0
  ...
  val players: HCenOptLayer[Counter] = HCenOptLayer()
  players.setSomeMut(6, 38, CounterA)
  players.setSomesMut((4, 40, CounterB), (6, 42, CounterC))
}
...
{ override def turn: Int = 0
  ...
  val players: HCenOptLayer[Counter] = HCenOptLayer()
  players.setSomesMut((4, 4, CounterA), (10, 6, CounterB), (8, 8, CounterC))
}
...
{ override def turn: Int = 0
  ...
  val players: HCenOptLayer[Counter] = HCenOptLayer()
  players.setSomesMut((4, 4, CounterA), (8, 4, CounterB), (6, 6, CounterC))
}
