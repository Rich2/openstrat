...
{ override implicit val grid: EGrid460LongFull = EGrid460.e90(94)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(128, mtainOld * 4),
      TRow(126, sahel * 2, mtainOld, hillyDeshot),
      TRow(124, hillySahel, mtainOld, hillySahel * 3),
      TRow(122, deshot * 2, hillyDeshot, hillySahel, deshot),
      TRow(120, mtainOld, hillyDeshot * 2, mtainOld * 2),
      TRow(118, mtainOld, hillySahel * 2, mtainOld * 3),
      TRow(116, deshot, deshot, hillyDeshot, mtainOld * 3),
      TRow(114, hillyOce, oceanic, hillySavannah, savannah, hillyJungle, mtainOld),
      TRow(112, hillySavannah * 2, CapeOld(3, 1, Land(Plain, Tropical)), hillySavannah, mtainOld * 2),
      VRow(111, MouthOld(3598, HVUL)),
      TRow(110, savannah, hillySavannah, sea * 2, hillyJungle, mtainOld),
      VRow(109, MouthOld(3590, HVUp)),
      TRow(108, sahel, savannah, sea * 3, CapeOld(4, 1, mtainOld), hillySavannah),
      TRow(106, savannah, sea * 4, CapeOld(1, 2, mtainOld), CapeOld(4, 1, jungle)),
