...
{ override implicit val grid: EGrid460LongFull = EGrid460.e0(102)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      VRow(133, BendIn(506, HVDR, 13), MouthLt(508, HVUR), Mouth(512, HVDn)),
      TRow(132, Cape(4, 1, hilly), sea, Cape(4, 4)),
      VRow(131, Mouth(504, HVUp), BendOut(508, HVDL), Mouth(516, HVDR), Mouth(518, HVDn)),
