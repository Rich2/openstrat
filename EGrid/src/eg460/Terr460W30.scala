...
{ override implicit val grid: EGrid460LongFull = EGrid460.w30(70)
  ...
  val terrSet: WTerrSetter = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rows: RArr[RowBase] = RArr(
      ...
      VRow(91, BendMin(11768, HVDR), BendIn(11770, HVUL, 13)),
      TRow(90, hillyJungle),
      VRow(89, BendOut(11768, HVUR), BendIn(11770, HVDL, 13)),
      TRow(88, hillySub),
      VRow(87, OrigLt(11768, HVUR, 7), BendIn(11770, HVUL, 13)),
    )
  }
  terrSet.run
}