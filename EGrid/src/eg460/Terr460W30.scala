...
{ override implicit val grid: EGrid460LongFull = EGrid460.w30(94)
  ...
  val terrSet: WTerrSetter = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rows: RArr[RowBase] = RArr(
      ...
      TRow(136, ice, sea, mtainDepr),
      VRow(135, BendMin(11772, HVDR, 3, SeaIceWinter), BendIn(11774, HVUL, 13, SeaIceWinter), OrigMinRevDepr(11778, HVUL), BendIn(11780, HVUp), OrigRtRevDepr(11782, HVUR)),
      VRow(133, BendIn(11770, HVUp, 6, SeaIceWinter), BendIn(11772, HVUL, 6, SeaIceWinter)),
      VRow(129, OrigMinRevDepr(11786, HVDR)),
      VRow(117, BendIn(11786, HVDR, 13), BendIn(11788, HVDn, 13), ThreeDown(11790, 0, 10, 13)),
      TRow(116, sea * 5, mtainDepr),
      VRow(115, BendIn(11786, HVUR, 13), BendIn(11788, HVUp, 13), BendIn(11790, HVUL, 13)),
      VRow(113, OrigLtRevDepr(11786, HVUp)),
      ...
      VRow(99, OrigMinRevDepr(11762, HVDn), OrigRtRevDepr(11766, HVUL, 7), OrigLtRevDepr(11768, HVDR, 7)),
