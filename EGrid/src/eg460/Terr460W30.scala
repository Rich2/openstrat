...
{ override implicit val grid: EGrid460LongFull = EGrid460.w30(94)
  ...
  val terrSet: WTerrSetter = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rows: RArr[RowBase] = RArr(
      ...
      VRow(135, BendMin(11772, HVDR, 3, SeaIceWinter), BendIn(11774, HVUL, 13, SeaIceWinter), OrigMinRevDepr(11778, HVUL), BendIn(11780, HVUp), MouthRt(11782, HVUR)),
      ...
      VRow(99, OrigMinRevDepr(11762, HVDn), MouthRt(11766, HVUL, 7), MouthLt(11768, HVDR, 7)),
