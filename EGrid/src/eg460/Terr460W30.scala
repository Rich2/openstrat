...
{ override implicit val grid: EGrid460LongFull = EGrid460.w30(94)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(142, ice),
      VRow(141, Mouth(11778, HVDL), BendIn(11780, HVUL, 11, SeaIceWinter)),
      TRow(140, ice),
      TRow(138, ice),
      VRow(137, BendAll(11776, HVDR, SeaIceWinter)),
      TRow(136, ice, sea, mtain),
      VRow(135, BendAll(11772, HVDR, SeaIceWinter), BendIn(11774, HVUL, 13, SeaIceWinter), Mouth(11778, HVUL), Mouth(11782, HVUR)),
