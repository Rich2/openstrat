...
{ override implicit val grid: EGrid460LongFull = EGrid460.e120(94)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(124, desert * 2, sahel, hillyTempForest, mtainOld),
      VRow(123, MouthOld(4608, HVUp), BendOut(4616, HVDR), MouthOld(4618, HVUR)),
      TRow(122, mtainOld, temperate, CapeOld(3, 2, hillyTemp), mtainOld),
      VRow(121, MouthOld(4612, HVUR), ThreeUp(4616, 0, 13, 6), BendOut(4618, HVUp), BendOut(4620, HVUL)),
      TRow(120, hillySavannah, temperate, CapeOld(2, 1, hillyTemp), CapeOld(4, 2, hillyTemp), CapeOld(4, 3, hillyTemp)),
      VRow(119, MouthOld(4608, HVDL), MouthOld(4616, HVDR)),
      TRow(118, mtainOld, temperate * 2, CapeOld(0, 3), sea, CapeOld(3, 1, hillyTemp)),
      VRow(117, MouthOld(4616, HVUL), MouthOld(4620, HVUR)),
      TRow(116, mtainOld, hillyTemp, mtainOld),
