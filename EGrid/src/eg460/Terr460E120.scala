...
{ override implicit val grid: EGrid460LongFull = EGrid460.e120(94)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(130, mtainOld * 4),
      TRow(128, mtainOld * 4),
      TRow(126, desert, sahel, savannah, mtainOld),
      TRow(124, desert * 2, sahel, hillyForest, mtainOld),
      VRow(123, MouthOld(4608, HVUp), BendOut(4616, HVDR), MouthOld(4618, HVUR)),
      TRow(122, mtainOld, level, Cape(3, 2, hilly), mtainOld),
      VRow(121, MouthOld(4612, HVUR), ThreeUp(4616, 0, 13, 6), BendOut(4618, HVUp), BendOut(4620, HVUL)),
      TRow(120, hillySavannah, level, Cape(2, 1, hilly), Cape(4, 2, hilly), Cape(4, 3, hilly)),
      VRow(119, MouthOld(4608, HVDL), MouthOld(4616, HVDR)),
      TRow(118, mtainOld, level * 2, Cape(0, 3), sea, Cape(3, 1, hilly)),
      VRow(117, MouthOld(4616, HVUL), MouthOld(4620, HVUR)),
      TRow(116, mtainOld, hilly, mtainOld),
      TRow(114, mtainOld * 2, Cape(2, 1, mtainOld), Isle8(mtainOld)),
      TRow(112, hillyJungle),
      VRow(111, MouthOld(4598, HVUL), ThreeDown(4600, 6, 0, 7), MouthRt(4602, HVUR, 7)),
      TRow(110, mtainOld, SepB(), sea * 2, Cape(0, 3, hillyJungle)),
