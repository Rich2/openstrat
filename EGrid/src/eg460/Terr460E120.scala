...
{ override implicit val grid: EGrid460LongFull = EGrid460.e120(94)
  ...
  { override val rows: RArr[RowBase] = RArr(
    ...
    VRow(111, OrigMinRevDepr(4598, HVUL), ThreeDown(4600, 6, 0, 7), MouthRt(4602, HVUR, 7)),
    ...
    VRow(101, BendIn(4606, HVDR), OrigMinRevDepr(4608, HVUR), MouthRt(4618, HVDL, 7), BendIn(4620, HVDn, 13), BendIn(4622, HVDL, 13)),
    TRow(100, sea, hillyJungle, jungle, mtainDepr, sea, sea, hillyJungle),
    VRow(99, BendIn(4596, HVDL, 7), MouthRt(4606, HVDn, 7), OrigMinRevDepr(4622, HVDn)),
    TRow(98, SepB(), sea, jungle, sea, hillyJungle, sea * 2, mtainDepr),
    VRow(97, MouthRt(4594, HVDL), BendIn(4596, HVUL), OrigMinRevDepr(4600, HVUL, 7, sea), OrigMinRevDepr(4602, HVDR, 5, sea), MouthLt(4620, HVUL), BendOut(4622, HVDL, 7)),
