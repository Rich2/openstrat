...
{ override implicit val grid: EGrid460LongFull = EGrid460.e120(94)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      VRow(121, Bend(4608, HVUR, 8, 5), ThreeDown(4610, 13, 10, 0), SourceRt(4612, HVDL), ThreeUp(4616, 0, 13, 6), BendOut(4618, HVUp), BendOut(4620, HVUL)),
      TRow(120, hillySavannah, oceanic, hillyOce, hillyOce, hillyOce),
      VRow(119, MouthOld(4616, HVDR)),
