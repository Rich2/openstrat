...
{ override implicit val grid: EGrid460LongFull = EGrid460.e150(94)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rows: RArr[RowBase] = RArr(
      ...
      VRow(141, SourceRt(5632, HVDR, 7, siceWin), SourceLt(5634, HVUL, 7, siceWin)),
      ...
      VRow(133, SourceRt(5630, HVDn, 7), BendIn(5634, HVDR, 13), Bend(5636, HVUL, 11, 5), Bend(5638, HVDR, 5, 1, siceWin)),
      TRow(132, mtainTaiga, sea, hillyTaiga),
      VRow(131, SourceLt(5628, HVUR, 7), BendIn(5630, HVUL, 13), SourceRt(5634, HVUp), VertRightsLeft(5638, siceWin, 6), BendIn(5640, HVDL, 10, siceWin)),
      TRow(130, mtainTaiga, sea * 2, hillyTaiga),
      VRow(129, SourceRt(5630, HVDn, 7), SourceLt(5638, HVUR, 7, siceWin), BendIn(5640, HVUL, 13, siceWin)),
      TRow(128, mtainTaiga),
