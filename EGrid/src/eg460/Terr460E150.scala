...
{ override implicit val grid: EGrid460LongFull = EGrid460.e150(94)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      VRow(133, BendIn(5634, HVDR, 13), Bend(5636, HVUL, 11, 5), BendOut(5638, HVDR)),
      TRow(132, mtainTaiga, sea, hillyTaiga),
      VRow(131, SourceRt(5634, HVUp), VertRightsLeft(5638, sea, 7)),
      TRow(130, mtainOld, sea * 2, mtainOld),
