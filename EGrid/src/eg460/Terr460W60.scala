...
{ override implicit val grid: EGrid460LongFull = EGrid460.w60(94)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      VRow(135, MouthOld(10748, HVDR), BendOut(10756, HVDL), BendAll(10760, HVDR, SeaIceWinter)),
      ...
      VRow(127, MouthOld(10748, HVDL), BendAll(10750, HVDn, sea, 7), ThreeDown(10752, 13, 0, 6), BendIn(10754, HVUL, 13)),
