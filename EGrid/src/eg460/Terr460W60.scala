...
{ override implicit val grid: EGrid460LongFull = EGrid460.w60(94)
  ...
  { override val rows: RArr[RowBase] = RArr(
    ...
    TRow(136, SepB(), hillyTundra, sea, CapeOld(4, 1, mtainTundra)),
    VRow(135, MouthOld(10748, HVDR), BendOut(10756, HVDL)),
    TRow(134, sea * 2, mtainOld),
    VRow(133, MouthOld(10752, HVUL), BendIn(10754, HVDL, 13), BendIn(10758, HVUp, 6, SeaIceWinter), BendIn(10760, HVUL, 6, SeaIceWinter)),
