...
{ override implicit val grid: EGrid460LongFull = EGrid460.w60(94)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(142, SepB(), CapeOld(4, 1, ice)),
      TRow(140, sea, ice),
      VRow(139, MouthOld(10754, HVUR)),
      TRow(138, SepB(), CapeOld(1, 1, hillyTundra), CapeOld(4, 2, mtainOld)),
      VRow(137, SetSep(10747), BendOut(10754, HVDL)),
      TRow(136, SepB(), hillyTundra, sea, CapeOld(4, 1, mtainOld)),
      ...
      TRow(132, lakesTaiga, CapeOld(1, 1, mtainOld)),
      VRow(131, BendOut(10754, HVUR)),
      TRow(130, lakesTaiga * 2, CapeOld(1, 1, hillyTaiga)),
      ...
      TRow(124, hillyForest, Land(PlainLakes, Boreal, Forest)),
