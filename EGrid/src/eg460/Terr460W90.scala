...
{ override implicit val grid: EGrid460LongFull = EGrid460.w90(70)
  ...
  { override val rows: RArr[RowBase] = RArr(
    ...
    TRow(122, savannah * 3, mtainContForest, hillyOce),
    VRow(121, OrigMin(9738, HVUR, 2), BendIn(9740, HVUL, 9)),
    TRow(120, sahel, hillySavannah, savannah, mtainSubForest, hillySub),
    ...
    VRow(105, OrigMin(9734, HVDn), Orig(9736, HVUp, 3, 7), OrigMin(9738, HVDn), Orig(9740, HVUp, 5, 7)),
