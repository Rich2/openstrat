...
{ override implicit val grid: EGrid460LongFull = EGrid460.w90(94)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(136, tundraLakes, CapeOld(2, 1, tundraLakes), CapeOld(0, 4, hillyTundra)),
      VRow(135, BendOut(9728, HVDR, 7), MouthOld(9736, HVDR)),
      TRow(134, tundraLakes, sea, CapeOld(5, 2, tundraLakes)),
      ...
      TRow(116, savannah, level, CapeOld(2, 2), sea, CapeOld(1, 2, jungle)),
