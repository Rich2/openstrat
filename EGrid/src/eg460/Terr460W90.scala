...
{ override implicit val grid: EGrid460LongFull = EGrid460.w90(94)
  ...
  { override val rows: RArr[RowBase] = RArr(
    ...
    VRow(127, OrigRt(9728, HVUR, 7, lake), BendIn(9730, HVDn, 13, lake), OrigMinRevDepr(9732, HVDR, 3, lake)),
    ...
    VRow(107, BendIn(9722, HVUR, 13), BendIn(9724, HVUp, 13), BendOut(9726, HVDn, 7), OrigRtRevDepr(9728, HVDR, 7), OrigMinRevDepr(9734, HVUL), BendIn(9736, HVDL, 10),
      BendIn(9740, HVDR, 10), BendIn(9742, HVDn, 10), BendOut(9744, HVUp)),

    TRow(106, sea * 4, mtainDepr, sea, hillyJungle),
    VRow(105, OrigMinRevDepr(9734, HVUp), OrigMinRevDepr(9736, HVDn), OrigMinRevDepr(9740, HVDn)),
    TRow(104, sea * 5, mtainDepr, hillyJungle),
    VRow(103, BendIn(9734, HVUR, 10), BendIn(9736, HVUp, 10), BendOut(9738, HVDn, 7), OrigMinRevDepr(9740, HVDR)),
