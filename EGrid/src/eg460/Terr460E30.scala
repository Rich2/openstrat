...
{ override implicit val grid: EGrid460LongFull = EGrid460.e30(94)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      VRow(119, MouthLt(1526, HVDn, 7),  Mouth(1528, HVDL), BendOut(1532, HVUp), BendOut(1536, HVUp), BendOut(1540, HVDL)),
      TRow(118, sahel, Cape(0, 1, sahel), Cape(0, 1, sahel), Cape(0, 2, sahel), savannah, desert),
      VRow(117, Mouth(1534, HVDL, 3, Scarp), Mouth(1536, HVUR, 3, Scarp), Mouth(1538, HVUp), Mouth(1540, HVDn), MouthRt(1542, HVUp), Mouth(1550, HVUp)),
      ...
      VRow(99, Mouth(1538, HVUL, 3, lake), Mouth(1540, HVDR, 3, lake), BendIn(1548, HVDR, 7), BendIn(1550, HVUL, 13)),
      ...
      VRow(95, MouthLt(1538, HVDn, 6, lake), Mouth(1540, HVUp, 3, lake), BendOut(1546, HVUR), BendIn(1548, HVDL, 13)),
