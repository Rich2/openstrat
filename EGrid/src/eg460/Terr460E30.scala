...
{ override implicit val grid: EGrid460LongFull = EGrid460.e30(94)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(132, temperate, temperate, taiga),
      VRow(131),
      TRow(130, temperate * 4),
      TRow(128, temperate * 2, hillyTemp, temperate),
      TRow(126, temperate, hillyTemp, savannah, temperate),
      VRow(125, SetSep(1527), MouthMax(1536, HVUL), ThreeDown(1538, 0, 13, 13), BendIn(1540, HVDn, 13), BendIn(1542, HVDL, 13)),
      TRow(124, mtainOld, hillyTemp, hillySavannah, mtainOld, mtainOld),
