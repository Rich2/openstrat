...
{ override implicit val grid: EGrid460LongFull = EGrid460.e30(94)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(116, desert * 2, sahel, desert, desert * 2),
      VRow(115, BendIn(1538, HVUR, 8), Bend(1540, HVDL, 1, 7), BendIn(1550, HVUR, 13)),
      TRow(114, desert * 3, sahel, hillySahel, desert),
      VRow(113, BendIn(1540, HVUR, 13), Bend(1542, HVDL, 3, 7)),
      TRow(112, desert * 3, hillyDesert, hillyDesert, desert),
      ...
      TRow(108, desert * 4, sahel, hillySahel, hillySahel),
