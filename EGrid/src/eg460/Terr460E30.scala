...
{ override implicit val grid: EGrid460LongFull = EGrid460.e30(94)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      TRow(146, SeaIcePerm),
      TRow(144, mtain),
      VRow(139, MouthRt(1538, HVUL, 7), BendIn(1540, HVDL, 6, sea, SeaIceWinter)),
      ...
      TRow(136, hillyTaiga, Land(LandLakes, Taiga, Forest), taiga),
      VRow(135, Bend(1532, HVDR, 4, 5, SeaIceWinter, sea), BendIn(1534, HVUL, 12, SeaIceWinter)),
      TRow(134, Land(LandLakes, Taiga, Forest), Land(LandLakes, Taiga, Forest), taiga),
