...
{ override implicit val grid: EGrid460LongFull = EGrid460.e30(70)
  ...
  { override val rows: RArr[RowBase] = RArr(
    ...
    VRow(89, BendOut(1542, HVDR, 7), OrigRt(1544, HVDL, 7), OrigLt(1546, HVDn, 7)),
    TRow(88, deshot, sahel, savannah, jungle, sea, hillySavannah),
    VRow(87, OrigLt(1542, HVUp, 7), OrigRt(1546, HVUp, 7)),
    ...
    VRow(81, BendIn(1524, HVUR, 13), BendOut(1526, HVDL, 7), OrigMin(1530, HVDn, 4), OrigLt(1534, HVUR, 7), OrigRt(1536, HVDL, 7)),
    TRow(80, hillySub),
    VRow(79, BendIn(1526, HVUR, 13), BendIn(1528, HVUp, 13), BendIn(1530, HVUL, 13)),
    )
  }
  help.run
