...
{ override implicit val grid: EGrid460LongFull = EGrid460.e60(114, 134)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(124, hillySavannah, sahel),
      VRow(123, BendOut(2554, HVUR)),
      TRow(122, Cape(1, 2, savannah), desert),
      ...
      TRow(116, Cape(3, 2, hillyDesert), mtain, hillyDesert),
      VRow(115, BendIn(2556, HVDL)),
      TRow(114, desert, Cape(0, 1, desert), Cape(3, 2, mtain), hillyDesert),
