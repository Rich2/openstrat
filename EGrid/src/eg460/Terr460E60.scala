...
{ override implicit val grid: EGrid460LongFull = EGrid460.e60(94)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rows: RArr[RowBase] = RArr(
      ...
      TRow(120, hillySahel, hillySahel, hillyDeshot, mtainOld * 2),
      TRow(118, hillySahel, hillyDeshot * 4, savannah),
      VRow(117, MouthLt(2550, HVUp)),
      TRow(116, hillyDeshot, mtainOld, hillyDeshot, hillySahel, hillyDeshot, deshot),
      ...
      TRow(114, deshot, deshot, mtainOld, hillyDeshot, sahel * 2),
      ...
      TRow(108, mtainOld, mtainOld, sea * 4, hillySavannah),
