...
{ override implicit val grid: EGrid460LongFull = EGrid460.w120(90)
  ...
  { override val rows: RArr[RowBase] = RArr(
    ...
    TRow(140, Isle10(tundra), CapeOld(0, 1, lakesTundra)),
    VRow(139, BendOut(8708, HVUp), BendIn(8710, HVUL)),
    TRow(138, lakesTundra, CapeOld(0, 1, lakesTundra)),
    VRow(137, MouthOld(8702, HVDL, 3, lake), MouthOld(8704, HVUR, 3, lake)),
    TRow(136, mtainOld, lakesTaiga, lakesTundra),
    VRow(135, MouthOld(8706, HVUL, 3, lake), MouthOld(8708, HVDR, 3, lake)),
    TRow(134, mtainOld, lakesTaiga, lakesTundra),
    ...
    TRow(124, sea, CapeOld(4, 2, mtainOld), hillyDeshot, hillySavannah, hillySahel),
    ...
    TRow(118, sea * 3, CapeOld(4, 1, hillySahel), hillyDeshot, hillySahel),
    VRow(117, BendOut(8706, HVDL), MouthOld(8708, HVUL), Bend(8710, HVDL, 3, 4)),
    TRow(116, sea * 3, CapeOld(4, 1, hillySahel), CapeOld(4, 1, hillySahel), hillySahel),
