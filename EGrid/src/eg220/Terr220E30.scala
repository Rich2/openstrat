...
{ override implicit val grid: EGrid220LongFull = EGrid220.e30(132)
  ...
  { override val rowDatas: RArr[RowBase] = RArr(
      TRow(182, Cape(2, 5, hillyTundra), Cape(2, 0, hillyTundra), sea * 3),
      TRow(180, hillyTundra, taiga, tundra, Cape(2, 0, hillyTundra), sea),
      TRow(178, taiga * 4, Cape(3, 5, tundra)),
      VRow(177, Mouth(1530, HVUp), Mouth(1538, HVDL), BendAll(1544, HVUL)),
      TRow(176, Cape(1, 2, taiga), taiga * 2, Cape(3, 0, taiga), Cape(2, 4, taiga), taiga),
      VRow(175, Mouth(1540, HVDL), Mouth(1544, HVDR)),
      TRow(174, Cape(1, 2, taiga), Cape(1, 5, taiga), taiga * 4),
      VRow(173, Mouth(1540, HVUL, Lake), BendAll(1542, HVDL, Lake)),
      TRow(172, Cape(1, 2, taiga), Cape(1, 5, taiga), taiga * 5),
      VRow(171, Mouth(1536, HVDL, Lake), Mouth(1538, HVUR, Lake), Mouth(1542, HVDn, Lake)),
      TRow(170, sea, Cape(2, 3, taiga), Cape(1, 3, taiga), taiga * 4),
      VRow(169, Mouth(1536, HVUR)),
      TRow(168, Cape(2, 1), Isle(), Cape(1, 0), forest * 2, taiga * 2),
      TRow(166, Cape(2, 2), Cape(1, 5), land * 2, forest * 2, land, forest),
      VRow(165, Mouth(1520, HVUL)),
      TRow(164, Cape(1, 5), land * 7),
      TRow(162, land * 9),
      ...
      TRow(154, land * 2, hilly * 2, land * 3, Cape(3, 2), land * 2),
      VRow(153, Mouth(1540, HVUR)),
      TRow(152, hilly * 2, land * 2, sea, Cape(3, 3), Cape(3, 1), Cape(2, 3, hilly), land * 2),
      TRow(150, hilly, hilly * 3, sea * 5, Cape(1, 4, mtain), hilly),
      VRow(149, Mouth(1554, HVDR)),
      TRow(148, Cape(2, 0, hilly), Cape(1, 4, hilly), land, hilly * 2, Cape(1, 0, hilly), mtain, hilly * 2, Cape(1, 0, mtain), hilly),
      VRow(147, Mouth(1526, HVUL)),
      TRow(146, Cape(2, 1, hilly), Cape(1, 4, hilly), Cape(2, 1, hilly), hilly * 2, hillyDesert * 3, mtain, hillyDesert * 2),
      VRow(145, BendOut(1518, HVDR), Mouth(1522, HVDL), Mouth(1524, HVUR)),
      TRow(144, Cape(3, 2, hilly), sea, hilly, sea, hilly * 4, hillyDesert, land, mtain),
      VRow(143, Mouth(1544, HVUp)),
      TRow(142, sea * 5, Cape(3, 2, hilly), sea, Cape(3, 2, hilly), Cape(1, 4, hilly), desert * 3),
      TRow(140, sea * 3, Isle(hilly), sea * 2, Isle(hilly), sea, hilly, desert * 3),
      TRow(138, sea * 2, Cape(3, 5, desert), sea * 5, hilly, desert * 3),
