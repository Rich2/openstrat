...
{ override implicit val grid: EGrid220LongFull = EGrid220.e30(132)
  ...
  { override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(154, oceanic * 2, hillyOce * 2, oceanic * 3, savannah * 3),
      VRow(153, MouthOld(1540, HVUR)),
      TRow(152, hillyOce * 2, oceanic * 2, sea, hillySavannah, hillySavannah, hillySubForest, savannah * 2),
      ...
      VRow(149, BendIn(1514, HVUp, 13), Bend(1516, HVDn, 6, 7), Bend(1518, HVDL, 13, 7), MouthRt(1534, HVDL), BendIn(1536, HVDn, 13), BendOut(1538, HVUp, 7),
        MouthLt(1540, HVUR, 7), BendMax(1550, HVUp), BendMax(1552, HVDn), SourceMin(1554, HVUL)),
