...
{ override implicit val grid: EGrid220LongFull = EGrid220.e30(132)
  ...
  { override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(178, taiga * 4, Headland(3, 5, Level, Tundra)),
      VRow(177, MouthUp(1530), MouthDL(1538), VertInUL(1544)),
      TRow(176, Headland(1, 2, Level, Taiga), taiga * 2, Headland(3, 0, Level, Taiga), Headland(2, 4, Level, Taiga), taiga),
      VRow(175, MouthDL(1540), MouthDR(1544)),
      TRow(174, Headland(1, 2, Level, Taiga), Headland(1, 5, Level, Taiga), taiga * 4),
      VRow(173, MouthUL(1540, Lake), VertInDL(1542, Lake, Lake)),
      TRow(172, Headland(1, 2, Level, Taiga), Headland(1, 5, Level, Taiga), taiga * 5),
      VRow(171, MouthDL(1536, Lake), MouthUR(1538, Lake), MouthDn(1542, Lake)),
      TRow(170, sea, Headland(2, 3, Level, Taiga), Headland(1, 3, Level, Taiga), taiga * 4),
      VRow(169, MouthUR(1536)),
      TRow(168, Headland(2, 1), Headland(2, 5), Headland(1, 0), forest * 2, taiga * 2),
      TRow(166, Headland(2, 2), Headland(1, 5), plain * 2, forest * 2, plain, forest),
      ...
      TRow(150, Headland(1, 4, Hilly), hills * 3, sea * 5, Headland(1, 4, Mountains), hills),
      VRow(149, MouthDR(1554)),
      TRow(148, Headland(2, 0, Hilly), Headland(1, 4, Hilly), plain, hills * 2, Headland(1, 0, Hilly), mtain, hills * 2, Headland(1, 0, Mountains), hills),
      VRow(147, MouthUL(1526)),
      TRow(146, Headland(2, 1, Hilly), Headland(1, 4, Hilly), Headland(2, 1, Hilly), hills * 2, desertHills * 3, mtain, desertHills * 2),
