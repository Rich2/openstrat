...
{ override implicit val grid: EGrid220LongFull = EGrid220.e30(132)
  ...
  { override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(156, level * 2, mtain, level * 6, desert),
      ...
      TRow(148, hilly * 2, level, hilly * 2, Cape(0, 1, hilly), mtain, hilly * 2, Cape(0, 1, mtain), hilly),
      ...
      TRow(144, hilly, sea, hilly, sea, hilly * 4, hillyDesert, level, mtain),
