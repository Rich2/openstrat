...
{ override implicit val grid: EGrid220LongFull = EGrid220.e30(132)
  ...
  { override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(170, sea, Cape(3, 2, taiga), taiga, taiga * 4),
      VRow(169, BendIn(1532, HVDn, 13, sea, SeaIceWinter), BendIn(1534, HVUp, 13, SeaIceWinter), MouthRt(1536, HVUR, 7, SeaIceWinter)),
      TRow(168, Cape(1, 2), Isle(), land, forest * 2, taiga * 2),
