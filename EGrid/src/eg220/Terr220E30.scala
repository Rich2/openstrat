...
{ override implicit val grid: EGrid220LongFull = EGrid220.e30(132)
  ...
  { override val rows: RArr[RowBase] = RArr(
    ...
    TRow(198, SeaIcePerm),
    TRow(196, SeaIcePerm),
    TRow(194, Isle10(hillyIce)),
    VRow(193, SetSep(1534, SeaIceWinter), SetSep(1536, SeaIceWinter)),
    ...
    VRow(139, OrigLt(1512, HVUL, 7), OrigRt(1520, HVUR, 7), BendIn(1522, HVDn, 11), BendOut(1524, HVUp, 7), ThreeUp(1526, 9, 13, 0), ThreeDown(1528, 9, 0, 13),
