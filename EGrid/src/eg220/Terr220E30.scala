...
{ override implicit val grid: EGrid220LongFull = EGrid220.e30(132)
  ...
  { override val rowDatas: RArr[RowBase] = RArr(
      ...
      VRow(173, BendInOut(1526, HVDR, 12, 5), BendIn(1528, HVUL), Mouth(1540, HVUL, Lake), BendAll(1542, HVDL, Lake)),
      TRow(172, taiga, taiga, taiga * 5),
      VRow(171, BendInOut(1526, HVUR, 7, 7), BendIn(1528, HVDL, 13), Mouth(1536, HVDL, Lake), Mouth(1538, HVUR, Lake), Mouth(1542, HVDn, Lake)),
      ...
      VRow(165, Mouth(1522, HVDL, sea, 7), BendInOut(1524, HVUL, 13, 7)),
