...
{ override implicit val grid: EGrid220LongFull = EGrid220.e30(132)
  ...
  { override val rowDatas: RArr[RowBase] = RArr(
      TRow(182, Cape.a(5, 2, hillyTundra), Cape.a(0, 2, hillyTundra), sea * 3),
      TRow(180, hillyTundra, taiga, tundra, Cape.a(0, 2, hillyTundra), sea),
      TRow(178, taiga * 4, Cape.a(5, 3, tundra)),
      VRow(177, Mouth(1530, HVUp), Mouth(1538, HVDL), BendAll(1544, HVUL)),
      TRow(176, Cape.a(2, 1, taiga), taiga * 2, Cape.a(0, 3, taiga), Cape.a(4, 2, taiga), taiga),
      VRow(175, Mouth(1540, HVDL), Mouth(1544, HVDR)),
      TRow(174, Cape.a(2, 1, taiga), Cape.a(5, 1, taiga), taiga * 4),
      VRow(173, Mouth(1540, HVUL, Lake), BendAll(1542, HVDL, Lake)),
      TRow(172, Cape.a(2, 1, taiga), Cape.a(5, 1, taiga), taiga * 5),
      VRow(171, Mouth(1536, HVDL, Lake), Mouth(1538, HVUR, Lake), Mouth(1542, HVDn, Lake)),
      TRow(170, sea, Cape.a(3, 2, taiga), Cape.a(3, 1, taiga), taiga * 4),
      VRow(169, Mouth(1536, HVUR)),
      TRow(168, Cape.a(1, 2), Isle(), Cape.a(0, 1), forest * 2, taiga * 2),
      TRow(166, Cape.a(2, 2), Cape.a(5, 1), land * 2, forest * 2, land, forest),
      VRow(165, Mouth(1520, HVUL)),
      TRow(164, Cape.a(5, 1), land * 7),
      TRow(162, land * 9),
      ...
      TRow(154, land * 2, hilly * 2, land * 3, Cape.a(2, 3), land * 2),
      VRow(153, Mouth(1540, HVUR)),
      TRow(152, hilly * 2, land * 2, sea, Cape.a(3, 3), Cape.a(1, 3), Cape.a(3, 2, hilly), land * 2),
      TRow(150, hilly, hilly * 3, sea * 5, Cape.a(4, 1, mtain), hilly),
      VRow(149, Mouth(1554, HVDR)),
      TRow(148, Cape.a(0, 2, hilly), Cape.a(4, 1, hilly), land, hilly * 2, Cape.a(0, 1, hilly), mtain, hilly * 2, Cape.a(0, 1, mtain), hilly),
      VRow(147, Mouth(1526, HVUL)),
      TRow(146, Cape.a(1, 2, hilly), Cape.a(4, 1, hilly), Cape.a(1, 2, hilly), hilly * 2, hillyDesert * 3, mtain, hillyDesert * 2),
      VRow(145, BendOut(1518, HVDR), Mouth(1522, HVDL), Mouth(1524, HVUR)),
      TRow(144, Cape.a(2, 3, hilly), sea, hilly, sea, hilly * 4, hillyDesert, land, mtain),
      VRow(143, Mouth(1544, HVUp)),
      TRow(142, sea * 5, Cape.a(2, 3, hilly), sea, Cape.a(2, 3, hilly), Cape.a(4, 1, hilly), desert * 3),
      TRow(140, sea * 3, Isle(hilly), sea * 2, Isle(hilly), sea, hilly, desert * 3),
      TRow(138, sea * 2, Cape.a(5, 3, desert), sea * 5, hilly, desert * 3),
