...
{ override implicit val grid: EGrid220LongFull = EGrid220.e30(132)
  ...
  { override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(154, level * 2, hilly * 2, level * 3, CapeOld(2, 3), level * 2),
      VRow(153, MouthOld(1540, HVUR)),
      TRow(152, hilly * 2, level * 2, sea, CapeOld(3, 3), CapeOld(1, 3), CapeOld(3, 2, hilly), level * 2),
      ...
      TRow(148, hilly * 2, level, hilly * 2, CapeOld(0, 1, hilly), mtainOld, hilly * 2, CapeOld(0, 1, mtainOld), hilly),
