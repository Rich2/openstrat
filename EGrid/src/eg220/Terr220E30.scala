...
{ override implicit val grid: EGrid220LongFull = EGrid220.e30(132)
  ...
  { override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(180, hillyTundra, taiga, tundra, Hland(2, 0, Hilly(Tundra)), sea),
      ...
      TRow(146, Hland(2, 1, Hilly()), Hland(1, 4, Hilly()), Hland(2, 1, Hilly()), hills * 2, hillyDesert * 3, mtain, hillyDesert * 2),
      VRow(145, Mouth(1522, HVDL), Mouth(1524, HVUR)),
      TRow(144, Hland(4, 2, Hilly()), sea, hills, sea, hills * 4, hillyDesert, plain, mtain),
