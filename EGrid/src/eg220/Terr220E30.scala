...
{ override implicit val grid: EGrid220LongFull = EGrid220.e30(132)
  ...
  { override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(174, Headland(1, 2, Plains, Taiga), Headland(1, 5, Plains, Taiga), taiga * 4),
      VRow(173, MouthUL(1540, Lake), VertInDL(1542, Lake, Lake)),
      TRow(172, Headland(1, 2, Plains, Taiga), Headland(1, 5, Plains, Taiga), taiga * 5),
      VRow(171, MouthDL(1536, Lake), MouthUR(1538, Lake), MouthDn(1542, Lake)),
      TRow(170, sea, Headland(2, 3, Plains, Taiga), Headland(1, 3, Plains, Taiga), taiga * 4),
