...
{ override implicit val grid: EGrid220LongFull = EGrid220.w60(140, 166)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rows: RArr[RowBase] = RArr(
      ...
      VRow(157, MouthLt(10742, HVDL), OrigRtRevDepr(10744, HVUR, 7), OrigRtRevDepr(10752, HVDn, 7)),
      TRow(156, mtainLakesTaiga, hillyTaiga, mtainDepr, sea * 2, hillyLakesTaiga * 2),
      VRow(155, OrigMinRevDepr(10748, HVDL), MouthLt(10750, HVUR, 7)),
      TRow(154, taiga, hillyTaiga * 4),
      TRow(152, hillyTaiga, hillyLakesTaiga, lakesTaiga, hillyLakesTaiga),
      VRow(151, BendOut(10740, HVDR, 6), OrigRtRevDepr(10742, HVUR, 7), MouthLt(10748, HVDL, 7), OrigRtRevDepr(10750, HVUR, 7)),
