...
{ override implicit val grid: EGrid220LongFull = EGrid220.w60(140, 166)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      TRow(166, hillyLakesTaiga, mtainLakesTaiga, hillyLakesTaiga, mtainOld),
      ...
      TRow(158, hillyLakesTaiga, mtainLakesTaiga, sea * 2, mtainOld, hillyLakesTaiga),
      VRow(157, MouthLt(10742, HVDL), MouthRt(10744, HVUR, 7), MouthRt(10752, HVDn, 7)),
      TRow(156, mtainLakesTaiga, hillyTaiga, mtainOld, sea * 2, hillyLakesTaiga * 2),
