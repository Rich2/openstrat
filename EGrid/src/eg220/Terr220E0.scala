...
{ override implicit val grid: EGrid220LongFull = EGrid220.e0(132, 202)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(166, sea * 2, hilly, sea, sea * 2, land, Cape.a(4, 1)),
      VRow(165, Mouth(526, HVDR), Mouth(528, HVUL)),
      TRow(164, sea, Cape.a(5, 3), Cape.a(4, 1, hilly), sea * 3, land, sea),
      VRow(163, Mouth(508, HVDR)),
      TRow(162, sea, land, Cape.a(4, 3, hilly), land, sea, Cape.a(5, 2), land * 3),
      VRow(161, Mouth(506, HVDR), BendOut(516, HVUL)),
      TRow(160, sea, Cape.a(2, 4), sea, land * 2, Cape.a(5, 1), land, hilly, land),
      VRow(159, Mouth(506, HVUR), BendAll(512, HVUp), BendAll(514, HVUL)),
      TRow(158, sea * 2, Cape.a(2, 4, hilly), Cape.a(4, 3), land, hilly * 4),
      VRow(157, Mouth(510, HVDR)),
      TRow(156, sea * 3, Cape.a(0, 1), land * 2, hilly * 2, land, hilly),
      ...
      TRow(152, sea * 4, land, hilly, mtain, hilly, land, Cape.a(4, 1, hilly)),
      VRow(151, Mouth(532, HVDR)),
      TRow(150, sea, Cape.a(4, 3, hilly), hilly * 4, hilly, Cape.a(2, 2, hilly), Cape.a(4, 5, hilly), hilly, sea),
      VRow(149, BendOut(518, HVDR), BendOut(520, HVDn), BendOut(526, HVUp)),
      TRow(148, sea * 2, land * 4, Cape.a(2, 2, hilly), sea, Cape.a(4, 3, hilly), sea, hilly),
      VRow(147, Mouth(514, HVUL), BendOut(524, HVDL)),
      TRow(146, sea, land * 4, sea * 3, Cape.a(1, 4, hilly), sea * 2),
      TRow(144, sea * 2, land * 3, sea * 5, Isle(hilly)),
      VRow(143, Mouth(512, HVDL), Mouth(516, HVDR)),
      TRow(142, sea * 3, Cape.a(2, 3, hilly), sea * 2, Cape.a(0, 1, hilly), hilly * 3, Cape.a(1, 2, hilly), sea),
      VRow(141, Mouth(530, HVDL)),
      TRow(140, sea * 2, Cape.a(5, 2, hilly), hilly, hillyDesert * 2, desert * 2, hillyDesert * 2, sea * 2),
