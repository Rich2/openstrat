...
{ override implicit val grid: EGrid220LongFull = EGrid220.e0(132)
  ...
  { override val rows: RArr[RowBase] = RArr(
    ...
    VRow(165, OrigRtRevDepr(502, HVDL), ThreeUp(504, 6, 9, 0), BendIn(506, HVDL, 7), BendOut(512, HVUR, 7), BendIn(514, HVDL, 13), OrigRtRevDepr(520, HVDn, 7),
    ...
    TRow(150, sea, hillyOce, hillyOce * 4, hillyOce, hillyOce, hillyOce, hillyOce, mtainDepr),
