...
{ override implicit val grid: EGrid220LongFull = EGrid220.e0(132, 202)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(168, sea, hillyTundra, hillyTemp, sea * 2, hillyTaiga, taiga),
      ...
      TRow(166, sea * 2, hillyTemp * 2, sea * 2, temperate, temperate),
      ...
      TRow(164, sea, temperate, hillyTemp, temperate, sea * 2, temperate, sea),
      ...
      TRow(162, sea, temperate, hillyTemp, temperate * 2, temperate * 4),
      VRow(161, MouthLt(498, HVUp), BendIn(504, HVUR, 13), MouthOld(506, HVDR), BendIn(514, HVDR, 13), Bend(516, HVUL, 13, 7)),
      TRow(160, sea, temperate, sea, temperate * 2, temperate * 2, hillyTemp, temperate),
      ...
      TRow(158, sea * 2, hillyTemp, temperate * 2, hillyTemp * 4),
      VRow(157, BendIn(504, HVUR, 13), BendIn(506, HVUp, 13), Bend(508, HVUL, 13, 7)),
      TRow(156, sea * 3, temperate * 3, hillyTemp * 2, temperate, hillyTemp),
      VRow(155, MouthOld(506, HVUL), BendOut(508, HVDL)),
      TRow(154, sea * 4, temperate * 2, hillyTemp, mtainOld * 3),
      VRow(153, BendIn(508, HVUR), MouthOld(510, HVDR)),
      VRow(153, MouthOld(530, HVUp)),
      TRow(152, sea * 4, temperate, hillyTemp, mtainOld, hillyTemp, temperate, hillyTemp),
      VRow(151, BendIn(530, HVUR, 13), BendOut(532, HVDL, 7)),
      TRow(150, sea, CapeOld(4, 3, hillyTemp), hillyTemp * 4, hillyTemp, CapeOld(2, 2, hillyTemp), CapeOld(4, 5, hillyTemp), hillyTemp, mtainOld),
      VRow(149, BendOut(518, HVDR), BendOut(520, HVDn), BendOut(526, HVUp), BendIn(532, HVUR, 13), BendIn(534, HVUp, 13), Bend(536, HVDn, 6, 7)),
      TRow(148, sea * 2, mtainOld, sahel, hillySavannah * 3, sea, CapeOld(4, 3, hillyTemp), sea, hillyTemp),
      VRow(147, MouthLt(514, HVUL), ThreeDown(516, 13, 6, 0), ThreeUp(518, 0, 6, 13), BendOut(524, HVDL), MouthLt(530, HVUL, 7), MouthRt(532, HVDR, 7)),
      TRow(146, sea, hillySavannah, hillyTemp, hillySavannah * 2, sea, hillySavannah, sea, CapeOld(1, 4, hillyTemp), sea * 2),
      ...
      TRow(142, sea * 3, hillyTemp, sea, hillySavannah * 6, sea),
      VRow(141, ThreeUp(500, 13, 13, 0), BendIn(502, HVUp, 13), MouthRt(504, HVUR, 7), MouthRt(508, HVDn, 7), MouthOld(530, HVDL)),
      TRow(140, sea * 2, hillySavannah, hillyTemp, hillyDesert * 2, desert * 2, hillyDesert * 2, sea * 2),
      TRow(138, sea * 2, temperate, desert, hillyDesert, desert * 7),
      TRow(136, sea * 2, mtainOld * 3, desert * 8),
