...
{ override implicit val grid: EGrid220LongFull = EGrid220.e0(132, 202)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      VRow(147, Mouth(514, HVUL), BendOut(524, HVDL), MouthLt(530, HVUL, 7), MouthRt(532, HVDR, 7)),
      TRow(146, sea, land * 4, sea * 3, Cape(1, 4, hilly), sea * 2),
      TRow(144, sea * 2, land * 3, sea * 5, hillySavannah),
      VRow(143, Mouth(512, HVDL), Mouth(516, HVDR)),
      TRow(142, sea * 3, Cape(2, 3, hilly), sea * 2, hilly, hilly * 3, hillySavannah, sea),
