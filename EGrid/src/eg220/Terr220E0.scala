...
{ override implicit val grid: EGrid220LongFull = EGrid220.e0(132)
  ...
  { override val rows: RArr[RowBase] = RArr(
    ...
    TRow(198, SeaIcePerm),
    TRow(196, SeaIcePerm),
    TRow(194, SeaIcePerm, SeaIceWinter),
    VRow(193, OrigLt(514, HVDn, 7, SeaIceWinter)),
    TRow(192, sea, mtainTundra),
    VRow(191, BendIn(514, HVUR, 13, sea, SeaIceWinter), BendOut(516, HVDL)),
    TRow(190, sea * 2, mtainIce),
    VRow(189, BendIn(516, HVUR, 13, SeaIceWinter, sea), OrigRt(518, HVUL, 7, SeaIceWinter)),
    ...
    TRow(168, sea, hillyTundra, hillyOce, sea * 2, mtainLakesOceForest, hillyLakesContForest),
    ...
    TRow(166, sea * 2, hillyOce * 2, sea * 2, oceanic, continental),
    ...
    VRow(149, BendIn(496, HVUR, 13), BendMin(498, HVDL, 1), BendOut(518, HVDR, 7), BendOut(520, HVDn, 7), ThreeDown(522, 13, 13, 0), ThreeUp(524, 9, 13, 13),
