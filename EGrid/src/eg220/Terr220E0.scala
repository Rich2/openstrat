...
{ override implicit val grid: EGrid220LongFull = EGrid220.e0(132, 202)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(166, sea * 2, hills, sea, sea * 2, land, Hland(1, 4)),
      VRow(165, Mouth(526, HVDR), Mouth(528, HVUL)),
      TRow(164, sea, Hland(3, 5), Hland(1, 4, hills), sea * 3, land, sea),
      VRow(163, Mouth(508, HVDR)),
      TRow(162, sea, land, Hland(3, 4, hills), land, sea, Hland(2, 5), land * 3),
      VRow(161, Mouth(506, HVDR), BendOut(516, HVUL)),
      TRow(160, sea, Hland(4, 2), sea, land * 2, Hland(1, 5), land, hills, land),
      VRow(159, Mouth(506, HVUR), BendAll(512, HVUp), BendAll(514, HVUL)),
      TRow(158, sea * 2, Hland(4, 2, hills), Hland(3, 4), land, hills * 4),
      VRow(157, Mouth(510, HVDR)),
      TRow(156, sea * 3, Hland(1, 0), land * 2, hills * 2, land, hills),
      VRow(155, Mouth(506, HVUL), BendOut(508, HVDL)),
      TRow(154, sea * 4, land * 2, hills, mtain * 3),
      VRow(153, BendIn(508, HVUR), Mouth(510, HVDR)),
      VRow(153, Mouth(530, HVUp)),
      TRow(152, sea * 4, land, hills, mtain, hills, land, Hland(1, 4, hills)),
      ...
      TRow(148, sea * 2, land * 4, Hland(2, 2, hills), sea, Hland(3, 4, hills), sea, hills),
      VRow(147, Mouth(514, HVUL), BendOut(524, HVDL)),
      TRow(146, sea, land * 4, sea * 3, Hland(4, 1, hills), sea * 2),
      TRow(144, sea * 2, land * 3, sea * 5, Isle(hills)),
