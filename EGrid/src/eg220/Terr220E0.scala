...
{ override implicit val grid: EGrid220LongFull = EGrid220.e0(132)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(160, sea, Headland(4, 2), sea, plain * 2, Headland(1, 5), plain, hills, plain),
      VRow(159, VertInUp(512), VertInUL(514)),
      TRow(158, sea * 2, Headland(4, 2, Hilly), Headland(3, 4), plain, hills * 4),
      VRow(157, MouthDR(510)),
      TRow(156, sea * 3, Headland(1, 0), plain * 2, hills * 2, plain, hills),
      ...
      TRow(150, sea, Headland(3, 4, Hilly), hills * 4, sea * 2, Isle(Hilly), hills, sea),
