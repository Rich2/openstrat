...
{ override implicit val grid: EGrid220LongFull = EGrid220.e0(132)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(160, sea, oceanic, sea, oceanic * 2, oceanic * 2, hillyOce, oceanic),
      ...
      TRow(150, sea, CapeOld(4, 3, hillyOce), hillyOce * 4, hillyOce, CapeOld(2, 2, hillyOce), CapeOld(4, 5, hillyOce), hillyOce, mtainOld),
      VRow(149, BendOut(518, HVDR), BendOut(520, HVDn), BendOut(526, HVUp), BendIn(532, HVUR, 13), BendIn(534, HVUp, 13), Bend(536, HVDn, 6, 7)),
      TRow(148, sea * 2, mtainOld, sahel, hillySavannah * 3, sea, CapeOld(4, 3, hillyOce), sea, hillyOce),
      VRow(147, MouthLt(514, HVUL), ThreeDown(516, 13, 6, 0), ThreeUp(518, 0, 6, 13), BendOut(524, HVDL), MouthLt(530, HVUL, 7), MouthRt(532, HVDR, 7)),
      TRow(146, sea, hillySavannah, hillyOce, hillySavannah * 2, sea, hillySavannah, sea, CapeOld(1, 4, hillyOce), sea * 2),
      ...
      TRow(140, sea * 2, hillySavannah, hillyOce, hillyDesert * 2, desert * 2, hillyDesert * 2, sea * 2),
      TRow(138, sea * 2, oceanic, desert, hillyDesert, desert * 7),
