...
{ override implicit val grid: EGrid220LongFull = EGrid220.e0(132, 202)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(170, sea * 2, Land(Hilly, Taiga, CivMix), SepB(), sea, hillyTaiga, taiga * 2),
      ...
      TRow(168, sea, hillyTundra, SepB(), hilly, sea * 2, Cape(3, 2, hillyTaiga), taiga),
      VRow(167, BendIn(502, HVUR, 13), ThreeDown(504, 10, 6, 0), BendIn(506, HVUL, 6), MouthLt(510, HVDn), BendAll(522, HVDn), BendAll(524, HVDL)),
      TRow(166, sea * 2, hilly, sea, sea * 2, land, Cape(4, 1)),
      VRow(165, ThreeUp(504, 6, 13, 0), BendIn(506, HVDL, 6), Mouth(526, HVDR), Mouth(528, HVUL)),
