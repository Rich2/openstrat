...
{ override implicit val grid: EGrid220LongFull = EGrid220.e0(132, 202)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(168, sea * 2, Hland(2, 0, hilly), sea * 2, Hland(2, 3, hillyTaiga), taiga),
      VRow(167, Mouth(510, HVDn), BendAll(522, HVDn), BendAll(524, HVDL)),
      TRow(166, sea * 2, hilly, sea, sea * 2, land, Hland(1, 4)),
      VRow(165, Mouth(526, HVDR), Mouth(528, HVUL)),
      TRow(164, sea, Hland(3, 5), Hland(1, 4, hilly), sea * 3, land, sea),
      VRow(163, Mouth(508, HVDR)),
      TRow(162, sea, land, Hland(3, 4, hilly), land, sea, Hland(2, 5), land * 3),
      VRow(161, Mouth(506, HVDR), BendOut(516, HVUL)),
      TRow(160, sea, Hland(4, 2), sea, land * 2, Hland(1, 5), land, hilly, land),
      VRow(159, Mouth(506, HVUR), BendAll(512, HVUp), BendAll(514, HVUL)),
      TRow(158, sea * 2, Hland(4, 2, hilly), Hland(3, 4), land, hilly * 4),
      VRow(157, Mouth(510, HVDR)),
      TRow(156, sea * 3, Hland(1, 0), land * 2, hilly * 2, land, hilly),
      ...
      TRow(152, sea * 4, land, hilly, mtain, hilly, land, Hland(1, 4, hilly)),
      VRow(151, Mouth(532, HVDR)),
      TRow(150, sea, Hland(3, 4, hilly), hilly * 4, hilly, Hland(2, 2, hilly), Hland(5, 4, hilly), hilly, sea),
      VRow(149, BendOut(518, HVDR), BendOut(520, HVDn), BendOut(526, HVUp)),
      TRow(148, sea * 2, land * 4, Hland(2, 2, hilly), sea, Hland(3, 4, hilly), sea, hilly),
      VRow(147, Mouth(514, HVUL), BendOut(524, HVDL)),
      TRow(146, sea, land * 4, sea * 3, Hland(4, 1, hilly), sea * 2),
      TRow(144, sea * 2, land * 3, sea * 5, Isle(hilly)),
      VRow(143, Mouth(512, HVDL), Mouth(516, HVDR)),
      TRow(142, sea * 3, Hland(3, 2, hilly), sea * 2, Hland(1, 0, hilly), hilly * 3, Hland(2, 1, hilly), sea),
      VRow(141, Mouth(530, HVDL)),
      TRow(140, sea * 2, Hland(2, 5, hilly), hilly, hillyDesert * 2, desert * 2, hillyDesert * 2, sea * 2),
