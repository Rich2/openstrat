...
/** Hex tile grids for Earth with a hex scale of 220km, a C scale of 80km. An area of 23577.541km. A minimum island size of 3929.590km. */
package object eg220
{
  ...
  def fullTerrsSideLayerSpawn(implicit subSys: EGrid220LongMulti): HSideLayer[WSide] =
