...
{ override implicit val grid: EGrid220LongFull = EGrid220.w90(142, 166)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      VRow(155, Mouth(9728, HVDL, 7, 3, lake), BendOut(9730, HVDn, 7, lake), BendInOut(9732, HVUp, 13, 6, lake), BendInOut(9734, HVDn, 9, 6, lake),
      ...
      TRow(142, hillyDesert, sahel * 2, hillySavannah, mtain),
    )
  }
  help.run
}