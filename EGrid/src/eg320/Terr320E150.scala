...
{ override implicit val grid: EGrid320LongFull = EGrid320.e150(120)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(162, WSeaIce * 2),
      TRow(160, WSeaIce * 2),
      TRow(158, Cape(3, 5, tundra, WSeaIce), WSeaIce * 2),
      TRow(156, tundra * 2, Cape(2, 0, tundra, WSeaIce)),
      TRow(154, tundra * 4),
      TRow(152, tundra, taiga * 3),
      TRow(150, taiga * 4),
      TRow(148, taiga * 3, sea, taiga),
      TRow(146, sea * 3, taiga, sea),
      TRow(144, sea * 3, Cape(2, 4, taiga), Cape(2, 1, taiga)),
      TRow(142, taiga * 2, sea * 2, Cape(3, 2, taiga), sea),
      TRow(140, taiga, sea * 5),
      TRow(138, Cape(2, 2, taiga), sea * 6),
      TRow(136, sea, Cape(3, 5, hillyForest), sea * 5),
      TRow(134, Cape(3, 3, hillyForest), Cape(2, 2, hillyForest), sea * 5),
      TRow(132, sea, Cape(2, 0, hilly), sea * 5),
      VRow(131, Mouth(5626, HVDn)),
      TRow(130, hilly, Cape(1, 2, hilly), sea * 6),
