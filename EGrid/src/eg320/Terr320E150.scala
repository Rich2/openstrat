...
{ override implicit val grid: EGrid320LongFull = EGrid320.e150(126, 164)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(156, tundra * 2, Headland(2, 0, Plains, Tundra)),
      TRow(154, tundra * 4),
      TRow(152, tundra, taiga * 3),
      TRow(150, taiga * 4),
      TRow(148, taiga * 3, sea, taiga),
      TRow(146, sea * 3, taiga, sea),
      TRow(144, sea * 3, Headland(2, 4, Plains, Taiga), Headland(2, 1, Plains, Taiga)),
