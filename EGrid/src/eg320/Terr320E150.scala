...
{ override implicit val grid: EGrid320LongFull = EGrid320.e150(120)
  ...
  { override val rows: RArr[RowBase] = RArr(
    ...
    VRow(147, Orig(5642, HVDR, 7, 1, siceWin), ThreeDown(5644, 13, 0, 13, siceWin)),
    TRow(146, sea * 3, taiga, hillyTaiga),
    VRow(145, BendOut(5642, HVDR, 7, siceWin), BendIn(5644, HVUL, 13,siceWin)),
    TRow(144, hillyTaiga, sea * 2, hillyTaiga * 2),
    VRow(143, BendIn(5640, HVDR, 6, siceWin), BendIn(5642, HVUL, 11, siceWin)),
    TRow(142, taiga, hillyBoreal, sea * 2, hillyTaiga),
    VRow(141, OrigMin(5638, HVUR, 3, siceWin), BendIn(5640, HVUL, 7, siceWin)),
    TRow(140, taiga),
    VRow(139, Orig(5624, HVDn ,3, 5)),
