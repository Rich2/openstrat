...
{ override implicit val grid: EGrid320LongFull = EGrid320.e150(126, 166)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(162, WSeaIce * 2),
      TRow(160, WSeaIce * 2),
      TRow(158, Headland(3, 5, Level, Tundra, WSeaIce), WSeaIce * 2),
      TRow(156, tundra * 2, Headland(2, 0, Level, Tundra, WSeaIce)),
      TRow(154, tundra * 4),
      TRow(152, tundra, taiga * 3),
      TRow(150, taiga * 4),
      TRow(148, taiga * 3, sea, taiga),
      TRow(146, sea * 3, taiga, sea),
      TRow(144, sea * 3, Headland(2, 4, Level, Taiga), Headland(2, 1, Level, Taiga)),
      TRow(142, taiga * 2, sea * 2, Headland(3, 2, Level, Taiga), sea),
      TRow(140, taiga, sea * 5),
      TRow(138, Headland(2, 2, Level, Taiga), sea * 6),
