...
{ override implicit val grid: EGrid320LongFull = EGrid320.e60(118)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(136, Cape(2, 1, level, Lake), Cape(5, 1, desert, Lake), desert * 5),
      TRow(134, Lake, desert * 5, mtainOld),
      TRow(132, mtainOld, Lake, desert * 3, mtainOld * 2),
      TRow(130, mtainOld, Cape(1, 1, mtainOld, Lake), Cape(5, 1, desert, Lake), desert * 3, mtainOld * 2),
      ...
      TRow(122, Cape(1, 1, desert), Cape(3, 2, hillyDesert), Cape(3, 1, mtainOld), desert * 3, level, desert * 2),
      TRow(120, desert * 2, sea, Cape(0, 2, hillyDesert), sea * 2, hillyDesert, level, desert),
