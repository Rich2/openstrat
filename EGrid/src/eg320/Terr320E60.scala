...
{ override implicit val grid: EGrid320LongFull = EGrid320.e60(118)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(136, Hland(1, 2, land, Lake), Hland(1, 5, desert, Lake), desert * 5),
      ...
      TRow(122, Hland(1, 1, desert), Hland(2, 3, hillyDesert), Hland(1, 3, mtain), desert * 3, land, desert * 2),
      TRow(120, desert * 2, sea, Hland(2, 0, hillyDesert), sea * 2, hillyDesert, land, desert),
