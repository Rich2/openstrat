...
{ override implicit val grid: EGrid320LongFull = EGrid320.e60(118)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(152, taiga * 4),
      TRow(150, taiga * 4),
      TRow(148, tempForest, taiga * 4),
      TRow(146, tempForest * 2, taiga * 3),
      TRow(144, tempForest * 5),
      TRow(142, temperate * 6),
      TRow(140, temperate * 2, desert * 3, temperate),
      TRow(138, temperate, desert * 6),
      VRow(137, MouthOld(2552, HVUR, 3, Lake)),
      TRow(136, CapeOld(2, 1, temperate, Lake), CapeOld(5, 1, desert, Lake), desert * 5),
      ...
      TRow(126, desert, mtainOld, desert * 5, temperate),
      TRow(124, desert, temperate, mtainOld, desert * 4, temperate * 2),
      VRow(123, MouthOld(2546, HVUL)),
      TRow(122, CapeOld(1, 1, desert), CapeOld(3, 2, hillyDesert), CapeOld(3, 1, mtainOld), desert * 3, temperate, desert * 2),
      TRow(120, desert * 2, sea, CapeOld(0, 2, hillyDesert), sea * 2, hillyDesert, temperate, desert),
      TRow(118, desert * 4, sea * 3, temperate * 2),
    )
  }
