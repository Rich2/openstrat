...
{ override implicit val grid: EGrid320LongFull = EGrid320.e60(118)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(164, WSeaIce),
      TRow(162, WSeaIce * 2),
      TRow(160, Cape(1, 5, tundra, WSeaIce), sea),
      TRow(158, Cape(4, 2, tundra), sea, tundra),
      ...
      TRow(136, Cape(1, 2, land, Lake), Cape(1, 5, desert, Lake), desert * 5),
      TRow(134, Lake, desert * 5, mtain),
      TRow(132, mtain, Lake, desert * 3, mtain * 2),
      TRow(130, mtain, Cape(1, 1, mtain, Lake), Cape(1, 5, desert, Lake), desert * 3, mtain * 2),
      ...
      TRow(122, Cape(1, 1, desert), Cape(2, 3, hillyDesert), Cape(1, 3, mtain), desert * 3, land, desert * 2),
      TRow(120, desert * 2, sea, Cape(2, 0, hillyDesert), sea * 2, hillyDesert, land, desert),
