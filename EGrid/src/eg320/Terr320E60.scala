...
{ override implicit val grid: EGrid320LongFull = EGrid320.e60(118)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(136, CapeOld(2, 1, plain, Lake), CapeOld(5, 1, desert, Lake), desert * 5),
      ...
      TRow(126, desert, mtainOld, desert * 5, plain),
      TRow(124, desert, plain, mtainOld, desert * 4, plain * 2),
      VRow(123, MouthOld(2546, HVUL)),
      TRow(122, CapeOld(1, 1, desert), CapeOld(3, 2, hillyDesert), CapeOld(3, 1, mtainOld), desert * 3, plain, desert * 2),
      TRow(120, desert * 2, sea, CapeOld(0, 2, hillyDesert), sea * 2, hillyDesert, plain, desert),
