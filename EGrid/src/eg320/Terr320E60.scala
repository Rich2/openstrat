...
{ override implicit val grid: EGrid320LongFull = EGrid320.e60(118)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(126, desert, mtain, desert * 5, level),
      TRow(124, desert, level, mtain, desert * 4, level * 2),
      VRow(123, MouthOld(2546, HVUL)),
      TRow(122, Cape(1, 1, desert), Cape(3, 2, hillyDesert), Cape(3, 1, mtain), desert * 3, level, desert * 2),
