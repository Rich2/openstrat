...
{ override implicit val grid: EGrid320LongFull = EGrid320.e60(118)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(164, WSeaIce),
      TRow(162, WSeaIce * 2),
      TRow(160, Hland(1, 5, tundra, WSeaIce), sea),
      TRow(158, Hland(4, 2, tundra), sea, tundra),
      ...
      TRow(136, Hland(1, 2, plain, Lake), Hland(1, 5, desert, Lake), desert * 5),
      TRow(134, Lake, desert * 5, mtain),
      TRow(132, mtain, Lake, desert * 3, mtain * 2),
      TRow(130, mtain, Hland(1, 1, mtain, Lake), Hland(1, 5, desert, Lake), desert * 3, mtain * 2),
      ...
      TRow(122, Hland(1, 1, desert), Hland(2, 3, hillyDesert), Hland(1, 3, mtain), desert * 3, plain, desert * 2),
      TRow(120, desert * 2, sea, Hland(2, 0, hillyDesert), sea * 2, hillyDesert, plain, desert),
