...
{ override implicit val grid: EGrid320LongFull = EGrid320.e30(118)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(152, Cape.a(2,1, taiga), taiga, Cape.a(1, 2, taiga), taiga),
      VRow(151, BendAll(1532, HVDR), Mouth(1540, HVDL)),
      TRow(150, Cape.a(2, 1, taiga), taiga * 3),
      VRow(149, Mouth(1536, HVUL, Lake), Mouth(1538, HVDR, Lake)),
      VRow(147, Mouth(1534, HVUR)),
      TRow(148, Cape.a(2, 1, taiga), Cape.a(3, 3, taiga), taiga * 3),
      TRow(146, Cape.a(5, 2), taiga * 4),
      ...
      TRow(136, hilly, land * 2, Cape.a(2), Cape.a(3, 3), Cape.a(3, 2), land),
      VRow(135, SetSide(1523), BendAll(1522, HVUR), BendOut(1536, HVDR), ThreeWay(1542), Mouth(1546, HVUR)),
      TRow(134, Cape.a(4, 1, hilly), hilly, hilly, sea * 3, mtain),
      VRow(133, Mouth(1530, HVUp), Mouth(1536, HVDn)),
      TRow(132, Cape.a(1, 2, hilly), hilly, Cape.a(4, 1, hilly), hilly * 4),
      VRow(131, VertRightsRight(1522), Mouth(1528, HVDR)),
      TRow(130, Cape.a(2, 4, hilly), Cape.a(3, 4, hilly), Cape.a(1, 3, hilly), Cape.a(3, 2, hilly), hilly * 4),
      ...
      TRow(126, sea, Cape.a(5, 2, sahel), Cape.a(0, 2, sahel), sea * 2, Cape.a(5, 1, hilly), desert * 2),
