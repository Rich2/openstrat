...
{ override implicit val grid: EGrid320LongFull = EGrid320.e30(118)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(162, Land(Mountains, IceCap, LandFree)),
      VRow(157, MouthRt(1530, HVDL, 7), MouthLt(1532, HVUR, 7)),
      TRow(156, hillyTundra, hillyTundra, sea),

      TRow(154, hillyTaiga, taiga * 2, tundra),
      VRow(153, MouthRt(1534, HVUp, 7), BendOut(1542, HVDR, 7)),
      TRow(152, taiga, taiga * 2, taiga),
      VRow(151, BendOut(1532, HVDR, 7), BendIn(1534, HVUL, 13), MouthLt(1542, HVDn, 7)),
