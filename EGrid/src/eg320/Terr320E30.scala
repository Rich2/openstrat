...
{ override implicit val grid: EGrid320LongFull = EGrid320.e30(118)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      VRow(151, BendAll(1532, HVDR), MouthOld(1540, HVDL)),
      ...
      VRow(137, MouthOld(1522, HVUp), MouthLtRt(1538, HVUp, 3, 7), BendAll(1542, HVDR), MouthOld(1544, HVUR)),
      ...
      VRow(129, BendAll(1528, HVDn), MouthOld(1536, HVUR)),
