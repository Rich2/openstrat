...
{ override implicit val grid: EGrid320LongFull = EGrid320.e30(118)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(156, Cape(2, 5, hillyTundra), Cape(2, 0, hillyTundra), sea),
      VRow(155, Mouth(1538, HVDn)),
      TRow(154, hillyTaiga, taiga * 2, Cape(4, 0, tundra)),
      VRow(153, Mouth(1534, HVUp)),
      TRow(152, Cape(1, 2, taiga), taiga, Cape(2, 1, taiga), taiga),
      VRow(151, BendAll(1532, HVDR), Mouth(1540, HVDL)),
      TRow(150, Cape(1, 2, taiga), taiga * 3),
      VRow(149, Mouth(1536, HVUL, Lake), Mouth(1538, HVDR, Lake)),
      VRow(147, Mouth(1534, HVUR)),
      TRow(148, Cape(1, 2, taiga), Cape(3, 3, taiga), taiga * 3),
      TRow(146, Cape(2, 5), taiga * 4),
      ...
      TRow(136, hilly, land * 2, Cape(1, 2), Cape(3, 3), Cape(2, 3), land),
      VRow(135, SetSide(1523), BendAll(1522, HVUR), BendOut(1536, HVDR), ThreeWay(1542), Mouth(1546, HVUR)),
      TRow(134, Cape(1, 4, hilly), hilly, hilly, sea * 3, mtain),
      VRow(133, Mouth(1530, HVUp), Mouth(1536, HVDn)),
      TRow(132, Cape(2, 1, hilly), hilly, Cape(1, 4, hilly), hilly * 4),
      VRow(131, VertRightsRight(1522), Mouth(1528, HVDR)),
      TRow(130, Cape(4, 2, hilly), Cape(4, 3, hilly), Cape(3, 1, hilly), Cape(2, 3, hilly), hilly * 4),
      ...
      TRow(126, sea, Cape(2, 5, sahel), Cape(2, 0, sahel), sea * 2, Cape(1, 5, hilly), desert * 2),
