...
{ override implicit val grid: EGrid320LongFull = EGrid320.e30(118)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(146, temperate, taiga * 4),
      VRow(145, BendOut(1526, HVUp, 7), Bend(1528, HVUL, 2, 7)),
      TRow(144, temperate * 5),
      TRow(142, temperate * 6),
      TRow(140, temperate * 6),
      TRow(138, mtainOld * 2, hillyTemp, temperate * 3, desert),
      VRow(137, MouthOld(1522, HVUp), Mouth(1538, HVUp, 3, 7), BendAllOld(1542, HVDR), MouthOld(1544, HVUR)),
      TRow(136, hillyTemp, temperate * 2, temperate, temperate, temperate, temperate),

      VRow(135, SetSep(1523), BendAllOld(1522, HVUR), BendOut(1536, HVDR, 7), ThreeUp(1538, 7, 0, 13), BendIn(1540, HVUp, 10), ThreeUp(1542, 7, 0, 7),
        MouthRt(1544, HVDR, 7)),

      TRow(134, CapeOld(4, 1, hillyTemp), hillyTemp, hillyTemp, sea * 3, mtainOld),
      VRow(133, MouthOld(1530, HVUp), MouthLt(1536, HVDn, 7)),
      TRow(132, CapeOld(1, 2, hillyTemp), hillyTemp, CapeOld(4, 1, hillyTemp), hillyTemp * 4),
      VRow(131, VertLeftsRight(1522), MouthOld(1528, HVDR)),
      TRow(130, CapeOld(2, 4, hillyTemp), CapeOld(3, 4, hillyTemp), CapeOld(1, 3, hillyTemp), CapeOld(3, 2, hillyTemp), hillyTemp * 4),
      VRow(129, BendAllOld(1528, HVDn), MouthOld(1536, HVUR)),
      TRow(128, sea * 2, Isle10(hillySavannah), sea, Isle10(hillyTemp), hillyTemp, desert * 2),
      VRow(127, BendAllOld(1528, HVUp)),
      TRow(126, sea, CapeOld(5, 2, sahel), CapeOld(0, 2, sahel), sea * 2, CapeOld(5, 1, hillyTemp), desert * 2),
