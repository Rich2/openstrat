...
{ override implicit val grid: EGrid320LongFull = EGrid320.e30(118)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(136, hilly, land * 2, Hland(1, 2), Hland(3, 3), Hland(2, 3), land),
      VRow(135, SetSide(1523), BendAll(1522, HVUR), BendOut(1536, HVDR), ThreeWay(1542), Mouth(1546, HVUR)),
      TRow(134, Hland(1, 4, hilly), hilly, hilly, sea * 3, mtain),
      VRow(133, Mouth(1530, HVUp), Mouth(1536, HVDn)),
      TRow(132, Hland(2, 1, hilly), hilly, Hland(1, 4, hilly), hilly * 4),
      VRow(131, VertRightsRight(1522), Mouth(1528, HVDR)),
      TRow(130, Hland(4, 2, hilly), Hland(4, 3, hilly), Hland(3, 1, hilly), Hland(2, 3, hilly), hilly * 4),
      ...
      TRow(126, sea, Hland(2, 5, sahel), Hland(2, 0, sahel), sea * 2, Hland(1, 5, hilly), desert * 2),
