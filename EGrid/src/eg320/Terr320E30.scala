...
{ override implicit val grid: EGrid320LongFull = EGrid320.e30(118)
  ...
  { override val rows: RArr[RowBase] = RArr(
    ...
    VRow(147, Bend(1528, HVDR, 13, 3), ThreeUp(1530, 13, 0, 10), BendIn(1532, HVUp, 13), OrigRt(1534, HVDL, 7)),
    ...
    VRow(137, OrigRt(1522, HVDn), Orig(1538, HVDn, 3, 7), BendIn(1542, HVDR), OrigRt(1544, HVDL)),
    ...
    VRow(131, BendIn(1520, HVDR), BendMax(1524, HVDR), ThreeUp(1526, 0, 6, 13), OrigLt(1528, HVUL), Bend(1530, HVUR, 10, 4), BendIn(1532, HVDL, 12)),
    ...
    VRow(125, OrigMin(1522, HVUR), Bend(1524, HVUL, 4, 2), OrigLt(1532, HVUp), OrigRt(1540, HVUp)),
    TRow(124, sahel * 4, savannah, deshot * 4),
    VRow(123, OrigLt(1538, HVDR), OrigMin(1540, HVUL)),
