...
{ override implicit val grid: EGrid320LongFull = EGrid320.e30(118)
  ...
  { override val rows: RArr[RowBase] = RArr(
    ...
    VRow(149, BendOut(1530, HVDR, 7), BendIn(1532, HVUL, 13), OrigMinRevDepr(1536, HVUL, 3, Lake), OrigMinRevDepr(1538, HVDR, 3, Lake)),
    ...
    VRow(137, OrigRt(1522, HVDn), Mouth(1538, HVUp, 3, 7), BendIn(1542, HVDR), OrigRt(1544, HVDL)),
