...
{ override implicit val grid: EGrid320LongFull = EGrid320.w30(118)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(152, Cape.a(2, 1, Hilly, IceCap, LandFree, Sea), sea, Cape.a(4, 2, hillyTundra), hillyTundra),
      TRow(150, Cape.a(2, 1, Hilly, IceCap, LandFree, Sea)),
      TRow(148, Cape.a(2, 2, tundra)),
