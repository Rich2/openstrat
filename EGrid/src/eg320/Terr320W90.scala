...
{ override implicit val grid: EGrid320LongFull = EGrid320.w90(124)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(158, Cape.a(4, 4, tundra, WSeaIce), Cape.a(4, 1, tundra, WSeaIce), Cape.a(0, 2, tundra, WSeaIce)),
      TRow(156, sea, Cape.a(1, 1, tundra), Cape.a(3, 2, tundra)),
      TRow(154, tundra * 3, sea),
      TRow(152, tundra * 2, Isle(tundra), Cape.a(4, 2, tundra)),
      TRow(150, taiga, tundra, sea * 2),
      TRow(148, taiga, tundra, sea * 2, Cape.a(4, 2, tundra)),
      TRow(146, taiga * 2, sea * 2, taiga),
      TRow(144, taiga * 3, Cape.a(0, 2, taiga), Cape.a(4, 2, taiga)),
      VRow(143, Mouth(9720, HVUp, Lake)),
      TRow(142, taiga * 4, Cape.a(1, 1, taiga), taiga),
      VRow(141, BendAll(9720, HVUR, Lake), Mouth(9722, HVDR, Lake), Mouth(9736, HVDn)),
      TRow(140, land, taiga * 5),
      VRow(139, Mouth(9732, HVDR, Lake)),
      TRow(138, land * 2, taiga, Cape.a(5, 2, land, Lake), taiga * 3),
