...
{ override implicit val grid: EGrid320LongFull = EGrid320.w90(124)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(140, level, taiga * 5),
      VRow(139, MouthOld(9732, HVDR, 3, Lake)),
      TRow(138, level * 2, taiga, CapeOld(5, 2, level, Lake), taiga * 3),
      VRow(137, MouthOld(9728, HVDn, 3, Lake), BendAllOld(9730, HVDR, Lake), MouthOld(9732, HVUR, 3, Lake)),
      TRow(136, level * 5, lake, taiga),
      VRow(135, BendAllOld(9730, HVUR, Lake), MouthOld(9732, HVDR, 3, Lake), MouthOld(9740, HVDL, 3, Lake), MouthOld(9742, HVUR, 3, Lake)),
      TRow(134, level * 6, hillyForest),
      TRow(132, desert, level * 4, hillyForest, hilly),
      TRow(130, desert, level * 5, hilly, level),
      TRow(128, desert, level * 3, hilly * 2, level, sea),
      TRow(126, desert, level * 6, sea),
      TRow(124, desert, level * 5, jungle, sea * 2),
    )
  }
  help.run
}