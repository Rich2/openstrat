...
{ override implicit val grid: EGrid320LongFull = EGrid320.w90(124)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(158, Cape(4, 4, tundra, WSeaIce), Cape(1, 4, tundra, WSeaIce), Cape(2, 0, tundra, WSeaIce)),
      TRow(156, sea, Cape(1, 1, tundra), Cape(2, 3, tundra)),
      TRow(154, tundra * 3, sea),
      TRow(152, tundra * 2, Isle(tundra), Cape(2, 4, tundra)),
      TRow(150, taiga, tundra, sea * 2),
      TRow(148, taiga, tundra, sea * 2, Cape(2, 4, tundra)),
      TRow(146, taiga * 2, sea * 2, taiga),
      TRow(144, taiga * 3, Cape(2, 0, taiga), Cape(2, 4, taiga)),
      ...
      TRow(138, land * 2, taiga, Cape(2, 5, land, Lake), taiga * 3),
