...
{ override implicit val grid: EGrid320LongFull = EGrid320.w90(124)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(160, Isle(tundra), SeaIceWinter),
      ...
      VRow(143, Mouth(9720, HVUp, 3, Lake)),
      TRow(142, taiga * 4, Cape(1, 1, taiga), taiga),
      VRow(141, BendAll(9720, HVUR, Lake), Mouth(9722, HVDR, 3, Lake), Mouth(9736, HVDn)),
      TRow(140, land, taiga * 5),
      VRow(139, Mouth(9732, HVDR, 3, Lake)),
      TRow(138, land * 2, taiga, Cape(5, 2, land, Lake), taiga * 3),
      VRow(137, Mouth(9728, HVDn, 3, Lake), BendAll(9730, HVDR, Lake), Mouth(9732, HVUR, 3, Lake)),
      TRow(136, land * 5, lake, taiga),
      VRow(135, BendAll(9730, HVUR, Lake), Mouth(9732, HVDR, 3, Lake), Mouth(9740, HVDL, 3, Lake), Mouth(9742, HVUR, 3, Lake)),
