...
{ override implicit val grid: EGrid320LongFull = EGrid320.w90(124)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(140, temperate, taiga * 5),
      VRow(139, MouthOld(9732, HVDR, 3, Lake)),
      TRow(138, temperate * 2, taiga, CapeOld(5, 2, temperate, Lake), taiga * 3),
      VRow(137, MouthOld(9728, HVDn, 3, Lake), BendAllOld(9730, HVDR, Lake), MouthOld(9732, HVUR, 3, Lake)),
      TRow(136, temperate * 5, lake, taiga),
      VRow(135, BendAllOld(9730, HVUR, Lake), MouthOld(9732, HVDR, 3, Lake), MouthOld(9740, HVDL, 3, Lake), MouthOld(9742, HVUR, 3, Lake)),
      TRow(134, temperate * 6, hillyTempForest),
      TRow(132, desert, temperate * 4, hillyTempForest, hillyTemp),
      TRow(130, desert, temperate * 5, hillyTemp, temperate),
      TRow(128, desert, temperate * 3, hillyTemp * 2, temperate, sea),
      TRow(126, desert, temperate * 6, sea),
      TRow(124, desert, temperate * 5, jungle, sea * 2),
    )
  }
  help.run
}