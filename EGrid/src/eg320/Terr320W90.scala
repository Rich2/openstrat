...
{ override implicit val grid: EGrid320LongFull = EGrid320.w90(124)
  ...
  { override val rows: RArr[RowBase] = RArr(
    ...
    VRow(149, Bend(9726, HVDR, 2, 4, siceWin), BendIn(9728, HVUL, 10, siceWin), OrigLt(9734, HVDn, 7, siceWin)),
    ...
    VRow(141, BendIn(9720, HVUR, 7, Lake), MouthOld(9722, HVDR, 3, Lake), OrigRt(9736, HVUp, 7, siceWin)),
    ...
    VRow(137, OrigLt(9728, HVUp, 6, Lake), OrigLt(9730, HVDn, 6, lake), OrigMax(9732, HVUp, lake), Orig(9734, HVDn, 2, 6, lake)),
    ...
    VRow(133, OrigLt(9732, HVUp, 7, lake), Orig(9736, HVDR, 4, 3, lake), BendIn(9738, HVUp, 13, lake),OrigRt(9740, HVDL, 7, lake)),
