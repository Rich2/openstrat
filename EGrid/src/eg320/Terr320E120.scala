...
object Terr320E120 extends Long320Terrs
{
  ...
  { val res: HCenLayer[WTile] = grid.newHCenLayer[WTile](taiga)
    ...
    wr(160, sea * 2)
    wr(158, tundra, tunHill, sea)
    wr(156, taiga * 2, mtain)
    wr(154,taiga * 3, hills)
    wr(152, taiga * 2, mtain, taigaHill)
    wr(150, taiga * 4)
    wr(148, taiga * 5)
    wr(146, taigaHill, mtain, taiga, taigaHill * 2)
    wr(144, mtain, taigaHill * 4)
    wr(142, taigaHill, taiga, taigaHill *2, taiga, taigaHill)
    wr(140, taigaHill, plain, taigaHill * 2, taiga, taigaHill)
