...
{ override implicit val grid: EGrid320LongFull = EGrid320.e120(124)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(132, plain * 3, Hland(2, 2, hills), Hland(1, 3, hills), hills, sea),
      TRow(130, desert, plain * 3, Hland(3, 0), Hland(2, 4,hills), Hland(2, 1, hills), sea),
      VRow(131, Mouth(4606, HVUL), Mouth(4614, HVUR)),
      TRow(130, desert, plain * 3, Hland(3, 0), Hland(2, 4,hills), Hland(2, 1, hills), sea),
      TRow(128, plain * 3, Hland(1, 2), sea, Hland(3, 2, hills), sea, hills),
