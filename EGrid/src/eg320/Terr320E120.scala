...
{ override implicit val grid: EGrid320LongFull = EGrid320.e120(126, 166)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
     ...
     TRow(132, plain * 3, Headland(2, 2, Hilly), Headland(1, 3, Hilly), hills, sea),
     TRow(130, desert, plain * 3, Headland(3, 0), Headland(2, 4,Hilly), Headland(2, 1, Hilly), sea),
     VRow(131, MouthUL(4606)),
     TRow(130, desert, plain * 3, Headland(3, 0), Headland(2, 4,Hilly), Headland(2, 1, Hilly), sea),
     TRow(128, plain * 3, Headland(1, 2), sea, Headland(3, 2, Hilly), sea, hills),
     TRow(126, mtain, hills, plain * 2, sea * 3, Headland(1, 2, Hilly)),
    )
  }
  help.run
}