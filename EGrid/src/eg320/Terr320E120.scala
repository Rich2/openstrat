...
{ override implicit val grid: EGrid320LongFull = EGrid320.e120(124)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(140, hillyTaiga, temperate, hillyTaiga * 2, taiga, hillyTaiga),
      TRow(138, desert * 2, temperate, hillyTemp, temperate, taiga * 2),
      TRow(136, temperate * 7),
      TRow(134, temperate * 6, sea),
      VRow(133, MouthOld(4610, HVUp)),
      TRow(132, temperate * 3, CapeOld(2, 2, hillyTemp), CapeOld(3, 1, hillyTemp), hillyTemp, sea),
      TRow(130, desert, temperate * 3, CapeOld(0, 3), CapeOld(4, 2, hillyTemp), CapeOld(1, 2, hillyTemp), sea),
      VRow(131, MouthOld(4606, HVUL), MouthOld(4614, HVUR)),
      TRow(130, desert, temperate * 3, CapeOld(0, 3), CapeOld(4, 2, hillyTemp), CapeOld(1, 2, hillyTemp), sea),
      TRow(128, temperate * 3, temperate/*2*/, sea, CapeOld(2, 3, hillyTemp), sea, hillyTemp),//check land and first hilly
      VRow(127, MouthOld(4608, HVDL)),
      TRow(126, mtainOld, hillyTemp, temperate * 2, CapeOld(0, 2), sea * 2, hillyTemp),
      VRow(125, MouthOld(4612, HVDn)),
      TRow(124, hillyTemp, mtainOld, temperate, hillyTemp * 2),
    )
  }
  help.run
}