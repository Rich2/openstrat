...
{ override implicit val grid: EGrid320LongFull = EGrid320.e120(124)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(132, land * 3, Cape(2, 2, hilly), Cape(1, 3, hilly), hilly, sea),
      TRow(130, desert, land * 3, Cape(3, 0), Cape(2, 4,hilly), Cape(2, 1, hilly), sea),
      VRow(131, Mouth(4606, HVUL), Mouth(4614, HVUR)),
      TRow(130, desert, land * 3, Cape(3, 0), Cape(2, 4,hilly), Cape(2, 1, hilly), sea),
      TRow(128, land * 3, Cape(1, 2), sea, Cape(3, 2, hilly), sea, hilly),
      VRow(127, Mouth(4608, HVDL)),
      TRow(126, mtain, hilly, land * 2, Cape(2, 0), sea * 2, hilly),
