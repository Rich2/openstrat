...
object Terr320E0 extends Long320Terrs
{
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(146, sea, hilly, sea, Hland(4, 4), Hland(3, 2, forest)),
      ...
      TRow(140, sea, Hland(4, 2, hilly), Hland(2, 5), land * 3),
      ...
      TRow(134, sea, hilly * 2, Hland(1, 2, hilly), sea, Isle(hilly), Hland(1, 1, hilly)),
      VRow(133, BendOut(514, HVDR)),
      TRow(132, sea, hilly, land, Hland(1, 2), sea, Isle(hilly), sea),
      VRow(131, BendAll(512, HVDR), MouthSpec(526, HVUL, HVRt, HVLt)),
      TRow(130, sea, Hland(3, 3), Hland(1, 3, hilly), Hland(2, 2, hilly), sea, Hland(2, 5, mtain), Hland(2, 0, hilly), Hland(2, 3, hilly)),
      VRow(129, Mouth(516, HVDn)),
      TRow(128, sea, Hland(2, 5, hilly), Hland(1, 0, hilly), hilly * 3, Hland(1, 1, hillySavannah), sea),
      VRow(127, BendOut(502, HVUL), Mouth(526, HVDn)),
      TRow(126, sea, Hland(1, 5), mtain, hillyDesert, sahel * 4),
      VRow(125, BendAll(500, HVUL)),
      TRow(124, sea, Hland(1, 5, hillyDesert), hilly, desert * 6),
