...
object Terr320E0 extends Long320Terrs
{
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(148, sea * 3, Cape(1, 4, hillyTaiga), taiga),
      VRow(147, ThreeWay(516)),
      TRow(146, sea, hilly, sea, Cape(4, 4), Cape(3, 2, forest)),
      VRow(145, Mouth(508, HVUL), Mouth(518, HVDR)),
      TRow(144, sea, Cape(2, 1), land, sea, land),
      TRow(142, sea, Cape(2, 2), Cape(1, 5), Cape(3, 1), land * 2),
      VRow(141, Mouth(504, HVUL)),
      TRow(140, sea, Cape(4, 2, hilly), Cape(2, 5), land * 3),
      ...
      TRow(134, sea, hilly * 2, Cape(1, 2, hilly), sea, Isle(hilly), Cape(1, 1, hilly)),
      VRow(133, BendOut(514, HVDR)),
      TRow(132, sea, hilly, land, Cape(1, 2), sea, Isle(hilly), sea),
      VRow(131, BendAll(512, HVDR), MouthSpec(526, HVUL, HVRt, HVLt)),
      TRow(130, sea, Cape(3, 3), Cape(1, 3, hilly), Cape(2, 2, hilly), sea, Cape(2, 5, mtain), Cape(2, 0, hilly), Cape(2, 3, hilly)),
      VRow(129, Mouth(516, HVDn)),
      TRow(128, sea, Cape(2, 5, hilly), Cape(1, 0, hilly), hilly * 3, Cape(1, 1, hillySavannah), sea),
      VRow(127, BendOut(502, HVUL), Mouth(526, HVDn)),
      TRow(126, sea, Cape(1, 5), mtain, hillyDesert, sahel * 4),
      VRow(125, BendAll(500, HVUL)),
      TRow(124, sea, Cape(1, 5, hillyDesert), hilly, desert * 6),
      VRow(123, SetSide(495), BendOut(498, HVUL)),
      TRow(122, SideB(), Cape(1, 5, desert), desert * 8),
