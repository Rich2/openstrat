...
object Terr320E0 extends Long320Terrs
{
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(146, mtain, hilly, sea, land, forest),
      VRow(145, BendIn(502, HVDR, 13), ThreeUp(504, 13, 13, 0), BendOut(506, HVDL, 7), BendOut(512, HVUR, 7), BendIn(514, HVDL, 13), BendIn(516, HVUR, 13), MouthOld(518, HVDR)),
      TRow(144, hilly, land, land, sea, land),
      VRow(143, MouthRt(502, HVDn, 7), BendIn(506, HVUR, 13), BendIn(508, HVDL, 7), BendOut(514, HVUR, 7), BendIn(516, HVDL, 13)),
      TRow(142, sea, land, land, land, land * 2),
      VRow(141, MouthLtRt(506, HVDL, 7, 7), BendIn(508, HVUL, 11), BendIn(510, HVDR, 13), BendIn(512, HVDn), BendIn(514, HVUp), BendIn(516, HVUL, 13)),
      TRow(140, sea, hilly, land, land * 3),
      ...
      VRow(135, MouthOld(516, HVUp), BendAll(526, HVUR)),
      TRow(134, sea, hilly * 2, Cape(2, 1, hilly), sea, Isle10(hilly), Cape(1, 1, hilly)),
      VRow(133, BendOut(514, HVDR)),
      TRow(132, sea, hilly, land, Cape(2, 1), sea, Isle10(hilly), sea),
      ...
      TRow(126, sea, land/*5*/, mtain, hillyDesert, sahel * 4),
