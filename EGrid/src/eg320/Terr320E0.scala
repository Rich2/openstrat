...
{ override implicit val grid: EGrid320LongFull = EGrid320.e0(118)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(146, mtainOld, hillyTemp, sea, temperate, tempForest),
      ...
      TRow(144, hillyTemp, temperate, temperate, sea, temperate),
      VRow(143, MouthRt(502, HVDn, 7), BendIn(506, HVUR, 13), BendIn(508, HVDL, 7), BendOut(514, HVUR, 7), BendIn(516, HVDL, 13)),
      TRow(142, sea, temperate, temperate, temperate, temperate * 2),
      VRow(141, Mouth(506, HVDL, 7, 7), BendIn(508, HVUL, 11), BendIn(510, HVDR, 13), BendIn(512, HVDn), BendIn(514, HVUp), BendIn(516, HVUL, 13)),
      TRow(140, sea, hillyTemp, temperate, temperate * 3),
      VRow(139, BendIn(506, HVUR, 13), BendIn(508, HVUp, 13), BendIn(510, HVUL, 13)),
      TRow(138, sea * 2, temperate * 2, hillyTemp, mtainOld * 2),
      VRow(137, MouthOld(526, HVUp)),
      TRow(136, sea * 3, temperate, hillyTemp, mtainOld, temperate),
      VRow(135, MouthOld(516, HVUp), BendAllOld(526, HVUR)),
      TRow(134, sea, hillyTemp * 2, CapeOld(2, 1, hillyTemp), sea, Isle10(hillyTemp), CapeOld(1, 1, hillyTemp)),
      VRow(133, BendOut(514, HVDR)),
      TRow(132, sea, hillyTemp, temperate, CapeOld(2, 1), sea, Isle10(hillyTemp), sea),
      VRow(131, BendAllOld(512, HVDR), MouthSpec(526, HVUL, HVRt, HVLt)),
      TRow(130, sea, CapeOld(3, 3), CapeOld(3, 1, hillyTemp), CapeOld(2, 2, hillyTemp), sea, CapeOld(5, 2, mtainOld), CapeOld(0, 2, hillyTemp), CapeOld(3, 2, hillyTemp)),
      VRow(129, MouthOld(516, HVDn)),
      TRow(128, sea, CapeOld(5, 2, hillyTemp), CapeOld(0, 1, hillyTemp), hillyTemp * 3, CapeOld(1, 1, hillySavannah), sea),
      VRow(127, BendOut(502, HVUL), MouthOld(526, HVDn)),
      TRow(126, sea, temperate/*5*/, mtainOld, hillyDesert, sahel * 4),
      VRow(125, BendAllOld(500, HVUL)),
      TRow(124, sea, CapeOld(5, 1, hillyDesert), hillyTemp, desert * 6),
