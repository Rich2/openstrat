...
{ override implicit val grid: EGrid320LongFull = EGrid320.e0(118)
  ...
  { override val rows: RArr[RowBase] = RArr(
    ...
    VRow(157, OrigRtRevDepr(518, HVDL, 7), OrigLtRevDepr(520, HVUR, 7)),
    TRow(156, sea * 3),
    TRow(154, sea * 4),
    TRow(152, sea * 3, hillyTaiga),
    VRow(151, BendIn(506, HVUL)),
    TRow(150, sea * 3, hillyTaiga),
    VRow(149, OrigLtRevDepr(514, HVUp, 7)),
    TRow(148, sea * 3, hillyTaiga, taiga),

    VRow(147, BendIn(504, HVDR, 13), OrigLtRevDepr(506, HVUR, 7), OrigRtRevDepr(512, HVUp, 7), OrigRtRevDepr(514, HVDn, 7), BendIn(516, HVDR, 13), BendIn(518, HVDn, 13),
