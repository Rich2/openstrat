...
object Terr320E0 extends Long320Terrs
{
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(144, sea, Hland(2, 1), land, sea, land),
      TRow(142, sea, Hland(2, 2), Hland(1, 5), Hland(3, 1), land * 2),
      VRow(141, Mouth(504, HVUL)),
      TRow(140, sea, Hland(4, 2, hills), Hland(2, 5), land * 3),

      TRow(138, sea * 2, land * 2, hills, mtain * 2),
      VRow(137, Mouth(526, HVUp)),
      TRow(136, sea * 3, land, hills, mtain, land),
      VRow(135, Mouth(516, HVUp), BendAll(526, HVUR)),
      TRow(134, sea, hills * 2, Hland(1, 2, hills), sea, Isle(hills), Hland(1, 1, hills)),
      VRow(133, BendOut(514, HVDR)),
      TRow(132, sea, hills, land, Hland(1, 2), sea, Isle(hills), sea),
      VRow(131, BendAll(512, HVDR), MouthSpec(526, HVUL, HVRt, HVLt)),
      TRow(130, sea, Hland(3, 3), Hland(1, 3, hills), Hland(2, 2, hills), sea, Hland(2, 5, mtain), Hland(2, 0, hills), Hland(2, 3, hills)),
      VRow(129, Mouth(516, HVDn)),
      TRow(128, sea, Hland(2, 5, hills), Hland(1, 0, hills), hills * 3, Hland(1, 1, hillySavannah), sea),
      VRow(127, BendOut(502, HVUL), Mouth(526, HVDn)),
      TRow(126, sea, Hland(1, 5), mtain, hillyDesert, sahel * 4),
      VRow(125, BendAll(500, HVUL)),
      TRow(124, sea, Hland(1, 5, hillyDesert), hills, desert * 6),
      VRow(123, SetSide(495), BendOut(498, HVUL)),
      TRow(122, SideB(), Hland(1, 5, desert), desert * 8),
