...
{ override implicit val grid: EGrid320LongFull = EGrid320.w120(122)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(160, Cape.a(5, 4, tundra, WSeaIce), Cape.a(1, 4, tundra, WSeaIce)),
      TRow(158, Cape.a(2, 4, tundra, WSeaIce), Cape.a(4, 3, tundra, WSeaIce), Cape.a(0, 2, tundra, WSeaIce)),
      TRow(156, Cape.a(0, 1, tundra, WSeaIce), Cape.a(0, 2, tundra, WSeaIce), Cape.a(2, 3, tundra, WSeaIce)),
      TRow(154, tundra * 4),
