...
{ override implicit val grid: EGrid320LongFull = EGrid320.w120(122)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(142, sea, mtainOld * 2, level * 3),
      TRow(140, sea, mtainOld * 2, level * 3),
      TRow(138, sea * 2, mtainOld * 2, level * 3),
      TRow(136, sea * 2, hillyForest, hilly, mtainOld * 2, hillyDesert),
      TRow(134, sea * 2, hilly, hillyDesert, desert, hillyDesert * 2),
      TRow(132, sea * 2, hilly * 2, hillyDesert * 2, mtainOld),
      TRow(130, sea * 3, hilly, hilly, hillyDesert * 2, mtainOld),
