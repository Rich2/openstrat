...
{ override implicit val grid: EGrid320LongFull = EGrid320.w120(122)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(142, sea, mtainOld * 2, temperate * 3),
      TRow(140, sea, mtainOld * 2, temperate * 3),
      TRow(138, sea * 2, mtainOld * 2, temperate * 3),
      TRow(136, sea * 2, hillyTempForest, hillyTemp, mtainOld * 2, hillyDesert),
      TRow(134, sea * 2, hillyTemp, hillyDesert, desert, hillyDesert * 2),
      TRow(132, sea * 2, hillyTemp * 2, hillyDesert * 2, mtainOld),
      TRow(130, sea * 3, hillyTemp, hillyTemp, hillyDesert * 2, mtainOld),
      TRow(128, sea * 3, hillyTemp, hillyDesert * 2, desert, hillyDesert),
      TRow(126, sea * 5, hillyTemp, hillyDesert, desert),
      TRow(124, sea * 6, hillyTemp, hillyTemp, hillyDesert),
    )
  }
