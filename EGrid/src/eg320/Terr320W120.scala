...
{ override implicit val grid: EGrid320LongFull = EGrid320.w120(122)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(160, Hland(4, 5, tundra, WSeaIce), Hland(4, 1, tundra, WSeaIce)),
      TRow(158, Hland(4, 2, tundra, WSeaIce), Hland(3, 4, tundra, WSeaIce), Hland(2, 0, tundra, WSeaIce)),
      TRow(156, Hland(1, 0, tundra, WSeaIce), Hland(2, 0, tundra, WSeaIce), Hland(3, 2, tundra, WSeaIce)),
      TRow(154, tundra * 4),
