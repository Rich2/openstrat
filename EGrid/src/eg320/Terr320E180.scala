...
{ override implicit val grid: EGrid320LongFull = EGrid320.e180(120)
  ...
  { override val rows: RArr[RowBase] = RArr(
    ...
    VRow(153, Orig(6662, HVDn, 6, 2, siceWin)),
    TRow(152, tundra, hillyTundra, tundra, taiga),

    VRow(151, OrigLt(6656, HVUR, 6, siceWin), BendOut(6658, HVDn, 7, siceWin), ThreeDown(6660, 9, 12, 0, siceWin), ThreeUp(6662, 13, 12, 11, siceWin),
      ThreeDown(6664, 13, 1, 12, siceWin), Orig(6666, HVDL, 2, 7, siceWin)),

    TRow(150, tundra * 2, siceWin, tundra),

    VRow(149, BendIn(6650, HVDR, 6, siceWin), BendIn(6652, HVDn, 6, siceWin), BendIn(6654, HVUp, 13, siceWin), OrigRt(6656, HVDL, 7, siceWin),
    ...
    VRow(147, Orig(6646, HVDR, 7, 1, siceWin), ThreeDown(6648, 13, 0, 13, siceWin), BendIn(6650, HVUL, 9, siceWin), BendIn(6662, HVUR, 13, siceWin),
