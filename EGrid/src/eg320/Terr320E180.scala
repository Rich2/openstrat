...
{ override implicit val grid: EGrid320LongFull = EGrid320.e180(120)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(160, WSeaIce * 2),
      TRow(158, WSeaIce * 3),
      TRow(156, Cape.a(5, 3, tundra, WSeaIce), WSeaIce * 2),
      TRow(154, tundra * 2, Cape.a(0, 2, tundra, WSeaIce), WSeaIce),
      TRow(152, tundra, sea, Cape.a(1, 4, tundra, WSeaIce), Cape.a(4, 2, taiga, WSeaIce)),
