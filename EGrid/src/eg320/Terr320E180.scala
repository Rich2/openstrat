...
{ override implicit val grid: EGrid320LongFull = EGrid320.e180(120)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(160, WSeaIce * 2),
      TRow(158, WSeaIce * 3),
      TRow(156, Hland(3, 5, tundra, WSeaIce), WSeaIce * 2),
      TRow(154, tundra * 2, Hland(2, 0, tundra, WSeaIce), WSeaIce),
      TRow(152, tundra, sea, Hland(4, 1, tundra, WSeaIce), Hland(2, 4, taiga, WSeaIce)),
