...
{ implicit val grid: EGrid80LongFull = EGrid80.e0(416, 582)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(434, sea * 6, hillyOce * 2, oceanic, deshot, hillyDesert, oceanic, hillyOce, oceanic * 2, hillyOce * 3, sea * 6, hillyOce, sea * 2, CapeOld(3, 2, hillyOce), hillyOce, mtainOld, hillyOce),
      ...
      TRow(430, sea * 5, oceanic, hillyOce * 5, deshot, hillyOce, hillyDesert, mtainOld, oceanic, sea * 8, hillyOce, CapeOld(1, 2, hillyOce), sea * 4, hillyOce),
