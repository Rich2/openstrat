...
{ implicit val grid: EGrid80LongFull = EGrid80.e0(416, 582)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      TRow(556, sea *6, Cape.a(4, 2, mtain)),
      ...
      TRow(508, Cape.a(1, 3, hillyTundra), sea * 14, taiga * 2),
      ...
      TRow(494, sea * 9, Cape.a(5, 4, hilly), sea * 3, taiga * 7),
      TRow(492, sea * 8, Cape.a(2, 4, hilly), sea * 4, taiga * 6),
      TRow(490, sea * 14, taiga * 3, hillyTaiga, taiga * 3),
      TRow(488, sea * 7, Cape.a(5, 3, hilly), Isle(hilly), sea * 6, taiga * 2, sea, Cape.a(4, 1), taiga * 2),
      TRow(486, sea * 5, Isle(hilly) * 2, mtain, Cape.a(1, 2, hilly), sea * 7, Cape.a(2, 3, hillyTaiga), sea * 2, Cape.a(4, 1), land * 2),
      VRow(485, Mouth(502, HVDL)),
      TRow(484, sea * 5, Cape.a(4, 3, hilly), mtain, hillyForest, hilly, sea * 9, Cape.a(5, 4), Cape.a(4, 1), land * 2),
      TRow(482, sea * 6, mtain * 2, hilly, sea * 8, land * 2, sea, Cape.a(4, 1), land),
      TRow(480, sea * 7, hilly * 2, sea * 9, land * 2, sea, land * 2),
      VRow(479, Mouth(550, HVUL), BendAll(552, HVDL)),
      TRow(478, sea * 6, Cape.a(3, 3, hilly), land * 2, Cape.a(0, 2), sea * 7, land * 2, Cape.a(4, 3), land * 2, sea),
      VRow(477, Mouth(552, HVDn)),
      TRow(476, sea * 5, hilly, land, Cape.a(3, 3, hilly), hilly * 2, Cape.a(1), sea * 7, land, Cape.a(1), Cape.a(2, 3), sea * 2),
      TRow(474, sea * 4, Cape.a(5, 2), land * 2, Cape.a(1, 3, hilly), sea, hilly, land, hilly, sea * 7, land * 2, sea * 3),
      VRow(473, Mouth(492, HVUL)),
      TRow(472, sea * 3, land * 3, Cape.a(1, 2), sea * 2, land, hilly, Cape.a(1, 2), sea * 6, land * 6),
      TRow(470, sea * 4, land * 3, sea, hilly * 2, land * 2, sea * 4, land * 9),
      TRow(468, sea * 4, land * 3, sea * 2, hilly * 2, land * 3, sea * 2, land * 9),
      TRow(466, sea * 3, Cape.a(3, 3), land, Cape.a(2, 2), sea * 2, hilly * 2, land * 3, sea * 2, land * 4, hilly * 2, land * 4),
      VRow(465, Mouth(514, HVDL), Mouth(502, HVDR)),
      TRow(464, sea * 9, Cape.a(5, 2), land * 3, Cape.a(0, 4), sea, land * 2, hilly * 7, land, hilly),
      TRow(462, sea * 8, Cape.a(5, 2, hilly), hilly, Cape.a(3, 1, hilly), Cape.a(3, 1), Cape.a(2, 2), sea, Cape.a(5, 1), land * 3, hilly * 8),
      TRow(460, sea * 7, Cape.a(2, 4, hilly), sea * 5, Cape.a(5, 1), land * 2, hilly * 10),
      VRow(459, Mouth(508, HVDL), Mouth(512, HVDR)),
      TRow(458, sea * 11, Cape.a(4, 2), Cape.a(0, 1), land * 6, hilly * 3, land, hilly * 3, land),
      VRow(457, Mouth(506, HVDR)),
      TRow(456, sea * 9, Cape.a(4, 3), Cape.a(0, 2), Cape.a(5, 2), land * 7, hilly * 3, land * 3, hilly * 2),
      ...
      TRow(442, sea * 12, land, forest, hilly * 3, mtain, hilly, mtain * 2, hilly, mtain * 3, hilly, Cape.a(1, 1), sea * 2),
      ...
      TRow(434, sea * 6, hilly * 2, land, desert, hillyDesert, land, hilly, land * 2, hilly * 3, sea * 6, hilly, sea * 2, Cape.a(3, 2, hilly), hilly, mtain, hilly),
      TRow(432, sea * 6, hilly * 3, land, desert, hilly * 3, desert, land, hilly * 2, sea * 7, Cape.a(5, 3, hilly), sea * 3, Cape.a(3, 2, hilly), hilly),
      TRow(430, sea * 5, land, hilly * 5, desert, hilly, hillyDesert, mtain, land, sea * 8, hilly, Cape.a(1, 2, hilly), sea * 4, hilly),
      ...
      TRow(422, sea * 6, land * 2, hilly * 4, hillyDesert, hilly, hillyDesert, land, sea * 14, Cape.a(0, 1, hilly), Cape.a(0, 1, mtain)),
      TRow(420, sea * 7, hilly, land * 3, hillyDesert, hilly * 4, sea * 14, hilly * 3),
      TRow(418, sea * 8, land, hilly * 2, mtain * 2, hillyDesert, sea * 5, hilly, mtain, sea, mtain * 2, hilly, mtain, hilly * 2, sea * 4, Cape.a(1, 4, hilly)),
