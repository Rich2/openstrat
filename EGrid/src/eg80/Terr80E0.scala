...
{ implicit val grid: EGrid80LongFull = EGrid80.e0(416)
  ...
  { override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(484, sea * 5, Head3Land(4, Hilly), mtain, forestHills, hills, sea * 9, Headland(4, 5), Headland(1, 4), plain * 2),
      ...
      TRow(476, sea * 5, hills, plain, Head3Land(3, Hilly), hills * 2, Headland(1, 1), sea * 7, plain, Head1Land(1), Head3Land(2), sea * 2),
      ...
      TRow(442, sea * 12, plain, forest, hills * 3, mtain, hills, mtain * 2, hills, mtain * 3, hills, Head1Land(1), sea * 2),
      ...
      TRow(434, sea * 6, hills * 2, plain, desert, desertHills, plain, hills, plain * 2, hills * 3, sea * 6, hills, sea * 2, Head2Land(3, Hilly), hills, mtain, hills),
      TRow(432, sea * 6, hills * 3, plain, desert, hills * 3, desert, plain, hills * 2, sea * 7, Head3Land(5, Hilly), sea * 3, Head2Land(3, Hilly), hills),
      ...
      TRow(422, sea * 6, plain * 2, hills * 4, desertHills, hills, desertHills, plain, sea * 14, Head1Land(0, Hilly), Head1Land(0, Mountains)),
      TRow(420, sea * 7, hills, plain * 3, desertHills, hills * 4, sea * 14, hills * 3),
      TRow(418, sea * 8, plain, hills * 2, mtain * 2, desertHills, sea * 5, hills, mtain, sea, mtain * 2, hills, mtain, hills * 2, sea * 4, Head4Land(1, Hilly)),
