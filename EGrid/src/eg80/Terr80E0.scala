...
{ implicit val grid: EGrid80LongFull = EGrid80.e0(416, 582)
  ...
  { override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(486, sea * 5, Isle(hills) * 2, mtain, Hland(2, 1, hills), sea * 7, Hland(3, 2, hillyTaiga), sea * 2, Hland(1, 4), plain * 2),
      ...
      TRow(474, sea * 4, Hland(2, 5), plain * 2, Hland(3, 1, hills), sea, hills, plain, hills, sea * 7, plain * 2, sea * 3),
      ...
      TRow(462, sea * 8, Hland(2, 5, hills), hills, Hland(1, 3, hills), Hland(1, 3), Hland(2, 2), sea, Hland(1, 5), plain * 3, hills * 8),
      TRow(460, sea * 7, Hland(4, 2, hills), sea * 5, Hland(1, 5), plain * 2, hills * 10),
      ...
      TRow(434, sea * 6, hills * 2, plain, desert, hillyDesert, plain, hills, plain * 2, hills * 3, sea * 6, hills, sea * 2, Hland(2, 3, hills), hills, mtain, hills),
      TRow(432, sea * 6, hills * 3, plain, desert, hills * 3, desert, plain, hills * 2, sea * 7, Hland(3, 5, hills), sea * 3, Hland(2, 3, hills), hills),
      TRow(430, sea * 5, plain, hills * 5, desert, hills, hillyDesert, mtain, plain, sea * 8, hills, Hland(2, 1, hills), sea * 4, hills),
      ...
      TRow(422, sea * 6, plain * 2, hills * 4, hillyDesert, hills, hillyDesert, plain, sea * 14, Hland(1, 0, hills), Hland(1, 0, mtain)),
      TRow(420, sea * 7, hills, plain * 3, hillyDesert, hills * 4, sea * 14, hills * 3),
      TRow(418, sea * 8, plain, hills * 2, mtain * 2, hillyDesert, sea * 5, hills, mtain, sea, mtain * 2, hills, mtain, hills * 2, sea * 4, Hland(4, 1, hills)),
