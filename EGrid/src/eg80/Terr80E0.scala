...
{ implicit val grid: EGrid80LongFull = EGrid80.e0(416, 582)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(486, sea * 5, Isle(hilly) * 2, mtain, Hland(2, 1, hilly), sea * 7, Hland(3, 2, hillyTaiga), sea * 2, Hland(1, 4), land * 2),
      VRow(485, Mouth(502, HVDL)),
      TRow(484, sea * 5, Hland(3, 4, hilly), mtain, hillyForest, hilly, sea * 9, Hland(4, 5), Hland(1, 4), land * 2),
      TRow(482, sea * 6, mtain * 2, hilly, sea * 8, land * 2, sea, Hland(1, 4), land),
      TRow(480, sea * 7, hilly * 2, sea * 9, land * 2, sea, land * 2),
      VRow(479, Mouth(550, HVUL), BendAll(552, HVDL)),
      TRow(478, sea * 6, Hland(3, 3, hilly), land * 2, Hland(2, 0), sea * 7, land * 2, Hland(3, 4), land * 2, sea),
      VRow(477, Mouth(552, HVDn)),
      TRow(476, sea * 5, hilly, land, Hland(3, 3, hilly), hilly * 2, Hland(1, 1), sea * 7, land, Hland(1, 1), Hland(3, 2), sea * 2),
      TRow(474, sea * 4, Hland(2, 5), land * 2, Hland(3, 1, hilly), sea, hilly, land, hilly, sea * 7, land * 2, sea * 3),
      VRow(473, Mouth(492, HVUL)),
      TRow(472, sea * 3, land * 3, Hland(2, 1), sea * 2, land, hilly, Hland(2, 1), sea * 6, land * 6),
      TRow(470, sea * 4, land * 3, sea, hilly * 2, land * 2, sea * 4, land * 9),
      TRow(468, sea * 4, land * 3, sea * 2, hilly * 2, land * 3, sea * 2, land * 9),
      TRow(466, sea * 3, Hland(3, 3), land, Hland(2, 2), sea * 2, hilly * 2, land * 3, sea * 2, land * 4, hilly * 2, land * 4),
      VRow(465, Mouth(514, HVDL), Mouth(502, HVDR)),
      TRow(464, sea * 9, Hland(2, 5), land * 3, Hland(4, 0), sea, land * 2, hilly * 7, land, hilly),
      TRow(462, sea * 8, Hland(2, 5, hilly), hilly, Hland(1, 3, hilly), Hland(1, 3), Hland(2, 2), sea, Hland(1, 5), land * 3, hilly * 8),
      TRow(460, sea * 7, Hland(4, 2, hilly), sea * 5, Hland(1, 5), land * 2, hilly * 10),
      VRow(459, Mouth(508, HVDL), Mouth(512, HVDR)),
      TRow(458, sea * 11, Hland(2, 4), Hland(1, 0), land * 6, hilly * 3, land, hilly * 3, land),
      VRow(457, Mouth(506, HVDR)),
      TRow(456, sea * 9, Hland(3, 4), Hland(2, 0), Hland(2, 5), land * 7, hilly * 3, land * 3, hilly * 2),
      ...
      TRow(442, sea * 12, land, forest, hilly * 3, mtain, hilly, mtain * 2, hilly, mtain * 3, hilly, Hland(1, 1), sea * 2),
      ...
      TRow(434, sea * 6, hilly * 2, land, desert, hillyDesert, land, hilly, land * 2, hilly * 3, sea * 6, hilly, sea * 2, Hland(2, 3, hilly), hilly, mtain, hilly),
      TRow(432, sea * 6, hilly * 3, land, desert, hilly * 3, desert, land, hilly * 2, sea * 7, Hland(3, 5, hilly), sea * 3, Hland(2, 3, hilly), hilly),
      TRow(430, sea * 5, land, hilly * 5, desert, hilly, hillyDesert, mtain, land, sea * 8, hilly, Hland(2, 1, hilly), sea * 4, hilly),
      ...
      TRow(422, sea * 6, land * 2, hilly * 4, hillyDesert, hilly, hillyDesert, land, sea * 14, Hland(1, 0, hilly), Hland(1, 0, mtain)),
      TRow(420, sea * 7, hilly, land * 3, hillyDesert, hilly * 4, sea * 14, hilly * 3),
      TRow(418, sea * 8, land, hilly * 2, mtain * 2, hillyDesert, sea * 5, hilly, mtain, sea, mtain * 2, hilly, mtain, hilly * 2, sea * 4, Hland(4, 1, hilly)),
