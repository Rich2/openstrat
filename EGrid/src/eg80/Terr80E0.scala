...
{ implicit val grid: EGrid80LongFull = EGrid80.e0(416)
  ...
  { override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(484, sea * 5, Hland(3, 4, Hilly()), mtain, forestHills, hills, sea * 9, Hland(4, 5), Hland(1, 4), plain * 2),
      ...
      TRow(434, sea * 6, hills * 2, plain, desert, desertHills, plain, hills, plain * 2, hills * 3, sea * 6, hills, sea * 2, Hland(2, 3, Hilly()), hills, mtain, hills),
      TRow(432, sea * 6, hills * 3, plain, desert, hills * 3, desert, plain, hills * 2, sea * 7, Hland(3, 5, Hilly()), sea * 3, Hland(2, 3, Hilly()), hills),
      TRow(430, sea * 5, plain, hills * 5, desert, hills, desertHills, mtain, plain, sea * 8, hills, Hland(2, 1, Hilly()), sea * 4, hills),
      ...
      TRow(422, sea * 6, plain * 2, hills * 4, desertHills, hills, desertHills, plain, sea * 14, Hland(1, 0, Hilly()), Hland(1, 0, Mountains())),
      TRow(420, sea * 7, hills, plain * 3, desertHills, hills * 4, sea * 14, hills * 3),
      TRow(418, sea * 8, plain, hills * 2, mtain * 2, desertHills, sea * 5, hills, mtain, sea, mtain * 2, hills, mtain, hills * 2, sea * 4, Hland(4, 1, Hilly())),
...
object WesternFront
{
  ...
  def wfSTerrs:HSideOptionalLayer[WSide, WSideSome] = wfGrid.sideOptLayerSpawn(Terr80E0.grid, Terr80E0.sTerrs)
