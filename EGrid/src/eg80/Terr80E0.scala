...
{ implicit val grid: EGrid80LongFull = EGrid80.e0(416, 582)
  ...
  { override val rows: RArr[RowBase] = RArr(
    ...
    VRow(485, SourceLt(502, HVUR, 7), BendInRt(504, HVUL, 13, 7), BendInLt(544, HVUR, 13, 7), Bend(546, HVDL, 13, 4)),
    TRow(484, sea * 5, hillyOce, mtainOld, hillyOceForest, hillyOce, sea * 8, oceanic * 2, oceanic * 3),
    VRow(483, Source(544, HVUR, 4, 2), ThreeUp(546, 13, 0, 13), BendOut(548, HVDL, 7)),
    TRow(482, sea * 6, mtainOld * 2, hillyOce * 2, sea * 7, oceanic * 2, sea, oceanic, oceanic),
    ...
    TRow(442, sea * 12, oceanic, oceForest, hillyOce * 3, mtainOld, hillyOce, mtainOld * 2, hillyOce, mtainOld * 3, hillyOce, oceanic),
    ...
    TRow(430, sea * 5, oceanic, hillyOce * 5, deshot, hillyOce, hillyDeshot, mtainOld, oceanic, sea * 8, hillyOce, hillyOce, sea * 4, hillyOce),
