...
{
  implicit val grid: EGrid80LongFull = EGrid80.e0(434)
  ...
  override val terrs: HCenLayer[WTile] =
  {
    ...
    wr(434, sea * 6, hills * 2, plain, desert, hillDesert, plain, hills, plain * 2, hills * 3, sea * 6, hills, sea * 2, hills * 2, mtain, hills)
    res
  }
