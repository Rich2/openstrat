...
{ implicit val grid: EGrid80LongFull = EGrid80.e0(416, 582)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(486, sea * 6, Isle10(hillyOce), mtainOld, CapeOld(1, 2, hillyOce), sea * 7, CapeOld(2, 3, hillyTaiga), sea * 2, CapeOld(4, 1), oceanic * 2),
      ...
      TRow(482, sea * 6, mtainOld * 2, hillyOce, sea * 8, oceanic * 2, sea, CapeOld(4, 1), oceanic),
      ...
      TRow(436, sea * 5, hillyOce * 3, oceanic * 3, desert * 2, hillyOce, mtainOld * 4, sea * 5, hillyOce, sea * 2, hillyOce * 2, mtainOld, sea),
      TRow(434, sea * 6, hillyOce * 2, oceanic, desert, hillyDesert, oceanic, hillyOce, oceanic * 2, hillyOce * 3, sea * 6, hillyOce, sea * 2, CapeOld(3, 2, hillyOce), hillyOce, mtainOld, hillyOce),
      TRow(432, sea * 6, hillyOce * 3, oceanic, desert, hillyOce * 3, desert, oceanic, hillyOce * 2, sea * 7, CapeOld(5, 3, hillyOce), sea * 3, CapeOld(3, 2, hillyOce), hillyOce),
      TRow(430, sea * 5, oceanic, hillyOce * 5, desert, hillyOce, hillyDesert, mtainOld, oceanic, sea * 8, hillyOce, CapeOld(1, 2, hillyOce), sea * 4, hillyOce),
      TRow(428, sea * 6, hillyOce * 2, oceanic * 3, desert * 2, hillyOce * 3, sea * 8, hillyOce * 2, sea * 5),
      TRow(426, sea * 6, hillyOce, oceanic * 3, hillyOce * 2, desert * 2, hillyOce, oceanic, sea * 3, oceanic, sea * 5, hillyOce, sea * 6),
      TRow(424, sea * 5, oceanic * 5, hillyOce * 6, sea * 16),
      TRow(422, sea * 6, oceanic * 2, hillyOce * 4, hillyDesert, hillyOce, hillyDesert, oceanic, sea * 14, CapeOld(0, 1, hillyOce), CapeOld(0, 1, mtainOld)),
      TRow(420, sea * 7, hillyOce, oceanic * 3, hillyDesert, hillyOce * 4, sea * 14, hillyOce * 3),
      TRow(418, sea * 8, oceanic, hillyOce * 2, mtainOld * 2, hillyDesert, sea * 5, hillyOce, mtainOld, sea, mtainOld * 2, hillyOce, mtainOld, hillyOce * 2, sea * 4, CapeOld(1, 4, hillyOce)),
      TRow(416, sea * 9, hillyOce * 2, sea * 6, mtainOld, hillyOce * 7, mtainOld, hillyOce * 2, hillyDesert, sea * 4),
    )
  }
  help.run
}
