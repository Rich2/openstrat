...
{ implicit val grid: EGrid80LongFull = EGrid80.e0(416, 582)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(464, sea * 9, Cape(5, 2), land * 3, Cape(0, 4), sea, land * 2, hilly * 7, land, hilly),
      TRow(462, sea * 8, Cape(5, 2, hilly), hilly, Cape(3, 1, hilly), Cape(3, 1), Cape(2, 2), sea, Cape(5, 1), land * 3, hilly * 8),
      TRow(460, sea * 7, Cape(2, 4, hilly), sea * 5, Cape(5, 1), land * 2, hilly * 10),
...
object WesternFront
{
  ...
  def wfTerrs: LayerHcSys[WTile] = Terr80E0.terrs.spawn(Terr80E0.grid, wfGrid)
