...
{ implicit val grid: EGrid80LongFull = EGrid80.e0(416, 582)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(486, sea * 6, Isle10(hilly), mtain, Cape(1, 2, hilly), sea * 7, Cape(2, 3, hillyTaiga), sea * 2, Cape(4, 1), level * 2),
      VRow(485, MouthOld(502, HVDL)),
      TRow(484, sea * 5, hilly, mtain, hillyForest, hilly, sea * 9, Cape(5, 4), Cape(4, 1), level * 2),
      TRow(482, sea * 6, mtain * 2, hilly, sea * 8, level * 2, sea, Cape(4, 1), level),
      ...
      TRow(476, sea * 4, mtain, hilly, level, hilly, hilly * 2, level, sea * 7, level * 2, level, sea * 2),
      ...
      TRow(454, sea * 9, level * 10, hillyForest * 2, level * 4, hilly, mtain),
      TRow(452, sea * 11, level * 9, hilly * 2, mtain * 6),
      TRow(450, sea * 12, level * 7, hilly, mtain * 8),
      TRow(448, sea * 12, level * 4, hilly * 2, level, mtain * 9),
      TRow(446, sea * 13, level * 2, hilly * 4, mtain * 3, level * 2, mtain, level * 2, hilly * 2),
      TRow(444, sea * 13, forest, level, hilly * 5, mtain * 2, hilly * 2, level * 3, sea, level),
      TRow(442, sea * 12, level, forest, hilly * 3, mtain, hilly, mtain * 2, hilly, mtain * 3, hilly, Cape(1, 1), sea * 2),
      TRow(440, sea * 13, level * 3, hilly, mtain, hilly * 3, mtain * 2, sea * 2, hilly, mtain, hilly, sea * 2),
      TRow(438, sea * 5, hilly * 3, mtain * 3, hilly, mtain * 2, hilly * 4, sea * 2, hillyForest * 2, sea * 4, hilly * 3, sea),
      TRow(436, sea * 5, hilly * 3, level * 3, desert * 2, hilly, mtain * 4, sea * 5, hilly, sea * 2, hilly * 2, mtain, sea),
      TRow(434, sea * 6, hilly * 2, level, desert, hillyDesert, level, hilly, level * 2, hilly * 3, sea * 6, hilly, sea * 2, Cape(3, 2, hilly), hilly, mtain, hilly),
      TRow(432, sea * 6, hilly * 3, level, desert, hilly * 3, desert, level, hilly * 2, sea * 7, Cape(5, 3, hilly), sea * 3, Cape(3, 2, hilly), hilly),
      TRow(430, sea * 5, level, hilly * 5, desert, hilly, hillyDesert, mtain, level, sea * 8, hilly, Cape(1, 2, hilly), sea * 4, hilly),
      ...
      TRow(422, sea * 6, level * 2, hilly * 4, hillyDesert, hilly, hillyDesert, level, sea * 14, Cape(0, 1, hilly), Cape(0, 1, mtain)),
      TRow(420, sea * 7, hilly, level * 3, hillyDesert, hilly * 4, sea * 14, hilly * 3),
      TRow(418, sea * 8, level, hilly * 2, mtain * 2, hillyDesert, sea * 5, hilly, mtain, sea, mtain * 2, hilly, mtain, hilly * 2, sea * 4, Cape(1, 4, hilly)),
