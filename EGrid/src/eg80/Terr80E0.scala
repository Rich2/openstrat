...
{ implicit val grid: EGrid80LongFull = EGrid80.e0(416, 582)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(476, sea * 4, mtain, hilly, land, hilly, hilly * 2, land, sea * 7, land, Cape(1), Cape(2, 3), sea * 2),
      VRow(475, MouthRt(480, HVDL, 7), BendOut(482, HVUL, 7), BendInOut(494, HVUR, 8, 3), BendIn(496, HVDL, 8)),
      ...
      VRow(465, MouthLt(482, HVDL, 7), BendOut(484, HVDn, 7), BendIn(486, HVUp, 13), MouthRt(488, HVUR, 7), MouthRt(498, HVDL, 7),
        BendIn(500, HVDn, 13), Mouth(502, HVDR), Mouth(514, HVDL), BendIn(516, HVDn), ThreeDown(518, 0, 13, 6), BendIn(520, HVDn, 13), Mouth(522, HVDR)),
