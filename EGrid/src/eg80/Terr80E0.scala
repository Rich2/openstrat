...
{ implicit val grid: EGrid80LongFull = EGrid80.e0(416, 582)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(508, Cape(3, 1, hillyTundra), sea * 14, taiga * 2),
      ...
      TRow(494, sea * 9, Cape(4, 5, hilly), sea * 3, taiga * 7),
      TRow(492, sea * 8, Cape(4, 2, hilly), sea * 4, taiga * 6),
      TRow(490, sea * 14, taiga * 3, hillyTaiga, taiga * 3),
      TRow(488, sea * 7, Cape(3, 5, hilly), Isle(hilly), sea * 6, taiga * 2, sea, Cape(1, 4), taiga * 2),
      TRow(486, sea * 5, Isle(hilly) * 2, mtain, Cape(2, 1, hilly), sea * 7, Cape(3, 2, hillyTaiga), sea * 2, Cape(1, 4), land * 2),
      VRow(485, Mouth(502, HVDL)),
      TRow(484, sea * 5, Cape(3, 4, hilly), mtain, hillyForest, hilly, sea * 9, Cape(4, 5), Cape(1, 4), land * 2),
      TRow(482, sea * 6, mtain * 2, hilly, sea * 8, land * 2, sea, Cape(1, 4), land),
      TRow(480, sea * 7, hilly * 2, sea * 9, land * 2, sea, land * 2),
      VRow(479, Mouth(550, HVUL), BendAll(552, HVDL)),
      TRow(478, sea * 6, Cape(3, 3, hilly), land * 2, Cape(2, 0), sea * 7, land * 2, Cape(3, 4), land * 2, sea),
      VRow(477, Mouth(552, HVDn)),
      TRow(476, sea * 5, hilly, land, Cape(3, 3, hilly), hilly * 2, Cape(1, 1), sea * 7, land, Cape(1, 1), Cape(3, 2), sea * 2),
