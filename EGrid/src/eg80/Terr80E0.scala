...
{ implicit val grid: EGrid80LongFull = EGrid80.e0(416, 582)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      VRow(465, MouthRt(498, HVDL, sea, 7), BendIn(500, HVDn, 13), Mouth(502, HVDR), Mouth(514, HVDL), BendIn(516, HVDn), ThreeWay(518), BendIn(520, HVDn, 13), Mouth(522, HVDR)),
      TRow(464, sea * 9, land, land * 4, SideB(), land * 3, hilly * 7, land, hilly),
      VRow(463, BendIn(492, HVDR, 13), MouthLt(494, HVUR, sea, 7), BendAll(516, HVDR), BendIn(518, HVUL)),
      ...
      VRow(459, BendIn(490, HVUR, 13), BendIn(492, HVUp, 13), MouthRt(494, HVUR, sea, 7), Mouth(508, HVDL), Mouth(512, HVDR)),
