...
{ implicit val grid: EGrid80LongFull = EGrid80.e0(416, 582)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(474, sea * 4, Cape(2, 5), land * 2, Cape(3, 1, hilly), sea, hilly, land, hilly, sea * 7, land * 2, sea * 3),
      VRow(473, Mouth(492, HVUL)),
      TRow(472, sea * 3, land * 3, Cape(2, 1), sea * 2, land, hilly, Cape(2, 1), sea * 6, land * 6),
      ...
      TRow(464, sea * 9, Cape(2, 5), land * 3, Cape(4, 0), sea, land * 2, hilly * 7, land, hilly),
      TRow(462, sea * 8, Cape(2, 5, hilly), hilly, Cape(1, 3, hilly), Cape(1, 3), Cape(2, 2), sea, Cape(1, 5), land * 3, hilly * 8),
      TRow(460, sea * 7, Cape(4, 2, hilly), sea * 5, Cape(1, 5), land * 2, hilly * 10),
      VRow(459, Mouth(508, HVDL), Mouth(512, HVDR)),
      TRow(458, sea * 11, Cape(2, 4), Cape(1, 0), land * 6, hilly * 3, land, hilly * 3, land),
      VRow(457, Mouth(506, HVDR)),
      TRow(456, sea * 9, Cape(3, 4), Cape(2, 0), Cape(2, 5), land * 7, hilly * 3, land * 3, hilly * 2),
      ...
      TRow(434, sea * 6, hilly * 2, land, desert, hillyDesert, land, hilly, land * 2, hilly * 3, sea * 6, hilly, sea * 2, Cape(2, 3, hilly), hilly, mtain, hilly),
      TRow(432, sea * 6, hilly * 3, land, desert, hilly * 3, desert, land, hilly * 2, sea * 7, Cape(3, 5, hilly), sea * 3, Cape(2, 3, hilly), hilly),
      TRow(430, sea * 5, land, hilly * 5, desert, hilly, hillyDesert, mtain, land, sea * 8, hilly, Cape(2, 1, hilly), sea * 4, hilly),
      ...
      TRow(422, sea * 6, land * 2, hilly * 4, hillyDesert, hilly, hillyDesert, land, sea * 14, Cape(1, 0, hilly), Cape(1, 0, mtain)),
      TRow(420, sea * 7, hilly, land * 3, hillyDesert, hilly * 4, sea * 14, hilly * 3),
      TRow(418, sea * 8, land, hilly * 2, mtain * 2, hillyDesert, sea * 5, hilly, mtain, sea, mtain * 2, hilly, mtain, hilly * 2, sea * 4, Cape(4, 1, hilly)),
