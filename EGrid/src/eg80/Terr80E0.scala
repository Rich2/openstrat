...
{ implicit val grid: EGrid80LongFull = EGrid80.e0(416, 582)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(488, sea * 7, Cape(1, 1, hilly), Isle(hilly), sea * 6, taiga * 2, sea, Cape(4, 1), taiga * 2),
      TRow(486, sea * 6, Isle(hilly), mtain, Cape(1, 2, hilly), sea * 7, Cape(2, 3, hillyTaiga), sea * 2, Cape(4, 1), land * 2),
      ...
      VRow(477, Mouth(492, HVUL), ThreeWay(494), Mouth(496, HVUR), Mouth(552, HVDn)),
      TRow(476, sea * 5, hilly, land, hilly, hilly * 2, land, sea * 7, land, Cape(1), Cape(2, 3), sea * 2),
      VRow(475, BendAll(494, HVUR), BendIn(496, HVDL)),
      TRow(474, sea * 4, Cape(5, 2), land * 2, hilly, SideB(), sea, hilly, land, hilly, sea * 7, land * 2, sea * 3),
      ...
      VRow(465, MouthRt(498, HVDL, 7), BendIn(500, HVDn, 13), Mouth(502, HVDR), Mouth(514, HVDL), BendIn(516, HVDn), ThreeWay(518), BendIn(520, HVDn, 13), Mouth(522, HVDR)),
      ...
      VRow(459, BendIn(490, HVUR, 13), BendIn(492, HVUp, 13), MouthRt(494, HVUR, 7), Mouth(508, HVDL), Mouth(512, HVDR)),
