...
{ override implicit val grid: EGrid80LongFull = EGrid80.e30(410)
  ...
  { override val rowDatas: RArr[RowBase] = RArr(
      TRow(556, Cape(1, 1, mtain), ice, Cape(1, 2, ice), sea * 4),
      VRow(555, BendOut(1526, HVUR)),
      TRow(554, Cape(2, 1, mtain), Cape(3, 2, ice), sea * 5),
      TRow(552, ice, sea * 7),
      ...
      TRow(488, taiga, sea * 4, Cape(2, 1), land * 15),
      TRow(486, land, sea * 4, Cape(2, 2), sea, land * 15),
      TRow(484, land, sea, land, sea, Cape(2, 5), sea, land * 16),
      TRow(482, land, sea * 3, Cape(1, 5), land * 17),
      TRow(480, land, sea * 3, Cape(2, 4), land * 18),
      ...
      TRow(450, hilly, land * 5, hilly * 3, mtain * 2, hilly * 3, land * 7, sea, Cape(1, 5), land * 5),
      ...
      TRow(438, sea, Cape(2, 3, mtain), mtain * 4, hilly, mtain * 2, hilly * 4, sea * 13, mtain * 3, land),
      TRow(436, Sea * 2, Cape(2, 3, mtain), mtain, hilly * 2, mtain * 2, hilly * 2, land * 2, sea * 14, land, hilly, mtain * 2),

      TRow(434, Cape(2, 1, hilly), sea * 3, hilly, mtain, hilly * 2, mtain, hilly * 2, land, hilly, sea * 4, hilly * 4, sea * 6, hilly, mtain,
        hilly * 2),

      TRow(432, hilly, Cape(2, 0), sea * 2, Cape(2, 4, hilly), mtain, hilly * 6, land * 2, hilly, hilly * 7, land, hilly * 8),
      ...
      TRow(424, Cape(1, 5, hilly), sea * 4, hilly, mtain, hilly * 2, sea * 3, hilly * 5, hillyDesert, desert * 2, hillyDesert * 6, mtain * 2, hillyDesert, lake,
      hillyDesert, mtain),

      VRow(423, BendAll(1500, HVUp)),

      TRow(422, Cape(4, 2, mtain), sea * 4, Isle(hilly), Cape(3, 4, hilly), Cape(2, 0, mtain), hilly * 2, sea * 2, hilly * 7, desert,
      ...
      TRow(418, SideB(), sea * 7, hilly, sea * 5, hilly * 5, mtain, hilly * 2, Cape(1, 3) * 2, hilly, desert * 2, land, desert * 3, hillyDesert * 2, mtain),
      VRow(417, Mouth(1564, HVUR)),

      TRow(416, sea * 10, sea * 4, Isle(hilly), sea, Cape(3, 2, mtain), sea * 2, Cape(2, 3, mtain), Cape(2, 2, mtain), sea * 2, hilly, land,
        desert * 7, hillyDesert),

      TRow(414, sea * 9, hilly, sea * 10, Cape(4, 5, hilly), sea, hilly * 2, desert * 8, hillyDesert),
