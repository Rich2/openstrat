...
{ override implicit val grid: EGrid80LongFull = EGrid80.e30(410)
  ...
  { override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(488, taiga, sea * 4, Hland(2, 1), plain * 15),
      TRow(486, plain, sea * 4, Hland(2, 2), sea, plain * 15),
      TRow(484, plain, sea, plain, sea, Hland(2, 5), sea, plain * 16),
      TRow(482, plain, sea * 3, Hland(1, 5), plain * 17),
      TRow(480, plain, sea * 3, Hland(2, 4), plain * 18),
