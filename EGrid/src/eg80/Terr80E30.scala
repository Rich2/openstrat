...
{ override implicit val grid: EGrid80LongFull = EGrid80.e30(410)
  ...
  { override val rowDatas: RArr[RowBase] = RArr(
      TRow(556, Cape.a(1, 1, mtain), ice, Cape.a(2, 1, ice), sea * 4),
      VRow(555, BendOut(1526, HVUR)),
      TRow(554, Cape.a(1, 2, mtain), Cape.a(2, 3, ice), sea * 5),
      TRow(552, ice, sea * 7),
      ...
      TRow(488, taiga, sea * 4, Cape.a(1, 2), land * 15),
      TRow(486, land, sea * 4, Cape.a(2, 2), sea, land * 15),
      TRow(484, land, sea, land, sea, Cape.a(5, 2), sea, land * 16),
      TRow(482, land, sea * 3, Cape.a(5, 1), land * 17),
      TRow(480, land, sea * 3, Cape.a(4, 2), land * 18),
      ...
      TRow(450, hilly, land * 5, hilly * 3, mtain * 2, hilly * 3, land * 7, sea, Cape.a(5, 1), land * 5),
      ...
      TRow(444, hilly * 3, land * 3, hilly * 4, land * 4, sea * 4, hilly * 2, Cape.a(2, 2), Cape.a(2, 3), land * 4, hilly, land * 2),
      ...
      TRow(438, sea, Cape.a(3, 2, mtain), mtain * 4, hilly, mtain * 2, hilly * 4, sea * 13, mtain * 3, land),
      TRow(436, Sea * 2, Cape.a(3, 2, mtain), mtain, hilly * 2, mtain * 2, hilly * 2, land * 2, sea * 14, land, hilly, mtain * 2),

      TRow(434, Cape.a(1, 2, hilly), sea * 3, hilly, mtain, hilly * 2, mtain, hilly * 2, land, hilly, sea * 4, hilly * 4, sea * 6, hilly, mtain,
        hilly * 2),

      TRow(432, hilly, Cape.a(0, 2), sea * 2, Cape.a(4, 2, hilly), mtain, hilly * 6, land * 2, hilly, hilly * 7, land, hilly * 8),

      TRow(430, hilly, land, sea * 2, hilly, mtain, hilly, land, hilly * 2, sea, hilly, sea, hilly * 2, mtain * 5, hilly * 3, mtain * 4, hilly * 3,
      mtain),

      TRow(428, hilly, sea, land, sea, mtain * 2, hilly * 2, hilly * 2, sea, hilly * 3, mtain, hilly * 4, hillyDesert * 2, hilly * 4, hillyDesert * 2,
      hilly * 3, land),
      ...
      TRow(424, Cape.a(5, 1, hilly), sea * 4, hilly, mtain, hilly * 2, sea * 3, hilly * 5, hillyDesert, desert * 2, hillyDesert * 6, mtain * 2, hillyDesert, lake,
      hillyDesert, mtain),

      VRow(423, BendAll(1500, HVUp)),

      TRow(422, Cape.a(2, 4, mtain), sea * 4, Isle(hilly), Cape.a(4, 3, hilly), Cape.a(0, 2, mtain), hilly * 2, sea * 2, hilly * 7, desert,
      ...
      TRow(418, SideB(), sea * 7, hilly, sea * 5, hilly * 5, mtain, hilly * 2, Cape.a(3, 1) * 2, hilly, desert * 2, land, desert * 3, hillyDesert * 2, mtain),
      VRow(417, Mouth(1564, HVUR)),

      TRow(416, sea * 10, sea * 4, Isle(hilly), sea, Cape.a(2, 3, mtain), sea * 2, Cape.a(3, 2, mtain), Cape.a(2, 2, mtain), sea * 2, hilly, land,
        desert * 7, hillyDesert),

      TRow(414, sea * 9, hilly, sea * 10, Cape.a(5, 4, hilly), sea, hilly * 2, desert * 8, hillyDesert),
