...
{ override implicit val grid: EGrid80LongFull = EGrid80.e30(410)
  ...
  { override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(450, hilly, land * 5, hilly * 3, mtain * 2, hilly * 3, land * 7, sea, Hland(1, 5), land * 5),
      ...
      TRow(444, hilly * 3, land * 3, hilly * 4, land * 4, sea * 4, hilly * 2, Hland(2, 2), Hland(2, 3), land * 4, hilly, land * 2),
      ...
      TRow(438, sea, Hland(2, 3, mtain), mtain * 4, hilly, mtain * 2, hilly * 4, sea * 13, mtain * 3, land),
      TRow(436, Sea * 2, Hland(2, 3, mtain), mtain, hilly * 2, mtain * 2, hilly * 2, land * 2, sea * 14, land, hilly, mtain * 2),

      TRow(434, Hland(2, 1, hilly), sea * 3, hilly, mtain, hilly * 2, mtain, hilly * 2, land, hilly, sea * 4, hilly * 4, sea * 6, hilly, mtain,
        hilly * 2),

      TRow(432, hilly, Hland(2, 0), sea * 2, Hland(2, 4, hilly), mtain, hilly * 6, land * 2, hilly, hilly * 7, land, hilly * 8),
      ...
      TRow(424, Hland(1, 5, hilly), sea * 4, hilly, mtain, hilly * 2, sea * 3, hilly * 5, hillyDesert, desert * 2, hillyDesert * 6, mtain * 2, hillyDesert, lake,
      hillyDesert, mtain),

      VRow(423, BendAll(1500, HVUp)),

      TRow(422, Hland(4, 2, mtain), sea * 4, Isle(hilly), Hland(3, 4, hilly), Hland(2, 0, mtain), hilly * 2, sea * 2, hilly * 7, desert,
      ...
      TRow(418, SideB(), sea * 7, hilly, sea * 5, hilly * 5, mtain, hilly * 2, Hland(1, 3) * 2, hilly, desert * 2, land, desert * 3, hillyDesert * 2, mtain),
      VRow(417, Mouth(1564, HVUR)),

      TRow(416, sea * 10, sea * 4, Isle(hilly), sea, Hland(3, 2, mtain), sea * 2, Hland(2, 3, mtain), Hland(2, 2, mtain), sea * 2, hilly, land,
        desert * 7, hillyDesert),

      TRow(414, sea * 9, hilly, sea * 10, Hland(4, 5, hilly), sea, hilly * 2, desert * 8, hillyDesert),
