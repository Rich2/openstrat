...
{ override implicit val grid: EGrid160LongFull = EGrid160.e30(256)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(272, hilly, land, hilly * 2, land * 2, land, sea, land, Hland(2, 2), Hland(2, 3), land * 3),
      TRow(270, hilly * 3, land * 4, sea * 5, mtain, hilly, land),
      TRow(268, sea, Hland(2, 3, mtain), hilly * 3, land * 2, sea * 6, land, mtain),
      TRow(266, Hland(2, 0), Hland(2, 4, mtain), hilly * 3, land * 2, hilly * 8),
      VRow(265, Mouth(1510, HVUp)),
      TRow(264, hilly, Hland(4, 1), hilly * 2, sea, Hland(2, 4, hilly),  hilly * 9),
