...
{ override implicit val grid: EGrid160LongFull = EGrid160.e30(256)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(272, hills, plain, hills * 2, plain * 2, plain, sea, plain, Headland(2, 2), Headland(2, 3), plain * 3),
      TRow(270, hills * 3, plain * 4, sea * 5, mtain, hills, plain),
      TRow(268, sea, Headland(2, 3, Mountains), hills * 3, plain * 2, sea * 6, plain, mtain),
      TRow(266, Headland(2, 0), Headland(2, 4, Mountains), hills * 3, plain * 2, hills * 8),
      VRow(265, MouthUp(1510)),
      TRow(264, hills, Headland(4, 1), hills * 2, sea, Headland(2, 4, Hilly),  hills * 9),
