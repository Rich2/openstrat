...
{ override implicit val grid: EGrid160LongFull = EGrid160.e30(256)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(294, level, sea, level * 7, taiga),
      TRow(292, level, sea, level * 9),
      TRow(290, sea, level * 10),
      TRow(288, sea * 2, level * 9),
      TRow(286, level * 12),
      TRow(284, level * 3, forest * 2, level * 7),
      TRow(282, level * 4, forest * 2, level * 7),
      TRow(280, hilly, level * 12),
      TRow(278, hilly * 3, level * 10),
      TRow(276, level, hilly, level * 12),
      TRow(274, hilly * 2, level, hilly * 3, level * 4, sea, level * 3),
      TRow(272, hilly, level, hilly * 2, level * 2, level, sea, level, CapeOld(2, 2), CapeOld(3, 2), level * 3),
      TRow(270, hilly * 3, level * 4, sea * 5, mtainOld, hilly, level),
      TRow(268, sea, CapeOld(3, 2, mtainOld), hilly * 3, level * 2, sea * 6, level, mtainOld),
      TRow(266, CapeOld(0, 2), CapeOld(4, 2, mtainOld), hilly * 3, level * 2, hilly * 8),
      VRow(265, MouthOld(1510, HVUp)),
      TRow(264, hilly, CapeOld(1, 4), hilly * 2, sea, CapeOld(4, 2, hilly),  hilly * 9),
