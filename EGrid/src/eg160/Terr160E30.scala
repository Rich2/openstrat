...
{ override implicit val grid: EGrid160LongFull = EGrid160.e30(256)
  ...
  { override val rows: RArr[RowBase] = RArr(
    ...
    TRow(270, hillySavannah, hillyOce * 2, oceanic * 4, sea * 4, mtainSub, mtainOld, hillyOce, oceanic),
    TRow(268, sea, mtainOld, hillyOce * 3, oceanic * 2, sea * 6, oceanic, mtainOld),
    TRow(266, savannah, hillySavannah, hillyOce * 3, oceanic * 2, hillyOce * 8),
    VRow(265),
    TRow(264, hillyOce, oceanic, hillyOce * 2, sea, hillyOce,  hillyOce * 9),
