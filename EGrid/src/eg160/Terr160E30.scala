...
{ override implicit val grid: EGrid160LongFull = EGrid160.e30(254)
  ...
  { override val rows: RArr[RowBase] = RArr(
    ...
    VRow(263, BendIn(1504, HVDR, 13), OrigLt(1506, HVDL, 7), BendIn(1512, HVUp, 13), BendIn(1514, HVUL, 13), Bend(1522, HVUR, 5, 5),
    ...
    VRow(259, OrigLt(1506, HVUp, 7), BendIn(1514, HVUR, 13), BendOut(1516, HVDL, 7), BendInRt(1522, HVUR, 11, 5), OrigLt(1548, HVDn, 7)),
