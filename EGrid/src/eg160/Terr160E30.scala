...
{ override implicit val grid: EGrid160LongFull = EGrid160.e30(256)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(272, hilly, level, hilly * 2, level * 2, level, sea, level, Cape(2, 2), Cape(3, 2), level * 3),
      TRow(270, hilly * 3, level * 4, sea * 5, mtainOld, hilly, level),
      TRow(268, sea, Cape(3, 2, mtainOld), hilly * 3, level * 2, sea * 6, level, mtainOld),
      TRow(266, Cape(0, 2), Cape(4, 2, mtainOld), hilly * 3, level * 2, hilly * 8),
