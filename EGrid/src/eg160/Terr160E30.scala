...
{ override implicit val grid: EGrid160LongFull = EGrid160.e30(256)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(268, sea, Cape(2, 3, mtain), hilly * 3, land * 2, sea * 6, land, mtain),
      TRow(266, Cape(2, 0), Cape(2, 4, mtain), hilly * 3, land * 2, hilly * 8),
      VRow(265, Mouth(1510, HVUp)),
      TRow(264, hilly, Cape(4, 1), hilly * 2, sea, Cape(2, 4, hilly),  hilly * 9),
