...
{ override implicit val grid: EGrid160LongFull = EGrid160.e30(256)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(272, hills, plain, hills * 2, plain * 2, plain, sea, plain, Hland(2, 2), Hland(2, 3), plain * 3),
      TRow(270, hills * 3, plain * 4, sea * 5, mtain, hills, plain),
      TRow(268, sea, Hland(2, 3, Mountains()), hills * 3, plain * 2, sea * 6, plain, mtain),
      TRow(266, Hland(2, 0), Hland(2, 4, Mountains()), hills * 3, plain * 2, hills * 8),
      VRow(265, Mouth(1510, HVUp)),
      TRow(264, hills, Hland(4, 1), hills * 2, sea, Hland(2, 4, Hilly()),  hills * 9),
      TRow(262, hills, sea * 2, hills * 2, sea, hills, hills * 4, hills * 5),
      TRow(260, sea * 3, hills, sea * 2, hills * 10),
      TRow(258, sea * 11, hills * 5),
      TRow(256, sea * 5, hills * 2, sea * 3, Isle(Hilly()), hills * 6),
    )
  }
  help.run
}