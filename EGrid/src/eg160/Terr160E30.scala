...
{ override implicit val grid: EGrid160LongFull = EGrid160.e30(256)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(270, hilly * 3, level * 4, sea * 5, mtain, hilly, level),
      TRow(268, sea, Cape(3, 2, mtain), hilly * 3, level * 2, sea * 6, level, mtain),
      TRow(266, Cape(0, 2), Cape(4, 2, mtain), hilly * 3, level * 2, hilly * 8),
