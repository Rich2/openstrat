...
{ override implicit val grid: EGrid160LongFull = EGrid160.e30(256)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(280, hilly, plain * 12),
      TRow(278, hilly * 3, plain * 10),
      TRow(276, plain, hilly, plain * 12),
      TRow(274, hilly * 2, plain, hilly * 3, plain * 4, sea, plain * 3),
      TRow(272, hilly, plain, hilly * 2, plain * 2, plain, sea, plain, CapeOld(2, 2), CapeOld(3, 2), plain * 3),
      TRow(270, hilly * 3, plain * 4, sea * 5, mtainOld, hilly, plain),
      TRow(268, sea, CapeOld(3, 2, mtainOld), hilly * 3, plain * 2, sea * 6, plain, mtainOld),
      TRow(266, CapeOld(0, 2), CapeOld(4, 2, mtainOld), hilly * 3, plain * 2, hilly * 8),
