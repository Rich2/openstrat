...
{ override implicit val grid: EGrid160LongFull = EGrid160.e30(256)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(280, hills, land * 12),
      TRow(278, hills * 3, land * 10),
      TRow(276, land, hills, land * 12),
      TRow(274, hills * 2, land, hills * 3, land * 4, sea, land * 3),
      TRow(272, hills, land, hills * 2, land * 2, land, sea, land, Hland(2, 2), Hland(2, 3), land * 3),
      TRow(270, hills * 3, land * 4, sea * 5, mtain, hills, land),
      TRow(268, sea, Hland(2, 3, mtain), hills * 3, land * 2, sea * 6, land, mtain),
      TRow(266, Hland(2, 0), Hland(2, 4, mtain), hills * 3, land * 2, hills * 8),
      VRow(265, Mouth(1510, HVUp)),
      TRow(264, hills, Hland(4, 1), hills * 2, sea, Hland(2, 4, hills),  hills * 9),
      TRow(262, hills, sea * 2, hills * 2, sea, hills, hills * 4, hills * 5),
      TRow(260, sea * 3, hills, sea * 2, hills * 10),
      TRow(258, sea * 11, hills * 5),
      TRow(256, sea * 5, hills * 2, sea * 3, Isle(hills), hills * 6),
    )
  }
  help.run
}