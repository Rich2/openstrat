...
{ override implicit val grid: EGrid160LongFull = EGrid160.e0(262)
  ...
  { override val rowDatas: RArr[RowBase] = RArr(
      TRow(310, sea * 6, Cape.a(4, 3, mtain)),
      TRow(308, sea * 7, mtain),
      TRow(306, sea * 7, Cape.a(4, 2, mtain)),
      TRow(304, sea * 7, mtain),
      TRow(302, sea * 6, Cape.a(5, 2, hillyTaiga), hillyTaiga, taiga),
      TRow(300, sea * 6, Cape.a(5, 1,  mtain), hillyTaiga * 2),
      TRow(298, sea * 6, Cape.a(4, 2, mtain), mtain, hillyTaiga * 2),
      TRow(296, sea * 6, hillyTaiga * 2, taiga * 2),
      VRow(295, Mouth(528, HVUp)),
      TRow(294, sea * 2, Isle(hilly), Cape.a(5, 3, hilly), sea * 3, hilly, Cape.a(2, 2, hillyTaiga), taiga),
      TRow(292, sea * 3, hilly, Cape.a(1, 2, hilly), sea * 4, Cape.a(5, 4), land),
      TRow(290, sea * 2, Cape.a(4, 2, hilly), hilly, sea * 4, land, Isle(), land),
      VRow(289, BendAll(502, HVDL)),
      TRow(288, sea * 2, land, Cape.a(3, 2, hilly), land, sea * 4, land, sea),
      TRow(286, sea * 2, land, Cape.a(1, 2), land * 2, sea * 3, land * 3),
      TRow(284, sea, land * 2, Cape.a(4, 2, hilly), land * 2, sea, land * 5),
      TRow(282, sea * 4, hilly, land, Cape.a(1, 3), land * 2, hilly * 2, land * 2),
      TRow(280, sea * 4, Cape.a(2, 4, hilly), sea * 2, land, hilly * 5),
      ...
      TRow(270, sea * 2, Cape.a(4, 3), Cape.a(0, 1, hilly) * 3, land * 2, hilly * 2, mtain, sea, hilly * 2, sea),
      ...
      TRow(264, sea * 3, hilly * 2, hillyDesert, hilly, Cape.a(2, 1, hilly), sea, Isle(hilly), sea * 2, hilly, sea * 2),
