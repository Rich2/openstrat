...
{ override implicit val grid: EGrid160LongFull = EGrid160.e0(262)
  ...
  { override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(292, sea * 3, hilly, CapeOld(1, 2, hilly), sea * 4, CapeOld(5, 4), level),
      TRow(290, sea * 2, CapeOld(4, 2, hilly), hilly, sea * 4, level, Isle10(), level),
      VRow(289, BendAllOld(502, HVDL)),
      TRow(288, sea * 2, level, CapeOld(3, 2, hilly), level, sea * 4, level, sea),
      VRow(287, BendIn(520, HVDR, 13),  BendIn(522, HVDn, 13), MouthLt(524, HVDR, 7)),
      TRow(286, sea * 2, level, CapeOld(1, 2), level * 2, sea * 2, level * 4),
      TRow(284, sea, level * 2, CapeOld(4, 2, hilly), level * 2, sea, level * 5),
      TRow(282, sea * 4, hilly, level, CapeOld(1, 3), level * 2, hilly * 2, level * 2),
      TRow(280, sea * 4, CapeOld(2, 4, hilly), sea * 2, level, hilly * 5),
      ...
      TRow(270, sea * 2, CapeOld(4, 3), CapeOld(0, 1, hilly) * 3, level * 2, hilly * 2, mtainOld, sea, hilly * 2, sea),
