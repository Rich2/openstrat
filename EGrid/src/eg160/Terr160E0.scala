...
{ override implicit val grid: EGrid160LongFull = EGrid160.e0(262)
  ...
  { override val rowDatas: RArr[RowBase] = RArr(
      TRow(310, sea * 6, Cape(4, 3, mtainOld)),
      TRow(308, sea * 7, mtainOld),
      TRow(306, sea * 7, Cape(4, 2, mtainOld)),
      TRow(304, sea * 7, mtainOld),
      TRow(302, sea * 6, Cape(5, 2, hillyTaiga), hillyTaiga, taiga),
      TRow(300, sea * 6, Cape(5, 1,  mtainOld), hillyTaiga * 2),
      TRow(298, sea * 6, Cape(4, 2, mtainOld), mtainOld, hillyTaiga * 2),
      TRow(296, sea * 6, hillyTaiga * 2, taiga * 2),
      VRow(295, MouthOld(528, HVUp)),
      TRow(294, sea * 2, Isle10(hilly), Cape(5, 3, hilly), sea * 3, hilly, Cape(2, 2, hillyTaiga), taiga),
      TRow(292, sea * 3, hilly, Cape(1, 2, hilly), sea * 4, Cape(5, 4), level),
      TRow(290, sea * 2, Cape(4, 2, hilly), hilly, sea * 4, level, Isle10(), level),
      VRow(289, BendAllOld(502, HVDL)),
      TRow(288, sea * 2, level, Cape(3, 2, hilly), level, sea * 4, level, sea),
      VRow(287, BendIn(520, HVDR, 13),  BendIn(522, HVDn, 13), MouthLt(524, HVDR, 7)),
      TRow(286, sea * 2, level, Cape(1, 2), level * 2, sea * 2, level * 4),
      TRow(284, sea, level * 2, Cape(4, 2, hilly), level * 2, sea, level * 5),
      TRow(282, sea * 4, hilly, level, Cape(1, 3), level * 2, hilly * 2, level * 2),
      TRow(280, sea * 4, Cape(2, 4, hilly), sea * 2, level, hilly * 5),
      TRow(278, sea * 4, level * 5, hilly, level * 2, hilly),
      TRow(276, sea * 5, level * 4, hilly * 2, mtainOld * 3),
      TRow(274, sea * 6, level * 3, hilly, mtainOld * 4),
      VRow(273, MouthOld(538, HVUp)),
      TRow(272, sea * 6, level, hilly * 2, mtainOld, hilly, mtainOld, level, hilly),
      VRow(271, BendAllOld(538, HVUR), MouthOld(540, HVDR)),
      TRow(270, sea * 2, Cape(4, 3), Cape(0, 1, hilly) * 3, level * 2, hilly * 2, mtainOld, sea, hilly * 2, sea),
      TRow(268, sea * 3, hilly, level, hillyDesert * 2, mtainOld * 2, sea * 3, Isle10(hilly), hilly * 2),
      TRow(266, sea * 2, hilly * 2, desert, hillyDesert * 2, hilly, sea * 3, hilly, sea * 2, hilly),
      VRow(265, MouthOld(514, HVUp)),
      TRow(264, sea * 3, hilly * 2, hillyDesert, hilly, Cape(2, 1, hilly), sea, Isle10(hilly), sea * 2, hilly, sea * 2),
      TRow(262, sea * 3, level * 2, hilly * 3)
    )
  }
  help.run
}
