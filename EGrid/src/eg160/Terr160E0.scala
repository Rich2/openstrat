...
{ override implicit val grid: EGrid160LongFull = EGrid160.e0(262)
  ...
  { override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(290, sea * 2, Cape(2, 4, hilly), hilly, sea * 4, land, Isle(), land),
      VRow(289, BendAll(502, HVDL)),
      TRow(288, sea * 2, land, Cape(2, 3, hilly), land, sea * 4, land, sea),
      TRow(286, sea * 2, land, Cape(2, 1), land * 2, sea * 3, land * 3),
      TRow(284, sea, land * 2, Cape(2, 4, hilly), land * 2, sea, land * 5),
      TRow(282, sea * 4, hilly, land, Cape(3, 1), land * 2, hilly * 2, land * 2),
      TRow(280, sea * 4, Cape(4, 2, hilly), sea * 2, land, hilly * 5),
      ...
      TRow(270, sea * 2, Cape(3, 4), Cape(1, 0, hilly) * 3, land * 2, hilly * 2, mtain, sea, hilly * 2, sea),
      ...
      TRow(264, sea * 3, hilly * 2, hillyDesert, hilly, Cape(1, 2, hilly), sea, Isle(hilly), sea * 2, hilly, sea * 2),
