...
{ override implicit val grid: EGrid160LongFull = EGrid160.e0(262)
  ...
  { override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(292, sea * 3, hills, Hland(2, 1, hills), sea * 4, Hland(4, 5), land),
      TRow(290, sea * 2, Hland(2, 4, hills), hills, sea * 4, land, Isle(), land),
      VRow(289, BendAll(502, HVDL)),
      TRow(288, sea * 2, land, Hland(2, 3, hills), land, sea * 4, land, sea),
      TRow(286, sea * 2, land, Hland(2, 1), land * 2, sea * 3, land * 3),
      TRow(284, sea, land * 2, Hland(2, 4, hills), land * 2, sea, land * 5),
      TRow(282, sea * 4, hills, land, Hland(3, 1), land * 2, hills * 2, land * 2),
      TRow(280, sea * 4, Hland(4, 2, hills), sea * 2, land, hills * 5),
      TRow(278, sea * 4, land * 5, hills, land * 2, hills),
      TRow(276, sea * 5, land * 4, hills * 2, mtain * 3),
      TRow(274, sea * 6, land * 3, hills, mtain * 4),
      VRow(273, Mouth(538, HVUp)),
      TRow(272, sea * 6, land, hills * 2, mtain, hills, mtain, land, hills),
      VRow(271, BendAll(538, HVUR), Mouth(540, HVDR)),
      TRow(270, sea * 2, Hland(3, 4), Hland(1, 0, hills) * 3, land * 2, hills * 2, mtain, sea, hills * 2, sea),
      TRow(268, sea * 3, hills, land, hillyDesert * 2, mtain * 2, sea * 3, Isle(hills), hills * 2),
