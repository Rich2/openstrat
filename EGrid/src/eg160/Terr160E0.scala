...
{ override implicit val grid: EGrid160LongFull = EGrid160.e0(262)
  ...
  { override val rowDatas: RArr[RowBase] = RArr(
      TRow(310, sea * 6, Cape(3, 4, mtain)),
      TRow(308, sea * 7, mtain),
      TRow(306, sea * 7, Cape(2, 4, mtain)),
      TRow(304, sea * 7, mtain),
      TRow(302, sea * 6, Cape(2, 5, hillyTaiga), hillyTaiga, taiga),
      TRow(300, sea * 6, Cape(1, 5,  mtain), hillyTaiga * 2),
      TRow(298, sea * 6, Cape(2, 4, mtain), mtain, hillyTaiga * 2),
      TRow(296, sea * 6, hillyTaiga * 2, taiga * 2),
      VRow(295, Mouth(528, HVUp)),
      TRow(294, sea * 2, Isle(hilly), Cape(3, 5, hilly), sea * 3, hilly, Cape(2, 2, hillyTaiga), taiga),
      TRow(292, sea * 3, hilly, Cape(2, 1, hilly), sea * 4, Cape(4, 5), land),
