...
{ override implicit val grid: EGrid160LongFull = EGrid160.e0(262)
  ...
  { override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(276, sea * 5, level * 4, hilly * 2, mtain * 3),
      TRow(274, sea * 6, level * 3, hilly, mtain * 4),
      VRow(273, MouthOld(538, HVUp)),
      TRow(272, sea * 6, level, hilly * 2, mtain, hilly, mtain, level, hilly),
      VRow(271, BendAllOld(538, HVUR), MouthOld(540, HVDR)),
      TRow(270, sea * 2, Cape(4, 3), Cape(0, 1, hilly) * 3, level * 2, hilly * 2, mtain, sea, hilly * 2, sea),
      TRow(268, sea * 3, hilly, level, hillyDesert * 2, mtain * 2, sea * 3, Isle10(hilly), hilly * 2),
