...
{ override implicit val grid: EGrid160LongFull = EGrid160.e0(262)
  ...
  { override val rows: RArr[RowBase] = RArr(
    ...
    TRow(300, sea * 6, mtainOld, hillyTaiga * 2),
    TRow(298, sea * 6, mtainOld, mtainOld, hillyTaiga * 2),
    ...
    VRow(287, BendIn(502, HVUR, 13), ThreeDown(504, 10, 13, 12), Source(506, HVDL, 1, 6), BendIn(520, HVDR, 13),  BendIn(522, HVDn, 13), MouthLt(524, HVDR, 7)),
    TRow(286, sea * 2, oceanic, oceanic, oceanic * 2, sea * 2, oceanic * 4),
    VRow(285, BendIn(504, HVUL, 13), SourceRt(516, HVDR, 7), ThreeDown(518, 0, 10, 13)),
    ...
    TRow(270, sea * 2, CapeOld(4, 3), CapeOld(0, 1, hillyOce) * 3, oceanic * 2, hillyOce * 2, mtainOld, sea, hillyOce * 2, hillySavannah),
