...
{ override implicit val grid: EGrid160LongFull = EGrid160.e0(262)
  ...
  { override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(294, sea * 2, Isle10(hillyOce), CapeOld(5, 3, hillyOce), sea * 3, hillyOce, CapeOld(2, 2, hillyTaiga), taiga),
      ...
      TRow(284, sea, oceanic * 2, CapeOld(4, 2, hillyOce), oceanic * 2, sea, oceanic * 5),
      TRow(282, sea * 4, hillyOce, oceanic, CapeOld(1, 3), oceanic * 2, hillyOce * 2, oceanic * 2),
      TRow(280, sea * 4, CapeOld(2, 4, hillyOce), sea * 2, oceanic, hillyOce * 5),
      ...
      TRow(268, sea * 3, hillyOce, oceanic, hillyDesert * 2, mtainOld * 2, sea * 3, Isle10(hillyOce), hillyOce * 2),
      TRow(266, sea * 2, hillyOce * 2, deshot, hillyDesert * 2, hillyOce, sea * 3, hillyOce, sea * 2, hillyOce),
      VRow(265, MouthOld(514, HVUp)),
      TRow(264, sea * 3, hillyOce * 2, hillyDesert, hillyOce, CapeOld(2, 1, hillyOce), sea, Isle10(hillyOce), sea * 2, hillyOce, sea * 2),
