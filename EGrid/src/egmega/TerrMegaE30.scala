...
object TerrMegaE30 extends LongMegaTerrs
{
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      VRow(119, BendOut(1536, HVUp), Mouth(1538, HVUR)),
      TRow(118, tundra),
      TRow(116, taiga),
      VRow(115, Mouth(1534, HVUR)),
      TRow(114, land),
      TRow(112, hilly, land),
      TRow(110, Cape.a(3, 1, hilly), hilly),
      VRow(109, BendOut(1532, HVUR), Mouth(1538, HVDR)),
      TRow(108, Cape.a(0, 0), desert),
      VRow(107, Mouth(1538, HVUL), BendAll(1540, HVDL)),
      TRow(106, desert * 3),
      VRow(105, BendAll(1540, HVUR), BendAll(1542, HVDL)),
      TRow(104, desert * 3),
      VRow(103, BendAll(1542, HVUR)),
      TRow(102, jungle * 2, hilly),
      TRow(100, jungle * 2, land),
      TRow(98, jungle * 2, sea),
      TRow(96, land * 2, Cape.a(1, 3)),
      VRow(95, Mouth(1538, HVUL)),
      TRow(94, desert, Cape.a(1, 2), Cape.a(4, 2)),
      TRow(92, Cape.a(2, 2, hilly), sea),
      TRow(90, sea * 2),
      TRow(88, sea * 2),
      TRow(86, sea),
      TRow(84, sea),
