...
{ override implicit val grid: EGridMegaLongFull = EGridMega.e150(82)
  ...
  { override val rowDatas: RArr[RowBase] = RArr(
    VRow(119, BendIn(5634, HVDn, 13, siceWin), BendIn(5636, HVDL, 13, siceWin)),
    TRow(118, hillyTundra),
    TRow(116, hillyTundra),
    VRow(115, MouthOld(5632, HVUp), BendOut(5636, HVDR, 7, siceWin)),
    TRow(114, hillyTaiga),
    ...
    TRow(92, oceForest),
    VRow(91, BendOut(5628, HVDL, 7), MouthLt(5634, HVDn, 7)),
