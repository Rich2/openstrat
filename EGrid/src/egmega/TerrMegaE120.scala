...
{ override implicit val grid: EGridMegaLongFull = EGridMega.e120(82)
  ...
  { override val rows: RArr[RowBase] = RArr(
    VRow(119, SourceRt(4610, HVDR, 7, siceWin), BendMin(4612, HVUp, 3, siceWin)),
    TRow(118, hillyTundra),
    TRow(116, hillyTaiga),
    VRow(115, SourceMax(4612, HVDn)),
    TRow(114, taiga),
    TRow(112, taiga, hillyTaiga),
    VRow(111, SourceLt(4608, HVDn), Bend(4612, HVDR, 7, 5), Bend(4614, HVUL, 4, 7)),
    ...
    VRow(105, SourceRt(4604, HVDR, 7), ThreeDown(4606, 13, 10, 13), ThreeUp(4608, 10, 13, 10), ThreeDown(4610, 13, 0, 10), BendIn(4612, HVUL, 13)),
