...
{ override implicit val grid: EGridMegaLongFull = EGridMega.e60(82)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rows: RArr[RowBase] = RArr(
      ...
      VRow(107, OrigLtRevDepr(2558, HVUL), BendIn(2560, HVDL, 6)),
      TRow(106, deshot, mtainDesert, hillySavannah),
      VRow(105, BendIn(2554, HVDL, 13), BendIn(2560, HVUR, 13), OrigRtRevDepr(2562, HVDR, 7)),
      TRow(104, hillyDeshot, sea * 2),
      VRow(103, BendOut(2554, HVUR), BendIn(2556, HVUp, 13), OrigRtRevDepr(2558, HVUR, 7), BendIn(2564, HVDR, 13), OrigRtRevDepr(2566, HVUR), BendIn(2568, HVDR, 12)),
