...
abstract class EGrid120Long(rBottomCen: Int, cenLongInt: Int, rowArray: Array[Int]) extends
  EGridLong(rBottomCen, cenLongInt, 35.kiloMetre, 200, rowArray) with EGrid120Sys
...
class EGrid120LongFull(rBottomCen: Int, rTopCen: Int, cenLongInt: Int) extends EGridLongFull(rBottomCen, rTopCen, cenLongInt, 30.kiloMetre, 200)
