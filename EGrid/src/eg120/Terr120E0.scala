...
object Terr120E0 extends Long120Terrs
{
  ...
  { val res: HCenLayer[WTile] = grid.newHCenLayer[WTile](sea)
    ...
    gs(342, 534, mtain)
    gs(340, 532, mtain)
    gs(338, 530, tunHill * 2)
    gs(336, 528, taigaHill * 2, taiga)
    gs(334, 522, mtain, taigaHill * 3)
    wr(332, sea * 3, hills, sea * 4, mtain * 2, taigaHill, taiga * 2)
    wr(330, sea * 5, hills, sea * 2, mtain * 4, taigaHill)
    wr(328, sea * 6, sea * 3, mtain, taigaHill * 3)
    wr(326, sea * 5, hills, sea * 3, taigaHill * 2, taiga * 3)
    wr(324, sea * 3, plain, hills, sea * 4, taigaHill * 2, sea, plain * 2)
