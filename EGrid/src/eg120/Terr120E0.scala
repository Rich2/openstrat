...
{ override implicit val grid: EGrid120LongFull = EGrid120.e0(300)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(318, sea * 3, CapeOld(5, 3), CapeOld(4, 1, hillyOce), hillyOce, sea * 5, oceanic, oceanic, oceanic, sea),
      VRow(317, MouthOld(536, HVDn)),
      TRow(316, sea * 2, CapeOld(5, 2), oceanic, CapeOld(1, 3), CapeOld(3, 2, hillyOce), oceanic, sea * 5, oceanic, sea * 3),
