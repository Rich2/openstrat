...
{ override implicit val grid: EGrid120LongFull = EGrid120.e0(300)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(318, sea * 3, CapeOld(5, 3), CapeOld(4, 1, hilly), hilly, sea * 5, level, level, level, sea),
      VRow(317, MouthOld(536, HVDn)),
      TRow(316, sea * 2, CapeOld(5, 2), level, CapeOld(1, 3), CapeOld(3, 2, hilly), level, sea * 5, level, sea * 3),
      VRow(315, MouthOld(498, HVUL), MouthOld(506, HVUR)),
      TRow(314, sea * 2, CapeOld(4, 2), level, CapeOld(1, 2), CapeOld(4, 3, hilly), level * 2, sea * 3, CapeOld(5, 2), level * 4),
      TRow(312, sea * 2, level * 2, sea, hilly, level * 2, CapeOld(0, 3), sea, level * 6),
      TRow(310, sea * 2, CapeOld(2, 4), sea * 2, CapeOld(3, 2, hilly), level * 2, CapeOld(2, 1), sea, level * 3, hilly * 2, level * 2),
      VRow(309, MouthOld(504, HVUR)),
      TRow(308, sea * 5, CapeOld(4, 3, hilly), CapeOld(3, 1, hilly), CapeOld(3, 1), CapeOld(2, 2), CapeOld(5, 2), level * 2, hilly * 5),
      TRow(306, sea * 8, CapeOld(5, 3), CapeOld(5, 1), level * 2, hilly * 6),
      VRow(305, MouthOld(512, HVDn)),
      TRow(304, sea * 6, level * 5, hilly * 4, level, hilly * 2),
      TRow(302, sea * 6, CapeOld(3, 3), level * 4, hilly * 2, hillyForest, hilly * 2, mtainOld * 2),
