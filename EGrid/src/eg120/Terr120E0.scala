...
{ override implicit val grid: EGrid120LongFull = EGrid120.e0(300)
  ...
  { override val rows: RArr[RowBase] = RArr(
    ...
    VRow(319, BendIn(492, HVDR, 13), BendIn(494, HVDn, 13)),
    TRow(318, sea * 2, Land(MountLakes, Oceanic), oceanic, hillyOce, hillyOce, sea * 5, oceanic, oceanic, oceanic, sea),
    VRow(317, SourceRt(490, HVUR, 7), BendOut(492, HVUL, 7), MouthOld(536, HVDn)),
    TRow(316, sea * 2, oceanic, oceanic, CapeOld(1, 3), CapeOld(3, 2, hillyOce), oceanic, sea * 5, oceanic, sea * 3),
    VRow(315, MouthOld(498, HVUL), MouthOld(506, HVUR)),
    TRow(314, sea * 2, CapeOld(4, 2), oceanic, CapeOld(1, 2), CapeOld(4, 3, hillyOce), oceanic * 2, sea * 3, CapeOld(5, 2), oceanic * 4),
    TRow(312, sea * 2, oceanic * 2, sea, hillyOce, oceanic * 2, CapeOld(0, 3), sea, oceanic * 6),
    TRow(310, sea * 2, CapeOld(2, 4), sea * 2, CapeOld(3, 2, hillyOce), oceanic * 2, CapeOld(2, 1), sea, oceanic * 3, hillyOce * 2, oceanic * 2),
    VRow(309, MouthOld(504, HVUR)),
    TRow(308, sea * 5, CapeOld(4, 3, hillyOce), CapeOld(3, 1, hillyOce), CapeOld(3, 1), CapeOld(2, 2), CapeOld(5, 2), oceanic * 2, hillyOce * 5),
