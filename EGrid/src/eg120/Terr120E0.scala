...
{ override implicit val grid: EGrid120LongFull = EGrid120.e0(300)
  ...
  { override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(318, sea * 3, Cape(3, 5), Cape(1, 4, hilly), hilly, sea * 5, land, land, land, sea),
      VRow(317, Mouth(536, HVDn)),
      TRow(316, sea * 2, Cape(2, 5), land, Cape(3, 1), Cape(2, 3, hilly), land, sea * 5, land, sea * 3),
      VRow(315, Mouth(498, HVUL), Mouth(506, HVUR)),
      TRow(314, sea * 2, Cape(2, 4), land, Cape(2, 1), Cape(3, 4, hilly), land * 2, sea * 3, Cape(2, 5), land * 4),
      TRow(312, sea * 2, land * 2, sea, hilly, land * 2, Cape(3, 0), sea, land * 6),
      TRow(310, sea * 2, Cape(4, 2), sea * 2, Cape(2, 3, hilly), land * 2, Cape(1, 2), sea, land * 3, hilly * 2, land * 2),
      VRow(309, Mouth(504, HVUR)),
      TRow(308, sea * 5, Cape(3, 4, hilly), Cape(1, 3, hilly), Cape(1, 3), Cape(2, 2), Cape(2, 5), land * 2, hilly * 5),
      TRow(306, sea * 8, Cape(3, 5), Cape(1, 5), land * 2, hilly * 6),
