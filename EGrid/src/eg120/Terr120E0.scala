...
{ override implicit val grid: EGrid120LongFull = EGrid120.e0(300)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(332, sea * 3, Isle10(hillyTemp), sea * 4, mtainOld, mtainOld, hillyTaiga, taiga * 2),
      TRow(330, sea * 5, Isle10(hillyTemp), sea * 2, mtainOld * 4, hillyTaiga),
      TRow(328, sea * 6, sea * 3, mtainOld, hillyTaiga * 3),
      TRow(326, sea * 5, Isle10(hillyTemp), sea * 3, hillyTaiga, hillyTaiga, taiga * 3),
      VRow(325, BendOut(530, HVDR)),
      TRow(324, sea * 3, temperate, hillyTemp, sea * 4, hillyTaiga, hillyTaiga, sea, temperate * 2),
      VRow(323, ThreeDown(528, 13, 10, 0), Bend(530, HVUL, 13, 7), MouthRt(534, HVUL), BendIn(536, HVDL, 13)),
      TRow(322, sea * 3, hillyTemp, hillyTemp * 2, sea * 5, temperate * 2, temperate * 2),
      TRow(320, sea * 4, temperate * 2, sea * 5, temperate, temperate, sea, temperate),
      VRow(319, MouthOld(536, HVUp), MouthOld(538, HVUL), MouthOld(540, HVDR)),
      TRow(318, sea * 3, CapeOld(5, 3), CapeOld(4, 1, hillyTemp), hillyTemp, sea * 5, temperate, temperate, temperate, sea),
      VRow(317, MouthOld(536, HVDn)),
      TRow(316, sea * 2, CapeOld(5, 2), temperate, CapeOld(1, 3), CapeOld(3, 2, hillyTemp), temperate, sea * 5, temperate, sea * 3),
      VRow(315, MouthOld(498, HVUL), MouthOld(506, HVUR)),
      TRow(314, sea * 2, CapeOld(4, 2), temperate, CapeOld(1, 2), CapeOld(4, 3, hillyTemp), temperate * 2, sea * 3, CapeOld(5, 2), temperate * 4),
      TRow(312, sea * 2, temperate * 2, sea, hillyTemp, temperate * 2, CapeOld(0, 3), sea, temperate * 6),
      TRow(310, sea * 2, CapeOld(2, 4), sea * 2, CapeOld(3, 2, hillyTemp), temperate * 2, CapeOld(2, 1), sea, temperate * 3, hillyTemp * 2, temperate * 2),
      VRow(309, MouthOld(504, HVUR)),
      TRow(308, sea * 5, CapeOld(4, 3, hillyTemp), CapeOld(3, 1, hillyTemp), CapeOld(3, 1), CapeOld(2, 2), CapeOld(5, 2), temperate * 2, hillyTemp * 5),
      TRow(306, sea * 8, CapeOld(5, 3), CapeOld(5, 1), temperate * 2, hillyTemp * 6),
      VRow(305, MouthOld(512, HVDn)),
      TRow(304, sea * 6, temperate * 5, hillyTemp * 4, temperate, hillyTemp * 2),
      TRow(302, sea * 6, CapeOld(3, 3), temperate * 4, hillyTemp * 2, hillyTempForest, hillyTemp * 2, mtainOld * 2),
      TRow(300, sea * 8, temperate * 4, hillyTemp * 2, mtainOld * 4, hillyTemp),
    )
  }
  help.run
}
