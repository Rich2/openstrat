...
{ override implicit val grid: EGrid120LongFull = EGrid120.e0(300)
  ...
  { override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(332, sea * 3, Isle(hilly), sea * 4, Hland(2, 4, mtain), mtain, hillyTaiga, taiga * 2),
      TRow(330, sea * 5, Isle(hilly), sea * 2, mtain * 4, hillyTaiga),
      TRow(328, sea * 6, sea * 3, mtain, hillyTaiga * 3),
      TRow(326, sea * 5, Isle(hilly), sea * 3, Hland(2, 4, hillyTaiga), hillyTaiga, taiga * 3),
      TRow(324, sea * 3, land, hilly, sea * 4, Hland(2, 3, hillyTaiga), Hland(2, 2, hillyTaiga), sea, land * 2),
      TRow(322, sea * 3, hilly, hilly * 2, sea * 5, Hland(2, 5), sea, land * 2),
      TRow(320, sea * 4, land * 2, sea * 5, Hland(2, 4), land, sea, land),
      VRow(319, Mouth(536, HVUp), Mouth(538, HVUL), Mouth(540, HVDR)),
      TRow(318, sea * 3, Hland(3, 5), Hland(1, 4, hilly), hilly, sea * 5, land, land, land, sea),
      VRow(317, Mouth(536, HVDn)),
      TRow(316, sea * 2, Hland(2, 5), land, Hland(3, 1), Hland(2, 3, hilly), land, sea * 5, land, sea * 3),
      VRow(315, Mouth(498, HVUL), Mouth(506, HVUR)),
      TRow(314, sea * 2, Hland(2, 4), land, Hland(2, 1), Hland(3, 4, hilly), land * 2, sea * 3, Hland(2, 5), land * 4),
      TRow(312, sea * 2, land * 2, sea, hilly, land * 2, Hland(3, 0), sea, land * 6),
      TRow(310, sea * 2, Hland(4, 2), sea * 2, Hland(2, 3, hilly), land * 2, Hland(1, 2), sea, land * 3, hilly * 2, land * 2),
      VRow(309, Mouth(504, HVUR)),
      TRow(308, sea * 5, Hland(3, 4, hilly), Hland(1, 3, hilly), Hland(1, 3), Hland(2, 2), Hland(2, 5), land * 2, hilly * 5),
      TRow(306, sea * 8, Hland(3, 5), Hland(1, 5), land * 2, hilly * 6),
      VRow(305, Mouth(512, HVDn)),
      TRow(304, sea * 6, land * 5, hilly * 4, land, hilly * 2),
      TRow(302, sea * 6, Hland(3, 3), land * 4, hilly * 2, hillyForest, hilly * 2, mtain * 2),
