...
{ override implicit val grid: EGrid120LongFull = EGrid120.e0(274)
  ...
  { import TileRow as TRow, VertRow as VRow
    ...
    VRow(301, BendIn(500, HVUR, 13), BendIn(502, HVUp, 13), OrigMin(504, HVDL, 2), OrigLt(506, HVDn)),
    TRow(300, sea * 8, oceanic * 4, hillyOce * 2, mtainDepr * 4, hillyOce),
    VRow(299, BendIn(506, HVUR, 8), BendOut(508, HVDL)),
    ...
    VRow(295, BendIn(506, HVUR, 13), OrigMin(508, HVUL), OrigMin(536, HVDn, 1)),
    TRow(294, sea * 9, oceanic, hillySavannah, mtainOce * 2, hillyOce, mtainOceForest * 3, mtainOce, hillyOce),
    VRow(293, BendIn(486, HVDR, 13), OrigLt(488, HVDL, 7), OrigLt(534, HVUR, 7), ThreeUp(536, 13, 0, 13), BendOut(538, HVDL, 7)),
