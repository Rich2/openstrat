...
{ override implicit val grid: EGrid120LongFull = EGrid120.e0(300)
  ...
  { override val rows: RArr[RowBase] = RArr(
    ...
    VRow(317, SourceRt(490, HVUR, 7), BendOut(492, HVUL, 7)),
    ...
    TRow(314, sea * 2, oceanic, oceanic, CapeOld(1, 2), CapeOld(4, 3, hillyOce), oceanic * 2, sea * 3, CapeOld(5, 2), oceanic * 4),
    TRow(312, sea * 2, oceanic * 2, sea, hillyOce, oceanic * 2, CapeOld(0, 3), sea, oceanic * 6),
    TRow(310, sea * 2, oceanic, sea * 2, hillyOce, oceanic * 2, CapeOld(2, 1), sea, oceanic * 3, hillyOce * 2, oceanic * 2),
