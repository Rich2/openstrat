...
{ override implicit val grid: EGrid120LongFull = EGrid120.e0(300)
  ...
  { override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(324, sea * 3, plain, hills, sea * 4, Hland(2, 3, hillyTaiga), Hland(2, 2, hillyTaiga), sea, plain * 2),
      TRow(322, sea * 3, hills, hills * 2, sea * 5, Hland(2, 5), sea, plain * 2),
      TRow(320, sea * 4, plain * 2, sea * 5, Hland(2, 4), plain, sea, plain),
      VRow(319, Mouth(536, HVUp), Mouth(538, HVUL), Mouth(540, HVDR)),
      TRow(318, sea * 3, Hland(3, 5), Hland(1, 4, hills), hills, sea * 5, plain, plain, plain, sea),
      VRow(317, Mouth(536, HVDn)),
      TRow(316, sea * 2, Hland(2, 5), plain, Hland(3, 1), Hland(2, 3, hills), plain, sea * 5, plain, sea * 3),
      VRow(315, Mouth(498, HVUL), Mouth(506, HVUR)),
      TRow(314, sea * 2, Hland(2, 4), plain, Hland(2, 1), Hland(3, 4, hills), plain * 2, sea * 3, Hland(2, 5), plain * 4),
      TRow(312, sea * 2, plain * 2, sea, hills, plain * 2, Hland(3, 0), sea, plain * 6),
      TRow(310, sea * 2, Hland(4, 2), sea * 2, Hland(2, 3, hills), plain * 2, Hland(1, 2), sea, plain * 3, hills * 2, plain * 2),
      VRow(309, Mouth(504, HVUR)),
      TRow(308, sea * 5, Hland(3, 4, hills), Hland(1, 3, hills), Hland(1, 3), Hland(2, 2), Hland(2, 5), plain * 2, hills * 5),
