...
{ override implicit val grid: EGrid120LongFull = EGrid120.e0(274)
  ...
  { import TileRow as TRow, VertRow as VRow
    ...
    VRow(279, BendIn(512, HVDR, 13), BendIn(514, HVDn, 13), OrigMin(538, HVUp, 2)),
    ...
    //The lake is incorrect but has been set for the time being to aid with debugging of corners.
    TRow(276, sea * 6, mtainSavannah, lake, hillySavannah, mtainSavannah, hillySavannah * 2, sahel, hillySahel * 2, hillySavannah * 2, hillySahel),
