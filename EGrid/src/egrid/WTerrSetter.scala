  ...
  extends HSetter[WTile, WSep, WSepSome]
{
  ...
  case class Isle6(terr: Land, sepTerrs: Water = Sea) extends TRunner with Isle6Base
  ...
  case class Isle5(terr: Land, sepTerrs: Water = Sea) extends TRunner with Isle5Base
