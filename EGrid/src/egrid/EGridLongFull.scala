...
abstract class EGridLongFull(rBottomCen: Int, rTopCen: Int, longGridIndex: Int, cScale: MetricLength, rOffset: Int) extends EGridLong(rBottomCen,
...
object EGridLongFull
{
  ...
  def tileRowMinMaxC(r: Int, rOffset: Int, cOffset: Int, cScale: MetricLength): (Int, Int) =
  {
  ...
  def getBounds(rTileMin: Int, rTileMax: Int, rOffset: Int, c0Offset: Int, cScale: MetricLength): Array[Int] =
