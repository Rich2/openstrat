...
{ override implicit val grid: EGrid640LongFull = EGrid640.e0(86)
  ...
  { override val rows: RArr[RowBase] = RArr(
    ...
    VRow(119, OrigLtRevDepr(508, HVUp, 7)),
    ...
    VRow(101, OrigLtRevDepr(504, HVUL, 7), BendIn(506, HVUp, 11), BendOut(508, HVDn), BendIn(510, HVUp, 13), BendOut(512, HVDn, 7), BendIn(514, HVUp, 13),
