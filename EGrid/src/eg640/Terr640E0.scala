...
{ override implicit val grid: EGrid640LongFull = EGrid640.e0(96)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rows: RArr[RowBase] = RArr(
      ...
      VRow(125, OrigRt(508, HVDL), BendIn(510, HVDR, 13), ThreeUp(512, 13, 13, 0), BendIn(514, HVDL, 13), OrigRtRevDepr(518, HVUp)),
      ...
      TRow(122, oceanic * 2),
      VRow(121, OrigRtRevDepr(508, HVDn), OrigRtRevDepr(510, HVDL, 7), BendOut(512, HVUL, 7)),
      ...
      VRow(115, OrigRtRevDepr(506, HVDn, 7), OrigRtRevDepr(508, HVDL), BendIn(510, HVDn, 10), BendMin(512, HVUp), ThreeUp(514, 11, 3, 10), BendIn(516, HVUp, 11),
      ...
      VRow(101, MouthLt(504, HVUL, 7), BendIn(506, HVUp, 11), BendOut(508, HVDn), BendIn(510, HVUp, 13), BendOut(512, HVDn, 7), BendIn(514, HVUp, 13),
        BendOut(516, HVDn), OrigRtRevDepr(518, HVDR)),
