...
{ override implicit val grid: EGrid640LongFull = EGrid640.w90(96)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(114, sahel, savannah, level, level),
      TRow(112, savannah, level, jungle, sea),
      ...
      TRow(100, sea * 4, Cape(5, 1, mtainOld)),
      TRow(98, sea * 3, Cape(4, 2, mtainOld), jungle),
      TRow(96, sea * 4, Cape(4, 1, mtainOld)),
    )
  }
  help.run
}