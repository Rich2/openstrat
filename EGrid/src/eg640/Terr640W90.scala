...
{ override implicit val grid: EGrid640LongFull = EGrid640.w90(70)
  ...
  { override val rows: RArr[RowBase] = RArr(
    ...
    VRow(109, Bend(9724, HVUR, 2, 4), BendOut(9726, HVUp, 7), OrigLt(9728, HVDL, 7), BendIn(9730, HVDR, 13), ThreeUp(9732, 13, 13, 0), Bend(9734, HVUp, 13, 3),
      ThreeUp(9736, 0, 13, 13), BendIn(9738, HVDL, 6)),

    TRow(108, hillySavannah, jungle, hillyJungle * 2),
    VRow(107, Bend(9730, HVUR, 13, 5), BendInRt(9732, HVUp, 13, 4), BendOut(9734, HVDn), BendIn(9736, HVUp, 13), BendIn(9738, HVUL, 7)),
    TRow(106, sea, hillyJungle * 2),
    VRow(105, OrigLt(9724, HVDR, 7), BendIn(9726, HVUp, 13), Orig(9728, HVDL, 4, 2), OrigRt(9734, HVUR, 7), BendIn(9736, HVDn, 13), OrigMin(9738, HVUL)),
    ...
    VRow(87, BendIn(9736, HVDR, 10), OrigRt(9738, HVDL)),
    VRow(83, BendIn(9732, HVDR, 13), OrigMin(9734, HVDL, 4)),
    TRow(82, sea * 2, mtainOceForest),
    VRow(81, OrigRt(9732, HVUp, 7)),
    VRow(77, OrigLt(9732, HVDR, 7), BendIn(9734, HVUp, 11), BendIn(9736, HVUL, 13)),
    TRow(70, SeaIcePerm)
    )
  }
  help.run
