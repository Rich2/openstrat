...
{ override implicit val grid: EGrid640LongFull = EGrid640.w90(96)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(116, savannah, savannah, hillyTemp),
      TRow(114, sahel, savannah, temperate, temperate),
      TRow(112, savannah, temperate, jungle, sea),
      ...
      TRow(104, sea * 3, CapeOld(4, 1, hillyJungle), CapeOld(0, 1, hillyJungle)),
      VRow(103, MouthRt(9732, HVDR, 7)),
      TRow(102, sea * 4, mtainOld),
      TRow(100, sea * 4, CapeOld(5, 1, mtainOld)),
