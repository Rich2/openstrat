...
{ override implicit val grid: EGrid640LongFull = EGrid640.w90(96)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      VRow(111, BendAll(9724, HVDR), BendOut(9726, HVDn), BendIn(9728, HVUp, 13), BendOut(9730, HVDn, 7), BendOut(9732, HVDL, 7)),
      TRow(110, sahel, sea * 2, jungle),
      VRow(109, BendOut(9724, HVUR), BendOut(9726, HVUp), Mouth(9720, HVUR), BendIn(9730, HVDR, 13), ThreeUp(9732, 13, 13, 0), BendInOut(9734, HVUp, 13, 3)),
      TRow(108, jungle, Cape(0, 1, jungle), hillyJungle * 2),
      VRow(107, BendInOut(9730, HVUR, 13, 3), BendIn(9732, HVUp, 13), BendOut(9734, HVDn)),
