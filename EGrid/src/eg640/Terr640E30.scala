...
{ override implicit val grid: EGrid640LongFull = EGrid640.e30(96)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(124, temperate, taiga),
      VRow(123, MouthOld(1532, HVDR), BendOut(1532, HVUp), BendAllOld(1534, HVUL)),
      TRow(122, temperate, temperate),
      TRow(120, temperate * 3),
      TRow(118, temperate, temperate, temperate),
      VRow(119, MouthMin(1536, HVUp), MouthLt(1544, HVUp, 7, Lake)),
      VRow(117, BendIn(1530, HVDL, 11), MouthRt(1534, HVUp), Bend(1536, HVUR, 12, 7), BendIn(1538, HVUp, 13), Mouth(1540, HVUR, 7, 6), BendAllOld(1544, HVUR, Lake)),
      TRow(116, hillyTemp, hillyTemp, hillyTemp),
