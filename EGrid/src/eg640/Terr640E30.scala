...
{ override implicit val grid: EGrid640LongFull = EGrid640.e30(70)
  ...
  { override val rows: RArr[RowBase] = RArr(
    VRow(129, OrigRt(1534, HVUR, 7), BendIn(1536, HVDn, 9, sea, SeaIceWinter), BendOut(1538, HVUp, 7, SeaIceWinter)),
    TRow(128, tundra),
    TRow(126, taiga * 2),
    ...
    VRow(89, BendOut(1538, HVDR), BendIn(1540, HVUL, 13), OrigLt(1544, HVDR)),
