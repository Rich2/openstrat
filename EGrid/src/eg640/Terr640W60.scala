...
{ override implicit val grid: EGrid640LongFull = EGrid640.w60(94)
  ...
  { override val rows: RArr[RowBase] = RArr(
    ...
    TRow(116, hillyCont),
    VRow(115, OrigLtRevDepr(10746, HVUL), BendIn(10748, HVUp, 13), BendIn(10750, HVUL, 13)),
