...
{ override implicit val grid: EGrid640LongFull = EGrid640.e180(96)
  ...
  { override val rows: RArr[RowBase] = RArr(
    ...
    VRow(123, BendMin(6652, HVDR, 3, siceWin), SourceRt(6654, HVDL, 7, siceWin), BendIn(6658, HVUR, 13, siceWin), ThreeDown(6660, 13, 13, 0, siceWin),
      Source(6662, HVDL, 4, 2, siceWin)),
    TRow(122, SepB()),
    )
  }
  help.run
