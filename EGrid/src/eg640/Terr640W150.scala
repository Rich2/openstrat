...
{ override implicit val grid: EGrid640LongFull = EGrid640.w150(90)
  ...
  { override val rows: RArr[RowBase] = RArr(
    TRow(130, siceWin),
    VRow(129, ThreeDown(7678, 0, 8, 13, siceWin), BendIn(7680, HVDn, 13, siceWin), BendOut(7682, HVUp, 7, siceWin), BendOut(7684, HVDn, 7, siceWin)),
    TRow(128, tundra),
    VRow(127, SetSep(7677, siceWin)),
    TRow(126, hillyTundra, taiga),
    VRow(125, BendIn(7676, HVUL, 13, SeaIceWinter)),
    TRow(124, hillyTundra, mtainDepr),
    VRow(123, ThreeDown(7676, 13, 13, 0, siceWin), Orig(7678, HVDL, 4, 2, siceWin), Bend(7680, HVDR, 1,  5), BendOut(7682, HVDn, 7), BendIn(7684, HVDL)),
