...
{ override implicit val grid: EGrid640LongFull = EGrid640.e120(96)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(120, mtainOld, hillyTemp, hillyTemp),
      TRow(118, desert, steppe, hillyTemp),
      VRow(117, MouthRt(4610, HVUp), Bend(4614, HVDR, 10, 7)),
      TRow(116, hillySahel, hillySavannah, hillyTemp),
      VRow(115, BendIn(4608, HVDR, 13), BendIn(4610, HVUL, 13), BendIn(4612, HVDR, 13), BendIn(4614, HVUL, 13)),
      TRow(114, hillyTemp, temperate, hillyContForest, hillyTemp),
      VRow(113, BendIn(4608, HVUR, 13), ThreeDown(4610, 13, 0, 6), Bend(4612, HVUL, 3, 5)),
      TRow(112, temperate, hillyTemp, sea * 2),
      VRow(111, BendIn(4608, HVDR, 11), ThreeUp(4610, 2, 11, 4), BendIn(4612, HVDL, 11)),
      TRow(110, hillySavannah * 2, hillySubForest),
      VRow(109, ThreeUp(4608, 11, 0, 9), BendIn(4610, HVUp, 11), BendIn(4612, HVUL, 11)),
