...
{ override implicit val grid: EGrid640LongFull = EGrid640.e120(94)
  ...
  { override val rows: RArr[RowBase] = RArr(
    ...
    VRow(123, OrigRtRevDepr(4612, HVDL, 7, siceWin), BendIn(4614, HVDn, 13, siceWin)),
    TRow(122, mtainDepr, hillyTaiga),
    TRow(120, mtainDepr, hillyOce, hillyOce),
    TRow(118, deshot, steppe, hillyOce),
    VRow(117, Bend(4614, HVDR, 10, 7)),
    TRow(116, hillySahel, hillySavannah, hillyOce),
    VRow(115, BendIn(4608, HVDR, 13), OrigRevDepr(4610, HVUR, 5, 4), BendIn(4612, HVDR, 13), BendIn(4614, HVUL, 13)),
    ...
    VRow(109, BendOut(4606, HVDR, 7), ThreeUp(4608, 11, 0, 9), BendIn(4610, HVUp, 11), BendIn(4612, HVUL, 11)),
    TRow(108, hillyTrop),
    VRow(107, OrigLt(4604, HVUR, 7), BendIn(4606, HVUL, 13)),
