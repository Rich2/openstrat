...
{ override implicit val grid: EGrid640LongFull = EGrid640.e90(96)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      TRow(112, mtainOld, Land(Mountains, Desert, LandFree), mtainOld, hillyTemp),
      ...
      VRow(105, Bend(3574, HVDL, 4, 2), Bend(3578, HVDR, 1, 5), BendIn(3580, HVUL, 13), MouthRt(3592, HVUL), BendIn(3594, HVDL, 13)),
      TRow(104, savannah, sea * 3, hillyJungle),
      VRow(103, BendIn(3574, HVUR), ThreeDown(3576, 6, 11, 0), ThreeUp(3578, 0, 11, 11), BendIn(3580, HVDL, 11), MouthRt(3588, HVDL), BendIn(3590, HVDn, 13),
