...
{ override val title: String = "1000km 0E - 30E"
  override implicit val gridSys: EGrid13LongMulti = EGrid13.multi(3, 0, 82)
...
{ override val title: String = "13km 30W - 60E"
  override implicit val gridSys: EGrid13LongMulti = EGrid13.multi(4, 11, 82)
  override val terrs: HCenLayer[WTile] = fullTerrsHCenLayerSpawn
  override val sTerrs: HSideOptLayer[WSide, WSideSome] = fullTerrsSideLayerSpawn
  override val corners: HCornerLayer = fullTerrsCornerLayerSpawn
}
...
{ override val title: String = "13km 60W - 150E"
  override implicit val gridSys: EGrid13LongMulti = EGrid13.multi(8, 10, 124)
  override val terrs: HCenLayer[WTile] = fullTerrsHCenLayerSpawn
  override val sTerrs: HSideOptLayer[WSide, WSideSome] = fullTerrsSideLayerSpawn
  override val corners: HCornerLayer = fullTerrsCornerLayerSpawn
}
...
{ override val title: String = "All longitude terrain only scenario."
  override implicit val gridSys: EGrid13LongMulti = EGrid13.multi(12, 0, 124)
  override val terrs: HCenLayer[WTile] = fullTerrsHCenLayerSpawn
  override val sTerrs: HSideOptLayer[WSide, WSideSome] = fullTerrsSideLayerSpawn
  override val corners: HCornerLayer = fullTerrsCornerLayerSpawn
}
...
{ override val title: String = "13km 150W - 60W"
  override implicit val gridSys: EGrid13LongMulti = EGrid13.multi(4, 7, 124)
  override val terrs: HCenLayer[WTile] = fullTerrsHCenLayerSpawn
  override val sTerrs: HSideOptLayer[WSide, WSideSome] = fullTerrsSideLayerSpawn
  override val corners: HCornerLayer = fullTerrsCornerLayerSpawn
}
...
{ override val grids: RArr[EGridLongFull] = EGrid13.grids(2, 8, 154, 158)
