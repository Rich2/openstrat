...
{ override implicit val grid: EGrid13LongFull = EGrid13.w60(86)
  ...
  val help = new WTerrSetter(grid, terrs, sTerrs, corners)
  {
    override val rows: RArr[RowBase] = RArr(
      ...
      VRow(109, SourceLt(10752, HVDR), ThreeDown(10754, 13, 0, 13), ThreeUp(10756, 12, 0, 13)),
      TRow(108, hillyCont),
      VRow(107, SourceLt(10750, HVDR), BendIn(10752, HVUp, 13), BendIn(10754, HVUL, 13)),
      VRow(105, BendIn(10748, HVDn, 10), BendIn(10750, HVDL, 10)),
      VRow(103, Bend(10748, HVUp, 13, 4), ThreeUp(10750, 0, 13, 8), SourceLt(10752, HVUL, 7)),
      TRow(102, hillyOce, sea),
      VRow(101, SourceRt(10756, HVDR), BendIn(10758, HVDL, 13)),
      ...
      TRow(92, savannah),
      VRow(91, SourceRt(10750, HVDL), SourceRt(10752, HVUR), BendIn(10754, HVUL, 13)),
      VRow(89, SourceRt(10750, HVUL, 7)),
