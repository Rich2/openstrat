...
/** [[PolygonLL]] graphic for south east China depends on [[IndoChina]]. */
object China extends EArea2("China", 30.0 ll 105.5, hillyOce)
{ val qinhuangdao: LatLong = 39.92 ll 119.61
  ...
  override val polygonLL: PolygonLL = PolygonLL(Manchuria.jinzhou, qinhuangdao, luanheMouth, huituo, duliujianMouth, p5, jiolaiMouth, p10, rongcheng, p12,
    haitzhou, p15, p18, putuo, p25, suanyu, longhai, dashwei, hongKong, wuchuan, p40, xuwen, yingzaiMouth, IndoChina.beilunMouth, IndoChina.chittagong,
    India.magdhara, India.indiaNE, Mongolia.southWest, Mongolia.p50, Mongolia.southEast)
}
