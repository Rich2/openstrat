...
object Shetland extends EArea2("Shetland", 60.34 ll -1.23, level)
...
object Orkneys extends EArea2("Orkneys", 59.06 ll -3.15, level)
...
object Uist extends EArea2("Uist", 57.384 ll -7.32, level)
{
...
object IslayJura extends EArea2("Islay Jura", 55.879 ll -6.006, level)
