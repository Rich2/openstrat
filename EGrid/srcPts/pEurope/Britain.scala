...
object Wales extends EarthPoly("Wales", 52.40 ll -3.50, hillyOce)
...
object EnglandMiddle extends EarthPoly("England middle",  53.632 ll -1.581, deshot)
...
object EnglandSouth extends EarthPoly("England south", 51.632 ll -0.679, oceanic)
