...
object Jutland extends EArea2("Jutland", 56.29 ll 9.33, oceanic)
...
object Funen extends EArea2("Funen", 55.27 ll 10.39, oceanic)
...
object Zealand extends EArea2("Zealand", 55.58 ll 11.90, oceanic)
...
object SwedenSouth extends EArea2("SwedenSouth", 58.25 ll 15.14, oceanic)
{ //South Baltic Coast
...
object Oland extends EArea2("Oland", 56.77 ll 16.67, oceanic)
...
object Faroe extends EArea2("Faroe", 62.14 ll -6.91, hillyOce)
