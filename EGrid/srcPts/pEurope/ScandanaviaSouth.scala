...
object Jutland extends EarthArea("Jutland", 56.29 ll 9.33, oceanic)
...
object Funen extends EarthArea("Funen", 55.27 ll 10.39, oceanic)
...
object Zealand extends EarthArea("Zealand", 55.58 ll 11.90, oceanic)
...
object SwedenSouth extends EarthArea("SwedenSouth", 58.25 ll 15.14, oceanic)
{ //South Baltic Coast
...
object Oland extends EarthArea("Oland", 56.77 ll 16.67, oceanic)
...
object Faroe extends EarthArea("Faroe", 62.14 ll -6.91, hillyOce)
