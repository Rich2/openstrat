...
{ val nColumbia: LatLong = 12.19 ll -71.27
  ...
  val puntaTortuga = 0.775 ll -80.089
  val p95 = 4.258 ll -77.524
  ...
  override val polygonLL: PolygonLL = PolygonLL(nColumbia, caracas, caicara, margaritaE, trinidadNE, nwSAmericaEN, SouthAmericaMiddle.nwSAmericaES,
    SouthAmericaMiddle.northWest, nChile, p60, nPeru, west, sanLorenzo, p90, puntaTortuga, p95, bahiaSolano10,AmericasCentral.sePanama,
    AmericasCentral.nePanama)
}
...
{ val nAmapa: LatLong = 4.39 ll -51.51
  ...
  override val polygonLL: PolygonLL = PolygonLL(SouthAmericaWest.nwSAmericaEN, nAmapa, amazonMouthS, marajoMouth, p10, pedraFurada, paraiba, p70, jequitinhonhaMouth,
