...
{ import pMalay.*
  override val ePolys: RArr[EarthPoly] = RArr(Sumatra, BorneoNorth, BorneoSouth, Sulawesi, Halmahera, javaIsland, BaliIsland, Sumbawa, Lambok, Sumba, Flores,
    AlorIsland,  Wetar, Timor, GuineaWest, PapuaNewGuinea, NewBritain, NewIreland, Luzon, Palawan, VisayasWest, SamarLeyte, Mindano)
}
