...
{ import pEurope._
  override val a2Arr: RArr[EarthArea] = RArr(RussiaSouth, VolgaRegion, Caspian, AzovSea, Greece, BalkansWest, BalkansEast, FinlandNorth, FinlandSouth,
...
{ import pMed._
  override val a2Arr: RArr[EarthArea] = RArr(SaharaEast, Sinai, Naxos, Andros, Kythira, Crete, Corfu, Thasos, Samos, Cyprus, Rhodes, Cephalonia, Lesbos, Chios)
}
...
{ import pAfrica. _
  override val a2Arr: RArr[EarthArea] = RArr(LakeVictoria, LakeTanganyika, LakeMalawi, LakeMweru, SouthAfrica, Congo, AngloaZambia, FernandoPo,
...
{ import pAmericas._
  ...
  override val a2Arr: RArr[EarthArea] = greatLakes ++ RArr(Yukon, BearSlaveLand, BearSlaveLand, GreatBearLake, GreatSlaveLake, LakeWinnipeg, NunavutNorth,
    NunavutSouth, CanadaRockies, AlbertaSask, Manitoba, ReindeerLake, CanadaCentral, CanadaSouthEast, NewBrunswick, NovaScotia,  Quebecia,NewFoundland, Ungava)
}
...
{ import pAmericas._
  override val a2Arr: RArr[EarthArea] = RArr(AndesFarNorth, ColomVenez, Guyana, AndesNearNorth, AmazonWest, AmazonEast, SouthAmericaCentral, SouthAmericaEast,
