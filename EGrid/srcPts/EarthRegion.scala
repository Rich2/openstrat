...
{ import pAmericas._
  override val a2Arr: RArr[EarthArea] = RArr(AndesFarNorth, ColomVenez, Guyana, AndesNearNorth, AmazonWest, AmazonEast, SouthAmericaEast, AndesMiddle,
    SouthAmericaMiddle, SouthAmericaNS, SouthAmericaFS, DelFuego, Falklands)
}
