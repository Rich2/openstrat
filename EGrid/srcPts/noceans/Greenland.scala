...
object Greenland extends EarthPoly("Greenland", 75 ll -42, ice)
{ val neGreenland: LatLong = 81.44 ll -11.77
  ...
  val p94: LatLong = 82.554 ll -22.248
  val p96: LatLong = 82.081 ll -21.335
  val p99: LatLong = 81.805 ll -13.865
