...
object Majorca extends EArea2("Majorca", 39.59 ll 3.01, level)
...
object Sicily extends EArea2("Sicily", cen = 37.58 ll 14.27, level)
...
object Canarias extends EArea2("Canarias", 27.96 ll -15.60, level)
