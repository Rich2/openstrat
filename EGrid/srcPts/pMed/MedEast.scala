...
{ override def elements: RArr[IslandPolyLike] = RArr(Corfu, Cephalonia)
  override def area: Kilares = 2306.94.kilares - Kythira.area2
}

/** [[PolygonLL]] graphic for Corfu. Depends on nothing. */
object Corfu extends IslandPoly("Corfu", 39.63 ll 19.82, hillyOce)
...
object Cephalonia extends IslandPoly("Cephalonia", 38.22 ll 20.59, mtainSavannah)
{ override def oGroup: Some[IonianIs.type] = Some(IonianIs)
...
object Crete extends IslandPoly("Crete", 35.23 ll 24.92, mtainSavannah)
...
object Cyprus extends IslandPoly("Cyprus", 34.98 ll 33.15, hillyOce)
