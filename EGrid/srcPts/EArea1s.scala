...
{ import pEurope._
  override val a2Arr: RArr[EArea2] = RArr(IrelandNorth, IrelandSouth, EnglandNorth, EnglandMiddle, EnglandSouth, ScotlandLow, ScotlandHigh, Wales, Orkneys,
...
{ import pAsia._
  override val a2Arr: RArr[EArea2] = RArr(RusNorth, SiberiaWest, SiberiaNorth, SevernyIsland, Pakistan, India, SriLanka, Burma, Himalayas, Kyrgyyzstan,
    SiberiaSouth)
}
...
{ import pAsia._
  override val a2Arr: RArr[EArea2] = RArr(Manchuria, Mongolia, Xinjiang, China, Yunnan, TibetEast, Hainan, IndoChina, Korea, Yakutia, FeAsia, Kamchatka,
    sakhalin, Hokkaido, Honshu, Kyshu, Taiwan, Kazak, MalayPeninsula, LakeBaikal)
}
...
{ import pMalay._
  override val a2Arr: RArr[EArea2] = RArr(Sumatra, Borneo, Sulawesi, javaIsland, Sumbawa, Sumba, Flores, AlorIsland, Wetar, Timor, NewGuinea, Luzon, Palawan,
    Visayas, Samar, Mindano)
}
