...
{ import pAmericas._
  override val a2Arr: RArr[EArea2] = RArr(UsaSouthWest, UsaNorthWest, UsaMidWest, UsaNorthEast, UsaSouth, UsaPrariesSouth, Florida, Baja, Mexico, MexicoEast,
    AmericasCentral, Cuba, Jamaica)
}
