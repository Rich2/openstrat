...
{ import pEurope._
  override val a2Arr: RArr[EArea2] = RArr(Ireland, England, Scotland, Wales, Orkneys, Uist, IsleLewis, Shetland, Faroe, JanMayen, Frankia,
    BelgLux, Alsace, Netherlands, Jutland, Zealand, Funen, Germania, Alpsland, Polandia, Baltland, Ukraine, SwedenSouth, SwedenNorth, Oland)
}
...
{ import pAfrica. _
  override val a2Arr: RArr[EArea2] = RArr(LakeVictoria, LakeTanganyika, SouthAfrica, CentralAfricaWest, centralAfricaEast, Zanzibar, Madagascar)
}
...
{ import pAmericas._
  override val a2Arr: RArr[EArea2] = RArr(UsaWest, UsaMid, UsaEast, Florida, Baja, Mexico, MexicoEast, AmericasCentral, Cuba, Jamaica)
}
