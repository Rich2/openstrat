...
{ import pAsia._
  override val a2Arr: RArr[EArea2] = RArr(Manchuria, Mongolia, Xinjiang, China, Yunnan, Hainan, IndoChina, Korea, Yakutia, FeAsia, Kamchatka, sakhalin,
    Hokkaido, Honshu, Kyshu, Taiwan, Kazak, MalayPeninsula, LakeBaikal)
}
