...
{ import pAsia._
  override val a2Arr: RArr[EArea2] = RArr(Manchuria, Mongolia, Xinjiang, ChinaNorth, China, Yunnan, TibetEast, Hainan, IndoChina, Korea, Yakutia, FeAsia,
...
{ import pMalay._
  override val a2Arr: RArr[EArea2] = RArr(Sumatra, Borneo, Sulawesi, javaIsland, Sumbawa, Sumba, Flores, AlorIsland, Wetar, Timor, NewGuinea, NewBritain, Luzon,
