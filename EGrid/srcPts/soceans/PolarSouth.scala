...
object AntarticaEast extends EarthPoly("Antartica East", -89.91 ll 0, ice)
...
object AntarticaWest extends EarthPoly("Antartica\nWest", -80 ll -100, ice)
...
object WeddelSeaIce extends EarthPoly("Weddel Sea\nIce", -70 ll -40, SeaIcePerm)
...
/** [[polygonLL]] graphical representation of Weddel Sea seasonal ice. Depends on [[AntarticaEast]] and [[AntarticaWest]]. */
object RossSeaIce extends EarthPoly("Ross Sea\nIce", -70 ll -165, siceWin)
