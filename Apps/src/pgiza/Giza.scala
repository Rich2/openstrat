...
{
  override def square: SqlignLen2[PtLen2] = SqlignLen2.br(sideLen, KhafrePyramid.square.rb.slate(offVec))
...
{
  override def square: SqlignLen2[PtLen2] = SqlignLen2(sideLen)
