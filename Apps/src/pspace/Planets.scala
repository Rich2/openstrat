...
{ override val avSunDist: Metres = 36.megaMiles.toMetres
...
{ override val avSunDist: Metres = 67.2.megaMiles.toMetres
  override val name: String = "Venus"
  override def colour: Colour = White
}

object Earth extends Planet
{ override val avSunDist: Metres = 93.01.megaMiles.toMetres
