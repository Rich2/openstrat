...
{ override val avSunDist: Gigametre = 57.909175.gigaMetre
...
{ override val avSunDist: Gigametre = 108.208930.gigaMetre
  override val name: String = "Venus"
  override def colour: Colour = White
}

object Earth extends Planet
{ override val avSunDist: Gigametre = 149.597890.gigaMetre// 93.01.megaMiles.toMetres
