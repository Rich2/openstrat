...
{ override implicit val gridSys: HGrid = HGridRect.minMax(2, 12, 4, 40)
  ...
  val help = new VTerrSetter(gridSys, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      VRow(9, BendAll(26, HVDR, River), Orig(28, HVDL, River)),

      VRow(7, Orig(22, HVDR, River), ThreeDown(24, River), ThreeUp(26, River), BendAll(28, HVUp, River), BendAll(30, HVDn, River),
      ...
      VRow(5, Orig(22, HVUR, River), BendAll(24, HVUL, River)),
...
{ override val title: String = "CivRise Scen 2"
  ...
  val help = new VTerrSetter(gridSys, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      VRow(11, Orig(12, HVUL), BendAll(18, HVDn), BendAll(22, HVDn)),
      TRow(10, Plain, Cape(5, 2), Sea * 4, Isle10() * 2, Sea * 2),
      VRow(9, Orig(8, HVUp), Orig(18, HVUR)),
      TRow(8, Plain * 4, Cape(0, 4), Sea * 3, Plain, Sea),
      VRow(7, Orig(18, HVDR), Orig(28, HVUL), Orig(40, HVDn, River)),
      TRow(6, Plain * 3, Sea * 2, Cape(5, 2, Mountain), Sea, Plain, Plain * 2),
      VRow(5, Orig(24, HVUp), Orig(30, HVDn), BendAll(38, HVDR, River), BendAll(40, HVUL, River)),
      TRow(4, Sea * 5, Mountain * 3, Plain * 2),
      VRow(3, Orig(30, HVUp), Orig(36, HVUR, River), ThreeUp(38, River), Orig(40, HVUL, River)),
      TRow(2, Plain * 10),
    )
  }
  help.run
