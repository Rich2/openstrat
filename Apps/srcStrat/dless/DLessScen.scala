...
{ ThisScen =>
  ...
  val hexNames: LayerHcRefSys[String]
  ...
  { val targets: HCenBuffLayer[HCenPair[Army]] = gridSys.newHCenArrOfBuff
    ...
    { override implicit val gridSys: EGridSys = ThisScen.gridSys
      ...
      override val hexNames: LayerHcRefSys[String] = ThisScen.hexNames
...
object DLessScen1 extends DLessScen
{
  ...
  override val hexNames: LayerHcRefSys[String] = fullNamesHCenLayerSpawn
