...
object Army
{
  ...
  def persistEv(nations: Nation*): PersistShow2[Nation, Int, Army] =
    PersistShow2[Nation, Int, Army]("Army", "nation", "num", Army.apply)(Nation.persistEv(nations.toArr), ShowT.intPersistEv)
