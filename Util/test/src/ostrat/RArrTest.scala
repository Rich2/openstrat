...
object RArrTest extends TestSuite
{
  ...
  val tests = Tests {
    ...
    test("Unshow")
    { ("Seq(5; 6; 7)".findType[IntArr] === Right(intArr1)) ==> true
      ("Seq(5; 6; 7)".asType[IntArr] === Right(intArr1)) ==> true
      ("Seq[Int](5; 6; 7)".asType[IntArr] === Right(intArr1)) ==> true
      ("Seq[Double](5; 6; 7)".asType[IntArr] === Right(intArr1)) ==> true
      ("Seq(5; 6; 7)".findType[DblArr] === Right(DblArr(5, 6, 7))) ==> true
      ("Seq(-5; 6.27; 7.01)".findType[DblArr] === Right(DblArr(-5, 6.27, 7.01))) ==> true
    }
  }
}