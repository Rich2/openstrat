...
{ 
  ...
  { val Sp1 = StrPosn(1, 1)
    ...
    { Sp1 ==> StrPosn(1, 1)
      ...
      assertMatch("MyId".findTokens){ case GoodRefs1(IdentifierToken(Sp1, "MyId")) => }
      assertMatch("My3".findTokens){ case GoodRefs1(IdentifierToken(Sp1, "My3")) => }
      assertMatch("My3Id".findTokens){ case GoodRefs1(IdentifierToken(Sp1, "My3Id")) => }
      assertMatch("Ab3_5fG".findTokens){ case GoodRefs1(IdentifierToken(Sp1, "Ab3_5fG")) => }
