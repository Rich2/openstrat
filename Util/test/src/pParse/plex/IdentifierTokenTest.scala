...
{ val z1 = "Zog"
  ...
  val p1 = StrPosn(1, 1)
  val r1: ErrBi3[LexarException, CharsOff, TextPosn, Token] = lexIdentifierToken(o1, p1)(using z1.toChars)
  val z2 = "zog"
  val r2: ErrBi3[LexarException, CharsOff, TextPosn, Token] = lexIdentifierToken(o1, p1)(using z2.toChars)
  val e1 = "e4a"
  val r3: ErrBi3[LexarException, CharsOff, TextPosn, Token] = lexIdentifierToken(o1, p1)(using e1.toChars)
