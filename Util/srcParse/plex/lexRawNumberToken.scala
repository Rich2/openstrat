...
{
  def apply(rem: CharsOff, tp: TextPosn, str: String, isNeg: Boolean)(implicit charArr: CharArr): ErrBi3[ExcLexar, CharsOff, TextPosn, Token] = rem match
...
object parseBase32
{
  def apply(rem: CharsOff, tp: TextPosn, str: String, isNeg: Boolean)(implicit charArr: CharArr): ErrBi3[ExcLexar, CharsOff, TextPosn, ValidRawBase32IntToken] = rem match
...
{
  def apply(rem: CharsOff, tp: TextPosn, seq1: String, seq2: String, isNeg: Boolean)(implicit charArr: CharArr): ErrBi3[ExcLexar, CharsOff, TextPosn, Token] =
  rem match
  {
...
{
  def apply(rem: CharsOff, tp: TextPosn, digitsStr: String, isNeg: Boolean, alphaStr: String)(implicit charArr: CharArr): ErrBi3[ExcLexar, CharsOff, TextPosn, Token] =
    rem match
