...
{ override def baseMap[B, BB <: EMonBase[B]](f: Int => B)(implicit build: EMonBuild[B, BB]): BB = build(f(value))
  override def baseFlatMap[B, BB <: EMonBase[B]](f: Int => BB)(implicit build: EMonBuild[B, BB]): BB = f(value)
...
{ def baseMap[B, BB <: EMonBase[B]](f: Ints => B)(implicit build: EMonBuild[B, BB]): BB
}

final case class GoodInts(value: Ints) extends EMonInts with GoodBase[Ints]
{ override def baseMap[B, BB <: EMonBase[B]](f: Ints => B)(implicit build: EMonBuild[B, BB]): BB = build(f(value))
  override def baseFlatMap[B, BB <: EMonBase[B]](f: Ints => BB)(implicit build: EMonBuild[B, BB]): BB = f(value)
