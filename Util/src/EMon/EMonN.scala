...
{ def flatMap[B](f: (A1, A2) => EMon[B]): EMon[B]
  def flatMapRefs[B <: AnyRef](f: (A1, A2) => ERefs[B]): ERefs[B]
...
{ override def flatMap[B](f: (A1, A2) => EMon[B]): EMon[B] = f(a1, a2)
  override def flatMapRefs[B <: AnyRef](f: (A1, A2) => ERefs[B]): ERefs[B] = f(a1, a2)
...
{ override def flatMap[B](f: (A1, A2) => EMon[B]): EMon[B] = Bad[B](errs)
  override def flatMapRefs[B <: AnyRef](f: (A1, A2) => ERefs[B]): ERefs[B] = BadRefs[B](errs)
...
{ def flatMap[B](f: (A1, A2, A3) => EMon[B]): EMon[B]
  def flatMapRefs[B <: AnyRef](f: (A1, A2, A3) => ERefs[B]): ERefs[B]
}
...
{ override def flatMap[B](f: (A1, A2, A3) => EMon[B]): EMon[B] = f(a1, a2, a3)
  override  def flatMapRefs[B <: AnyRef](f: (A1, A2, A3) => ERefs[B]): ERefs[B] = f(a1, a2, a3)
}
...
{ override def flatMap[B](f: (A1, A2, A3) => EMon[B]): EMon[B] = Bad[B](errs)
  override  def flatMapRefs[B <: AnyRef](f: (A1, A2, A3) => ERefs[B]): ERefs[B] = BadRefs[B](errs)
}