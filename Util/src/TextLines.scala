...
//case class TextIn1Line(text: String, tailLen: Int) extends TextInLines
//
...
// *  indented. */
//case class TextIn2Line(text: String, tailLen: Int) extends TextInLines
//
...
//case class TextInMultiLines(text: String, tailLen: Int) extends TextInLines
//
