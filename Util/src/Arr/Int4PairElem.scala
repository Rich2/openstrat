...
/** An [[Arr]] of [[PairElemRestrict]]s where the first component is an [[Int4Elem]]. */
...
{ type ThisT <: Int4PairArr[A1, ArrA1, A2, A]
  ...
  override final def unsafeSetElem(i: Int, newValue: A): Unit = { unsafeSetA1(i, newValue.a1);  a2Array(i) = newValue.a2 }
...
{ /** Constructs new pair element from 3 [[Int]]s and a third parameter of type A2. */
  ...
  { b1IntBuffer(i * 4) = newValue.a1Int1
    b1IntBuffer(i * 4 + 1) = newValue.a1Int2
    b1IntBuffer(i * 4 + 2) = newValue.a1Int3
    b1IntBuffer(i * 4 + 3) = newValue.a1Int4
