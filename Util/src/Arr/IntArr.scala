...
object IntArrBuilder extends ArrBuilder[Int, IntArr] with ArrFlatBuilder[IntArr]
{ type BuffT = IntBuff
  override def arrUninitialised(length: Int): IntArr = new IntArr(new Array[Int](length))
