...
trait ArrArrayDblBuild[A <: ArrayDblBacked, ArrT <: ArrArrayDbl[A]] extends ArrTBuilder[A, ArrT]
...
trait ArrayDoubleBuff[A <: ArrayDblBacked] extends Any with SeqArrayLikeBacked[A]
