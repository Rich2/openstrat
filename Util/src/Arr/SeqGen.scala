...
trait SeqGen[+A] extends Any with SqdfGen[A @uncheckedVariance]
{ /** The final type of this object. */
  type ThisT <: SeqGen[A]

  /** The length of this Sequence. This will have the same value as the dataLength property inherited from [[SqdfGen]][A]. */
  def length: Int
