...
trait ArrFlatBuilder[ArrB <: ArrBase[_]] extends DataBuilderCommon[ArrB]
...
{ /** This is the fall back builder implicit for Arrs that do not have their own specialist ArrBuildBase classes. It is placed in this low priority trait
 ...
 implicit def anyImplicit[A](implicit ct: ClassTag[A], @unused notA: Not[ElemValueN]#L[A]): ArrFlatBuilder[Arr[A]] = new AnyBuild[A]
}