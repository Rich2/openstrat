...
trait LongNsArrBuilders[B <: ElemLongN, ArrB <: ArrLongNs[B]] extends ValueNSeqDefPersist[B, ArrB]
{ type VT = Long
...
trait ArrLongNsCompanion[A <: ElemLongN, ArrA <: ArrLongNs[A]] extends ValueNSeqDefCompanion[A, ArrA]
