...
trait Dbl7sArr[A <: Dbl7Elem] extends Any with DblNArr[A]
{ def productSize: Int = 7
  ...
  //def toArrs: ArrOld[ArrOld[Double]] = mapArrSeq(el => ArrOld(el.dbl1, el.dbl2, el.dbl3, el.dbl4, el.dbl5, el.dbl6, el.dbl7))
