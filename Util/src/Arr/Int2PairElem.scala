...
{ type ThisT <: Int2PairArr[A1, ArrA1, A2, A]
  ...
  override final def setElemUnsafe(i: Int, newElem: A): Unit ={ a1ArrayInt(i * 2) = newElem.a1Int1; a1ArrayInt(i * 2 + 1) = newElem.a1Int2
  ...
  final override def setA1Unsafe(index: Int, value: A1): Unit = { a1ArrayInt(index * 2) = value.int1; a1ArrayInt(index * 2 + 1) = value.int1 }
