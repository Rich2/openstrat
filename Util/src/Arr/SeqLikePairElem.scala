...
trait SeqLikePairElem[A1E, A1 <: SeqLike[A1E], A2] extends ElemPair[A1, A2] with SpecialT
{ def a1: A1
  def a2: A2
}
...
trait SeqLikeDblNPairElem[A1E <: ElemDblN, A1 <: DblNSeqLike[A1E], A2] extends SeqLikePairElem[A1E, A1, A2]
{ /** The backing Array of Doubles for the A1 [[DblNSeqLike]]. */
  def a1ArrayDbl: Array[Double]
}

trait SeqLikeDblNPairArr[A1E <: ElemDblN, A1 <: DblNSeqLike[A1E], A1Arr <: Arr[A1], A2, A <: SeqLikePairElem[A1E, A1, A2]] extends
...
{ type ThisT <: SeqLikeDblNPairArr[A1E, A1, A1Arr, A2, A]
  ...
  final override def unsafeSetA1(index: Int, value: A1): Unit = { a1Array(index) = value.unsafeArray }
}

trait SeqLikeDblNPairBuff[B1E <: ElemDblN, B1 <: DblNSeqLike[B1E], B2, B <: SeqLikeDblNPairElem[B1E, B1, B2]] extends SeqLikePairBuff[B1E, B1, B2, B]
...
trait SeqLikeDblNPairArrBuilder[B1E <: ElemDblN, B1 <: DblNSeqLike[B1E], ArrB1 <: Arr[B1], B2, B <: SeqLikeDblNPairElem[B1E, B1, B2], ArrB <: PairArr[B1, ArrB1, B2, B]] extends
