...
/** An object that can be constructed from a single [[Double]]. These are used in [[Dbl1sSeq]] Array[Int] based collections. */
...
trait Dbl1sSeq[A <: Dbl1Elem] extends Any with DblNsSeq[A]
