...
{ /** This method and "fHead" removes the need for headOption in the majority of case. Use fHead when are interested in the tail value */
  ...
  def mapPairArr[B1, ArrB1 <: Arr[B1], B2, B <: PairFinalA1Elem[B1, B2], ArrB <: PairArrFinalA1[B1, ArrB1, B2, B]](f1: A => B1, f2: A => B2)(
   ...
   *  logically flattened to a [[PairArrFinalA1]][B1, B2]. */
  def flatMapPairArr[B1, ArrB1 <: Arr[B1], B2, BB <: PairArrFinalA1[B1, ArrB1, B2, ?]](f1: A => ArrB1, f2: A => B2)(implicit
