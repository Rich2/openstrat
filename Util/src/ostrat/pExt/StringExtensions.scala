...
{  
  ...
  def findTokens: ERefs[pParse.Token] = pParse.srcToETokens(thisString, "String")
  def findStatements: ERefs[pParse.Statement] = findTokens.flatMap(pParse.tokensToEStatements(_))
