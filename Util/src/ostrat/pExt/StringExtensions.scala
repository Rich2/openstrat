...
{  
  ...
  def findTokens: ERefs[pParse.Token] = pParse.srcETokens(thisString, "String")
  def findStatements: ERefs[pParse.Statement] = findTokens.flatMap(pParse.tokensEStatements(_))
