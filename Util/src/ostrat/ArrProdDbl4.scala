...
trait ArrProdDbl4[A <: HomoDbl4] extends Any with ArrProdDblN[A]
{
...
abstract class ProductD4sCompanion[A <: HomoDbl4, M <: ArrProdDbl4[A]] //extends ProductDsBuilder[A, M]
{
  val factory: Int => M
...
abstract class ArrHomoDbl4Builder[A <: HomoDbl4, M <: ArrProdDbl4[A]](typeStr: String) extends ArrHomoDblNBuilder[A, M](typeStr)
{
