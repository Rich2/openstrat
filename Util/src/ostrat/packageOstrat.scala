...
{ import collection.mutable.ArrayBuffer, reflect.ClassTag
  ...
  def iDblToMap[A, AA <: SeqImut[A]](iFrom: Double, iTo: Double, iStep: Double = 1)(f: Double => A)(implicit ev: ArrTBuilder[A, AA]): AA =
  ...
  def iToMap[A, AA <: SeqImut[A]](iFrom: Int, iTo: Int, iStep: Int = 1)(f: Int => A)(implicit ev: ArrTBuilder[A, AA]): AA =
  ...
  def iUntilMap[A, AA <: SeqImut[A]](iFrom: Int, iUntil: Int, iStep: Int = 1)(f: Int => A)(implicit ev: ArrTBuilder[A, AA]): AA =
  ...
  def iToFlatMap[AA <: SeqImut[_]](iFrom: Int, iTo: Int, iStep: Int = 1)(f: Int => AA)(implicit ev: ArrTFlatBuilder[AA]): AA =
  { val buff = ev.newBuff()
  ...
  def ijSameToMap[A, AA <: SeqImut[A]](nFrom: Int, nTo: Int, nStep: Int = 1)(f: (Int, Int) => A)(implicit ev: ArrTBuilder[A, AA]): AA =
