...
abstract class PersistSeqLike[A, R](override val evA: PersistDec[A]) extends ShowTSeqLike[A, R] with PersistCompound[R]
{
...
abstract class PersistIterable[A, R <: Iterable[A]](ev: PersistDec[A]) extends PersistSeqLike[A, R](ev) with ShowIterable[A, R]
...
class PersistSeqImplicit[A](ev: PersistDec[A]) extends PersistIterable[A, Seq[A]](ev)
{
