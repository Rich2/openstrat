...
trait Show5T[A1, A2, A3, A4, A5, R] extends ShowProductT[R]
...
object Show5T
{
  ...
  class Show5TImp[A1, A2, A3, A4, A5, R](val typeStr: String, val name1: String, fArg1: R => A1, val name2: String, fArg2: R => A2,
    ...
    implicit ev1: ShowT[A1], ev2: ShowT[A2], ev3: ShowT[A3], ev4: ShowT[A4], ev5: ShowT[A5]) extends Show5T[A1, A2, A3, A4, A5, R] with TypeStr5[A1, A2, A3, A4, A5]
  {
