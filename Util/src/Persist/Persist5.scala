...
class Show5T[A1, A2, A3, A4, A5, R](val typeStr: String, name1: String, fArg1: R => A1, name2: String, fArg2: R => A2, name3: String, fArg3: R => A3,
  ...
  opt2In: Option[A2] = None, opt1In: Option[A1] = None)(implicit ev1: ShowTDec[A1], ev2: ShowTDec[A2], ev3: ShowTDec[A3], ev4: ShowTDec[A4],
                                                        ev5: ShowTDec[A5]) extends ShowProductT[R]
{
...
object Show5T
{
  def apply[A1, A2, A3, A4, A5, R](typeStr: String, name1: String, fArg1: R => A1, name2: String, fArg2: R => A2, name3: String, fArg3: R => A3,
    ...
    opt2: Option[A2] = None, opt1: Option[A1] = None)(implicit ev1: ShowTDec[A1], ev2: ShowTDec[A2], ev3: ShowTDec[A3], ev4: ShowTDec[A4], ev5: ShowTDec[A5]) =
