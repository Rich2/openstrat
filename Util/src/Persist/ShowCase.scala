...
abstract class Show1[A1, R](val typeStr: String, name1: String, fArg1: R => A1, val opt1: Option[A1] = None)(implicit ev1: ShowT[A1], eq1: Eq[A1])
  extends EqCase1[A1, R](fArg1) with ShowCase[R]
{
  ...
  def showComma(obj: R): String = ev1.showT(fArg1(obj), 10)
  override def showSemiNames(obj: R): String = name1 -:- ev1.showComma(fArg1(obj))
  override def showCommaNames(obj: R): String = name1 -:- ev1.showT(fArg1(obj), 10)
}
  ...
  ShowCase[R]
{
  ...
  override def showComma(obj: R): String = ev1.showT(fArg1(obj), 10) + ", " + ev2.showT(fArg2(obj), 10)
  override def showSemiNames(obj: R): String = name1 -:- ev1.showComma(fArg1(obj)) + "; " + name2 -:- ev2.showComma(fArg2(obj))
  override def showCommaNames(obj: R): String = name1 -:- ev1.showT(fArg1(obj), 10) + ", " + name2 -:- ev2.showT(fArg2(obj), 10)
}
                                                                                     ...
                                                                                     eq1: Eq[A1], eq2: Eq[A2], eq3: Eq[A3]) extends EqCase3[A1, A2, A3, R](fArg1, fArg2, fArg3) with ShowCase[R]
{
  ...
  { val p1 = fArg1(obj)
    ...
    (opt1, opt2, opt3) match
    { case (Some(v1), Some(v2), Some(v3)) if v1 == p1 & v2 == p2 & v3 == p3 => ""
      case (_, Some(v2), Some(v3)) if v2 == p2 & v3 == p3 => ev1.showT(p1, 10) + ","
  ...
  override def showCommaNames(obj: R): String = name1 -:- ev1.showT(fArg1(obj), 10) + ", " + name2 -:- ev2.showT(fArg2(obj), 10) + name3 -:-
    ev3.showT(fArg3(obj), 10)
}
                             ...
                             eq4: Eq[A4]) extends EqCase4[A1, A2, A3, A4, R](fArg1, fArg2, fArg3, fArg4)(eq1, eq2, eq3, eq4) with ShowCase[R]
{
  ...
  { val p1 = fArg1(obj)
    ...
    val p3 = fArg3(obj)
    val p4 = fArg4(obj)
    ev1.showT(p1, 10).appendCommas(ev2.showT(p2, 10), ev3.showT(p3, 10), ev4.showT(p4, 10))
  }

  override def showSemiNames(obj: R): String = name1 -:- ev1.showComma(fArg1(obj)) + "; " + name2 -:- ev2.showComma(fArg2(obj)) + "; " +
    name3 -:- ev3.showComma(fArg3(obj)) + "; " + name4 -:- ev4.showComma(fArg4(obj))
  
  override def showCommaNames(obj: R): String = name1 -:- ev1.showT(fArg1(obj), 0) + ", " + name2 -:- ev2.showT(fArg2(obj), 0) + name3 -:- ev3.showT(fArg3(obj), 0) +
    name4 -:- ev4.showT(fArg4(obj), 0)
}
  ...
  ShowCase[R]
{
  ...
  { val p1 = fArg1(obj)
    ...
    val p4 = fArg4(obj)
    val p5 = fArg5(obj)
    ev1.showT(p1, 0).appendCommas(ev2.showT(p2, 0), ev3.showT(p3, 0), ev4.showT(p4, 0), ev5.showT(p5, 0))
  }
  ...
  override def showCommaNames(obj: R): String = name1 -:- ev1.showT(fArg1(obj), 0) + ", " + name2 -:- ev2.showT(fArg2(obj), 0) + name3 -:- ev3.showT(fArg3(obj), 0) +
    name4 -:- ev4.showT(fArg4(obj), 0)+ name5 -:- ev5.showT(fArg5(obj), 0)
}
                                        ...
                                        eq4: Eq[A4], eq5: Eq[A5], eq6: Eq[A6]) extends EqCase6[A1, A2, A3, A4, A5, A6, R](fArg1, fArg2, fArg3, fArg4, fArg5, fArg6) with ShowCase[R]
{
  ...
  { val p1 = fArg1(obj)
    ...
    val p5 = fArg5(obj)
    val p6 = fArg6(obj)
    ev1.showT(p1, 0).appendCommas(ev2.showT(p2, 0), ev3.showT(p3, 0), ev4.showT(p4, 0), ev5.showT(p5, 0), ev6.showT(p6, 0))
  }
  ...
  override def showCommaNames(obj: R): String = name1 -:- ev1.showT(fArg1(obj), 0) + ", " + name2 -:- ev2.showT(fArg2(obj), 0) + name3 -:- ev3.showT(fArg3(obj), 0) +
    name4 -:- ev4.showT(fArg4(obj), 0) + name5 -:- ev5.showT(fArg5(obj), 0) + name6 -:- ev6.showT(fArg6(obj), 0)
}
