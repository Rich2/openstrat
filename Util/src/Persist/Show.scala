 ...
 *  ShowT type class instance. It is better for the [[ShowPrecisionT]] type class instance to delegate to this trait than have the toString method delegate to
 *  the [[ShowPrecisionT]] type class instance in the companion object. Potentially that can create initialisation order problems, but at the very least it
...
/** Companion object of the Show trait contains the Way trait, used by the show method on Show and the showT method on [[ShowPrecisionT]] */
object ShowPrec
{
}
...
trait ShowSingleton extends ShowPrec
