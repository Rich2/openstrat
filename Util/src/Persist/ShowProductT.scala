...
/** The base trait for the persistence of algebraic product types, including case classes. */
trait ShowProductPrecT[R] extends ShowCompoundPrecT[R] with ShowProductT[R]
{
...
abstract class Show4T[A1, A2, A3, A4, R](val typeStr: String, name1: String, fArg1: R => A1, name2: String, fArg2: R => A2, name3: String,
  ...
  opt1In: Option[A1] = None)(implicit ev1: ShowPrecisionT[A1], ev2: ShowPrecisionT[A2], ev3: ShowPrecisionT[A3], ev4: ShowPrecisionT[A4]) extends ShowProductPrecT[R]
{
...
class Show5T[A1, A2, A3, A4, A5, R](val typeStr: String, name1: String, fArg1: R => A1, name2: String, fArg2: R => A2, name3: String, fArg3: R => A3,
  ...
  ev5: ShowPrecisionT[A5]) extends ShowProductPrecT[R]
{
...
class Show6T[A1, A2, A3, A4, A5, A6, R](val typeStr: String, name1: String, fArg1: R => A1, name2: String, fArg2: R => A2, name3: String,
  ...
  implicit ev1: ShowPrecisionT[A1], ev2: ShowPrecisionT[A2], ev3: ShowPrecisionT[A3], ev4: ShowPrecisionT[A4], ev5: ShowPrecisionT[A5], ev6: ShowPrecisionT[A6]) extends ShowProductPrecT[R]
{
