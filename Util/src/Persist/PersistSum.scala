...
abstract class PersistSum2[ST <: AnyRef, A1 <: ST , A2 <: ST](val ev1: PersistPrec[A1], val ev2: PersistPrec[A2])(implicit ct1: ClassTag[A1],
    ct2: ClassTag[A2]) extends ShowSum2[ST, A1, A2] with UnShowSum2[ST, A1, A2] with PersistPrec[ST]