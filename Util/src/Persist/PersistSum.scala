...
abstract class ShowSum2[ST <: AnyRef, A1 <: ST, A2 <: ST]()(implicit val ct1: ClassTag[A1], val ct2: ClassTag[A2]) extends ShowPrecisionT[ST]
{
  def ev1: ShowPrecisionT[A1]
  def ev2: ShowPrecisionT[A2]
...
object ShowSum2
{
  def apply[ST <: AnyRef, A1 <: ST, A2 <: ST](typeIn: String, ev1In: ShowPrecisionT[A1], ev2In: ShowPrecisionT[A2])(implicit ct1: ClassTag[A1], ct2: ClassTag[A2]):
    ShowSum2[ST, A1, A2] = new ShowSum2[ST, A1, A2]()(ct1, ct2)
  { override def typeStr: String = typeIn
    override def ev1: ShowPrecisionT[A1] = ev1In
    override def ev2: ShowPrecisionT[A2] = ev2In
  }
}
...
abstract class PersistSum2[ST <: AnyRef, A1 <: ST , A2 <: ST](val ev1: PersistPrecision[A1], val ev2: PersistPrecision[A2])(implicit ct1: ClassTag[A1],
    ct2: ClassTag[A2]) extends ShowSum2[ST, A1, A2] with UnShowSum2[ST, A1, A2] with PersistPrecision[ST]