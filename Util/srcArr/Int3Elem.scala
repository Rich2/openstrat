...
trait SeqLikeInt3[A <: Int3Elem] extends Any, SeqLikeIntN[A]
...
trait BuffInt3[A <: Int3Elem] extends Any, BuffIntN[A]
...
trait BuilderSeqLikeInt3Map[B <: Int3Elem, BB <: SeqLikeInt3[B]] extends BuilderSeqLikeInt3[BB], BuilderSeqLikeIntNMap[B, BB]
...
trait BuilderSeqLikeInt3Flat[BB <: SeqLikeInt3[?]] extends BuilderSeqLikeInt3[BB], BuilderSeqLikeIntNFlat[BB]
