...
trait Dbl4SeqLike[A <: Dbl4Elem] extends Any with SeqLikeDblN[A]
...
trait Dbl4SeqSpec[A <: Dbl4Elem] extends Any with Dbl4SeqLike[A] with SeqSpecDblN[A]
...
/** Trait for creating the ArrTBuilder type class instances for [[Dbl4Arr]] final classes. Instances for the [[BuilderMapArr]] type class, for classes /
...
/** Trait for creating the ArrTBuilder and ArrTFlatBuilder type class instances for [[Dbl4Arr]] final classes. Instances for the [[BuilderMapArr]] type
