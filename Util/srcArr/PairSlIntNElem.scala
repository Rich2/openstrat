...
trait PairSlIntNElem[A1E <: IntNElem, A1 <: SeqLikeIntNImut[A1E], A2] extends PairSeqLikeElem[A1E, A1, A2] with ArrayIntBackedPair[A1, A2]

/** An [[Arr]] of [[PairElem]]s where the first component of each pair is a [[SeqLikeIntN]]. */
trait ArrPairSeqLikeIntN[A1E <: IntNElem, A1 <: SeqLikeIntNImut[A1E], ArrA1 <: Arr[A1], A2, A <: PairSlIntNElem[A1E, A1, A2]] extends
...
trait BuffPairSlIntN[B1E <: IntNElem, B1 <: SeqLikeIntNImut[B1E], B2, B <: PairSlIntNElem[B1E, B1, B2]] extends BuffPairSeqLike[B1E, B1, B2, B]
...
trait BuilderMapArrPairSeqLikeIntN[B1E <: IntNElem, B1 <: SeqLikeIntNImut[B1E], ArrB1 <: Arr[B1], B2, B <: PairSlIntNElem[B1E, B1, B2],
