...
{ implicit val intsImplicit: BuilderMapArr[Int, IntArr] = IntArrBuilder
  ...
  implicit val stringImplicit: BuilderMapArr[String, StrArr] = StringArrBuilder
...
object BuilderFlatArr extends BuilderFlatArrPriority2
