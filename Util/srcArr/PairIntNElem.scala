...
trait BuilderArrPairIntNFlat[B1 <: IntNElem, ArrB1 <: ArrIntN[B1], B2, ArrB <: ArrPairIntN[B1, ArrB1, B2, ?]] extends
  BuilderArrPairIntN[B1, ArrB1, B2, ArrB] with BuilderFlatArrPair[B1, ArrB1, B2, ArrB]
{
