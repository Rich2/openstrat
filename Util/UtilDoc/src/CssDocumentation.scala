...
object CssDocumentation extends CssOpenstrat
{
  override def rules: RArr[CssRuleLike] = RArr(
    ...
    CssSelsRule("code", ChildSel("code", "span"), ChildSel("code", "div"))(FontSizeDec(14.px), BGColourDec(Black), ColourDec(White), PadBottomDec(0.1.em)),
    CssSelsRule(".output", ChildSel(".output", "div"))(BGColourDec(Black), ColourDec(Pink)),
