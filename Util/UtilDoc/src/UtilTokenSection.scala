...
object UtilTokenSection extends Section
{
  ...
  def tokList: UlSection = UlSection("The Tokeniser will create the following tokens",
    LiHtml("""Keytokens <span class= lexical>_ ? ?? ???</ span >"""),
    LiHtml("Identifiers alphanumeric tokens starting with a letter or underscore character."), LiHtml("Operators"),
    LiHtml("Numeric literals"), LiHtml("Separators , . .. ... {} etc."), LiHtml("String literals"), LiHtml("Character literals"), LiHtml("Comments"))
  ...
  def identList = UlSection("Identifiers are categorised into 3 types.", LiHtml("IdentUnder An identifer beginning with an underscore character."),
    LiHtml("IdentLow And identifer beginning with a lower case alphabetic character."),
    LiHtml("IdentUp An identifer beginning with an upper case alphabetic character. Some of these tokens will also be consider valid raw Base32" --
  ...
  def lits: OlSection = OlSection("Numerical literals come in 4 types.",
    LiHtml("Floating point numbers <span class= lexical>6.02e23 6.02e-23 6.02e-23d</span>.Note this is the only case where a negative or dash" --
    ...
    LiHtml("Explicit hexadecimals <span class= lexical>0x433A 0x2222 0xff000bc</span> Alphabetic characters must be all lower or all upper case."),
  ...
  def digToksEl = UlSection("DigitCode tokens. These are a sequence of one or more sequences of digits separated by decimal points, as well as" --
    ...
    "divided into",
    LiHtml("Valid natural integers <span class= lexical>0 21 567</span> These are valid raw hexademimal and raw Base32 tokens."),
    LiHtml("Valid natural integers with trailing lower case alphabetic characters at the end of the token" --
    ...
    LiHtml("Raw Hexadecimals that start with a digit, the alphabetic characters must be all lower or all upper case." --
      "<span class= lexical>3A 2d1e 567D</span>. These are also valid raw Base32 tokens."),
    LiHtml("Raw Base32 tokens that start with a digit that are not valid raw Hexadecimals, the alphabetic characters must be all lower or all" --
      "upper case. <span class= lexical>3G 2d1s 567R</span>"),
    LiHtml("Valid fractional decimal numbers, which may have trailing lower case alphabetic characters at the end of the token" --
      "<span class= lexical>0.0f 2084.4 3.1rc</span>"),
    LiHtml("DigitCode Tokens with 3 or greater digit sequence parts <span class= lexical>2.13.4 0.0.3snap 192.168.1.1</span>")
  )

  def negToks = LiHtml("There will be tokens for negative numbers. <span class= lexical>-5 -5.32 -5.87e7 -0xA434</span> will all be lexically" --
