...
object Show5T
{
  ...
  class Show5TImp[A1, A2, A3, A4, A5, R](val typeStr: String, val name1: String, fArg1: R => A1, val name2: String, fArg2: R => A2,
    ...
    implicit val persist1: ShowT[A1], val persist2: ShowT[A2], val persist3: ShowT[A3], ev4: ShowT[A4], ev5: ShowT[A5]) extends Show5T[A1, A2, A3, A4, A5, R]// with TypeStr5Plus[A1, A2, A3, A4, A5]
  {
...
object Persist5
{
  ...
  class Persist5Imp[A1, A2, A3, A4, A5, R](val typeStr: String, val name1: String, val fArg1: R => A1, val name2: String, val fArg2: R => A2,
    ...
    opt1In: Option[A1] = None)(implicit val persist1: Persist[A1], val persist2: Persist[A2], val persist3: Persist[A3], val ev4: Persist[A4],
