...
/** A convenience trait type class trait for persistence, that combines the [[Showing]] and [[Unshow]] type classes. Most if not all final classes that
...
trait Persist[T] extends Showing[T] with Unshow[T]
