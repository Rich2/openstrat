...
object PersistNumsTest  extends TestSuite
{
  val tests = Tests {
    ...
    test("Doubles")
     { 23.4.str ==> "23.4"
       8.0.str ==> "8"
       9.12345.show(ShowStd, 0, 0) ==> "9"
       9.12345.show(ShowStd, 1, 0) ==> "9.1"
       9.12345.show(ShowStd, 4, 0) ==> "9.1234"
       4.3234.show(ShowStd, 6, 6) ==> "4.323400"
       234.568.show(ShowStd, -1, 4) ==> "234.5680"
