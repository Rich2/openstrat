...
object IdentifierTokenTest extends TestSuite
{
  ...
  val p1 = StrPosn(1, 1)
  val r1: EEMon3[CharsOff, TextPosn, Token] = lexIdentifierToken(o1, p1)(z1.toChars)
  val z2 = "zog"
  val r2: EEMon3[CharsOff, TextPosn, Token] = lexIdentifierToken(o1, p1)(z2.toChars)
  val e1 = "e4a"
  val r3: EEMon3[CharsOff, TextPosn, Token] = lexIdentifierToken(o1, p1)(e1.toChars)
