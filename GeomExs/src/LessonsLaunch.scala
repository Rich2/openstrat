...
object LessonsLaunch extends GuiLaunchMore
{
  ...
  val aList: RArr[LessonGraphics] = RArr(LsACircles, LsASquares, LsACircles2, LsAPolygons, LsARotation, LsAArcs, LsAShapes, LsAShapesReproduction, LsABeziers,
    LsADiagram, LsAReflect, LsAHexEnum, LsATiling, LsAEllipses, LsAInnerRect, LsAPolygonSides, LsAText)
