...
{ override def getTime: Long = 0
  override protected def tlPolyFill(poly: PolygonTr, colour: Colour): Unit = {}
  override protected def tlPolyDraw(poly: PolygonTr, lineWidth: Double, colour: Colour): Unit = {}
