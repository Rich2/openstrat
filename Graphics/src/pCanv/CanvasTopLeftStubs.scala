...
{ override def getTime: Long = 0
  ...
  override protected def tlShapeFill(shape: ShapeGen, colour: Colour): Unit = {}
  override protected def tlShapeDraw(shape: ShapeGen, lineWidth: Double, colour: Colour): Unit = {}
