...
object TransAlign
{
  ...
  { override def slate(obj: GeomElem, offset: Pt2): GeomElem = obj.slate(offset)
  ...
  { override def slate(obj: T, offset: Pt2): T = obj.slate(offset).asInstanceOf[T]
  ...
  { override def slate(obj: AA, offset: Pt2): AA = obj.map(ev.slate(_, offset))
  ...
  { override def slate(obj: F[A], offset: Pt2): F[A] = evF.mapT(obj, evA.slate(_, offset))
  ...
  { override def slate(obj: Array[A], offset: Pt2): Array[A] = obj.map(ev.slate(_, offset))
