 ...
 *  a BezierSeg. */
class ShapeGenOld(val arrayUnsafe: Array[Double]) extends /* Shape with */ ArrProdDbl7[CurveTail] with AffinePreserve
...
object ShapeGenOld extends ProdDbl7sCompanion[CurveTail, ShapeGenOld]
