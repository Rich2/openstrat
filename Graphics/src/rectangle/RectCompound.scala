...
case class RectCompound(shape: Rect, facets: Arr[GraphicFacet], children: Arr[GraphicElem] = Arr()) extends RectGraphic with RectangleCompound
{
  ...
  override def slateXY(xOffset: Double, yOffset: Double): RectCompound =
    RectCompound(shape.slateXY(xOffset, yOffset), facets, children.SlateXY(xOffset, yOffset))
...
object RectCompound
{
  ...
  implicit val XYScaleImplicit: ScaleXYT[RectCompound] = (obj, xOperand, yOperand) => obj.scaleXY(xOperand, yOperand)
