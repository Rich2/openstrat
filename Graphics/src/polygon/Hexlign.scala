...
final class Hexlign(val dInner: Double, val xCen: Double, val yCen: Double) extends HexReg
{ override def cen: Pt2 = xCen pp yCen
  ...
  override def sd4Cen: Pt2 = Pt2(0, -rInner)
  ...
  override def sd1Cen: Pt2 = Pt2(0, rInner)
  ...
  override def xySlate(xOffset: Double, yOffset: Double): Hexlign = Hexlign(dInner, cen.addXY(xOffset, yOffset))
  ...
  override def scale(operand: Double): Hexlign = Hexlign(dInner * operand, cen.scale(operand))

  /** Mirror, reflection transformation of a Hexlign across the X axis, returns a Hexlign. */
  override def negY: Hexlign = Hexlign(dInner, cen.negY)

  /** Mirror, reflection transformation of Hexlign across the Y axis, returns a Hexlign. */
  override def negX: Hexlign = Hexlign(dInner, cen.negX)

  override def rotate90: HexYlign = HexYlign(dInner, cen.rotate90)
  override def rotate180: Hexlign = Hexlign(dInner, cen.rotate180)
  override def rotate270: HexYlign = HexYlign(dInner, cen.rotate270)

  /** Prolign 2d transformations, similar transformations that retain alignment with the axes. */
  override def prolign(matrix: ProlignMatrix): Hexlign = Hexlign(dInner, cen.prolign(matrix))
}
