 ...
 *  maps. */
final class PolygonMetre3(val arrayUnsafe: Array[Double]) extends AnyVal with Dbl3sSeq[PtMetre3] with PolygonDbl3s[PtMetre3]
...
object PolygonMetre3 extends Dbl3sDataCompanion[PtMetre3, PolygonMetre3]
{ override def fromArrayDbl(array: Array[Double]): PolygonMetre3 = new PolygonMetre3(array)

  implicit val persistImplicit: Dbl3sDataPersist[PtMetre3, PolygonMetre3] = new Dbl3sDataPersist[PtMetre3, PolygonMetre3]("PolygonMs3")
