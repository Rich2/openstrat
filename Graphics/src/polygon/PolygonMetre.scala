...
final class PolygonMetre(val arrayUnsafe: Array[Double]) extends AnyVal with Dbl2sSeq[PtMetre2] with PolygonDbl2s[PtMetre2]
...
object PolygonMetre extends Dbl2sDataCompanion[PtMetre2, PolygonMetre]
{ override def fromArrayDbl(array: Array[Double]): PolygonMetre = new PolygonMetre(array)

  implicit val persistImplicit: Dbl2sDataPersist[PtMetre2, PolygonMetre] = new Dbl2sDataPersist[PtMetre2, PolygonMetre]("PolygonMs")
