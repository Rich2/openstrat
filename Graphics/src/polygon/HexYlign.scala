...
{ override def cen: Pt2 = xCen pp yCen
  ...
  override def xSd1Cen: Double = rInner
  override def ySd1Cen: Double = 0
  override def sd1Cen: Pt2 = Pt2(rInner, 0)
  override def xSd4Cen: Double = -rInner
  override def ySd4Cen: Double = 0
  override def sd4Cen: Pt2 = Pt2(-rInner, 0)
  ...
  override def rotate90: Hexlign = Hexlign(dInner, cen.rotate90)
