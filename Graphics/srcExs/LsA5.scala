...
//  val a2 = a1 ++ a1.flatMap(_.startCenEndTexts)
  ...
  val p90 = ps.rotateAbout(cc, 90.vDegs)
  val p135 = ps.rotateAbout(cc, 135.vDegs)
  val p180 = ps.rotateAbout(cc, 180.vDegs)
  val p225 = ps.rotateAbout(cc, 225.vDegs)
  val p270 = ps.rotateAbout(cc, 270.vDegs)
