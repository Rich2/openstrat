...
{ val r0 = Rect(200, 100)
  val r1 = r0.xySlate(-300,300)
  val r2 = r0.xySlate(300, 300)
  val r3 = r0.xySlate(300, -300)
  val r4 = r0.xySlate(-300, -300)
  ...
  mouseUp = (button: MouseButton, selected: List[Any], posn: Pt2) => selected match
  {
    case ::(cen: Pt2, tail) =>
