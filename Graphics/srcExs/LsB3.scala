...
case class LsB3(canv: CanvasPlatform) extends CanvasNoPanels("Lesson B3")
{
  ...
  timedRepaint{e =>
    ...
    val e3 = 5000 - e2
    Arr(
      Rect(200, 100).xSlate(e3 / 4 - 600).fill(Colour.fromInts(0, 255 * e2 / 5000, 255 * e3 / 5000)),
      Rect(200, 100).xSlate(e2 / 4 - 600).fill(Colour.fromInts(255* e3 / 5000, 255 * e2 /5000, 0 ,  128))
    )
  }
}
