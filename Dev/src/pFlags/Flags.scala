...
{ val name = "China"
  val ratio = 1.5
  val apply: Arr[DisplayElem] =Arr[DisplayElem](Rectangle(1.5, 1).fillOld(Red),
    Rectangle.fromTL(0.75, 0.5, - 0.75 vv 0.5).fillOld(DarkBlue))
}
...
{ val name = "White"
  val ratio = 1.5
  val apply: Arr[DisplayElem] = Arr[DisplayElem](Rectangle(1.5, 1).fillOld(White))
}
...
{ val name = "CommonShapesInFlags"
  ...
  {
    Arr[DisplayElem](
      Rectangle(1.5, 1).fillOld(White),

      //off centre cross
      Rectangle(ratio, 0.25).fillOld(Green),
      Rectangle(0.25, 1).fillOld(Green).slate(-0.3 vv 0),
...
{ val name = "Eritrea"
  val ratio = 2.0
  val apply: Arr[DisplayElem] =
  { val blueRectangle = Rectangle(2, 0.5, 0 vv 0.25).fillOld(Colour(0xFF4189dd))
    val greenRectangle =Rectangle(2, 0.5, 0 vv -0.25).fillOld(Colour(0xFF12ad2b))
...
{ val name = "Papua New Guinea"
  val ratio = 4.0/3
  val apply: Arr[DisplayElem] =
  { val base = Rectangle(ratio, 1).fillOld(Black)
