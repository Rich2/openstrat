...
{ def name: String
  ...
  def leftToRight(colours: Colour*): Arr[GraphicAffineElem] = colours.iMap((colour, i) => Rectangle.fromTL(ratio / colours.length, 1,
  ...
  def topToBottom(colours: Colour*): Arr[GraphicAffineElem] = colours.iMap((colour, i) => Rectangle.fromTL(ratio,
