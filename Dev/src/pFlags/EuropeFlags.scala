...
{ val name = "CCCP"
  ...
  val apply: GraphicElems = Arr(
    ...
    //hammer
    PolyCurve(LineTail(-0.7709 pp 0.2138), LineTail(-0.7395 pp 0.1822), LineTail(-0.7099 pp 0.2116),
    ...
    //sickle
    PolyCurve(LineTail(-0.6695 pp 0.3163), BezierTail(-0.6437 pp 0.3018, -0.624 pp 0.2809, -0.6124 pp 0.259),
