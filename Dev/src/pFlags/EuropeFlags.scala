...
{ val name = "CCCP"
  ...
  { Arr[GraphicElem](
    ...
    PolyCurve(LineTail(-0.7709 vv 0.2138), LineTail(-0.7395 vv 0.1822), LineTail(-0.7099 vv 0.2116),
      ...
      BezierTail(-0.5415 vv 0.07472, -0.5415 vv 0.08566, -0.5482 vv 0.09243), BezierTail(-0.5962 vv 0.1378, -0.6444 vv 0.1834, -0.6924 vv 0.2289),
      LineTail(-0.6525 vv 0.2686), LineTail(-0.7081 vv 0.2763), LineTail(-0.7709 vv 0.2138)).fill(Colour(0xFFFFD700)),
    //sickle
    PolyCurve(LineTail(-0.6695 vv 0.3163), BezierTail(-0.6437 vv 0.3018, -0.624 vv 0.2809, -0.6124 vv 0.259),
      BezierTail(-0.6007 vv 0.2369, -0.5955 vv 0.2137, -0.5954 vv 0.1953), BezierTail(-0.5952 vv 0.1574, -0.6262 vv 0.1266, -0.6641 vv 0.1266),
      BezierTail(-0.6843 vv 0.1266, -0.7025 vv 0.1354, -0.715 vv 0.1493), LineTail(-0.722 vv 0.1434),
      BezierTail(-0.7232 vv 0.1439, -0.7244 vv 0.1441, -0.7257 vv 0.1441), BezierTail(-0.7287 vv 0.1441, -0.7316 vv 0.1428, -0.7336 vv 0.1405),
      BezierTail(-0.7386 vv 0.1398, -0.7427 vv 0.1364, -0.7443 vv 0.1316), BezierTail(-0.7495 vv 0.1212, -0.7587 vv 0.1129, -0.7698 vv 0.1092),
      BezierTail(-0.7699 vv 0.1091, -0.77 vv 0.1091, -0.7701 vv 0.109), BezierTail(-0.7752 vv 0.1072, -0.7803 vv 0.1038, -0.7847 vv 0.09938),
      BezierTail(-0.7934 vv 0.09065, -0.7976 vv 0.07948, -0.7952 vv 0.07165), BezierTail(-0.7954 vv 0.07097, -0.7956 vv 0.07025, -0.7956 vv 0.06953),
      BezierTail(-0.7956 vv 0.06591, -0.7926 vv 0.06298, -0.789 vv 0.06298), BezierTail(-0.7881 vv 0.06298, -0.7872 vv 0.06317, -0.7864 vv 0.06354),
      BezierTail(-0.7786 vv 0.06178, -0.7679 vv 0.06612, -0.7596 vv 0.07447), BezierTail(-0.7549 vv 0.07922, -0.7514 vv 0.08485, -0.7497 vv 0.09036),
      BezierTail(-0.7458 vv 0.1014, -0.7375 vv 0.1104, -0.727 vv 0.1154), BezierTail(-0.7267 vv 0.1156, -0.7265 vv 0.1157, -0.7263 vv 0.1158),
      BezierTail(-0.7228 vv 0.1175, -0.7202 vv 0.1207, -0.7193 vv 0.1245), BezierTail(-0.7031 vv 0.1054, -0.6789 vv 0.09325, -0.6517 vv 0.09262),
      BezierTail(-0.602 vv 0.09145, -0.5649 vv 0.128, -0.5631 vv 0.1807), BezierTail(-0.5623 vv 0.2072, -0.5725 vv 0.2413, -0.5959 vv 0.2693),
      BezierTail(-0.6137 vv 0.2907, -0.6399 vv 0.3085, -0.6695 vv 0.3163), LineTail(-0.6695 vv 0.3163)).fill(Colour(0xFFFFD700)),
    //outer star
