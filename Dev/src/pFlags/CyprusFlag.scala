...
{ val name = "Cyprus"
  ...
  val apply =
  {
    ...
    val map = PolyCurve(LineTail(0.4619 vv 0.3267), LineTail(0.458 vv 0.3252), LineTail(0.4564 vv 0.3245), LineTail(0.4517 vv 0.3248),
      ...
      LineTail(-0.07402 vv -0.08272), LineTail(-0.06875 vv -0.07925), LineTail(-0.06332 vv -0.07689), LineTail(-0.06318 vv -0.07623), LineTail(-0.06257 vv -0.07648), LineTail(-0.04875 vv -0.07178), LineTail(-0.04852 vv -0.07175), LineTail(-0.04237 vv -0.07068), LineTail(-0.0008352 vv -0.0736), LineTail(0.0007048 vv -0.07314), LineTail(0.0007115 vv -0.07313), LineTail(0.002095 vv -0.06925), LineTail(0.00284 vv -0.06853), LineTail(0.003335 vv -0.06806), LineTail(0.007901 vv -0.06605), LineTail(0.01004 vv -0.06574), LineTail(0.01596 vv -0.0672), LineTail(0.01839 vv -0.0678), LineTail(0.02228 vv -0.06562), LineTail(0.02503 vv -0.06567), LineTail(0.03073 vv -0.06256), LineTail(0.03425 vv -0.06265), LineTail(0.03558 vv -0.06211), LineTail(0.04244 vv -0.05719), LineTail(0.04904 vv -0.0553), LineTail(0.05076 vv -0.05438), LineTail(0.05136 vv -0.05405), LineTail(0.05813 vv -0.05048), LineTail(0.06243 vv -0.04718), LineTail(0.06614 vv -0.04521), LineTail(0.0702 vv -0.04416), LineTail(0.08083 vv -0.04341), LineTail(0.08297 vv -0.03985), LineTail(0.08754 vv -0.03924), LineTail(0.09031 vv -0.03612), LineTail(0.09347 vv -0.03483), LineTail(0.09573 vv -0.03157), LineTail(0.09763 vv -0.02884), LineTail(0.1003 vv -0.0273), LineTail(0.1088 vv -0.02677), LineTail(0.1189 vv -0.02802), LineTail(0.1202 vv -0.02721), LineTail(0.1225 vv -0.01908), LineTail(0.1248 vv -0.01756), LineTail(0.1313 vv -0.008204), LineTail(0.1313 vv -0.004796), LineTail(0.1313 vv -0.001949), LineTail(0.1323 vv 0.002104), LineTail(0.1316 vv 0.009422), LineTail(0.1325 vv 0.01683), LineTail(0.1365 vv 0.02625), LineTail(0.14 vv 0.03005), LineTail(0.1457 vv 0.03388), LineTail(0.1485 vv 0.03514), LineTail(0.1526 vv 0.03582), LineTail(0.1526 vv 0.03582), LineTail(0.1532 vv 0.03593), LineTail(0.1542 vv 0.0361), LineTail(0.1683 vv 0.0363), BezierTail(0.1685 vv 0.03644, 0.1734 vv 0.03637, 0.1734 vv 0.03637), LineTail(0.1781 vv 0.03643), LineTail(0.19 vv 0.03432), LineTail(0.1908 vv 0.03417), LineTail(0.1948 vv 0.03288), LineTail(0.1994 vv 0.02928), LineTail(0.2043 vv 0.0245), LineTail(0.2052 vv 0.02361), LineTail(0.2084 vv 0.02227), LineTail(0.2094 vv 0.02186), LineTail(0.212 vv 0.02227), LineTail(0.2157 vv 0.02422), LineTail(0.2185 vv 0.02659), LineTail(0.2224 vv 0.02869), LineTail(0.2225 vv 0.02882), LineTail(0.2246 vv 0.03207), LineTail(0.2247 vv 0.03214), LineTail(0.2247 vv 0.03212), LineTail(0.2247 vv 0.03214), LineTail(0.2247 vv 0.03215), LineTail(0.2256 vv 0.03344), LineTail(0.233 vv 0.03633), LineTail(0.2417 vv 0.03684), LineTail(0.2427 vv 0.03737), LineTail(0.2432 vv 0.03766), LineTail(0.2455 vv 0.04036), LineTail(0.2477 vv 0.04038), LineTail(0.2529 vv 0.03849), LineTail(0.2566 vv 0.03922), LineTail(0.2595 vv 0.03806), LineTail(0.2617 vv 0.03832), LineTail(0.266 vv 0.03883), LineTail(0.2706 vv 0.0356), LineTail(0.2733 vv 0.03526), LineTail(0.2827 vv 0.02974), LineTail(0.2832 vv 0.02966), LineTail(0.2835 vv 0.02962), LineTail(0.284 vv 0.02953), LineTail(0.2851 vv 0.02986), LineTail(0.2868 vv 0.03034), LineTail(0.287 vv 0.03041), LineTail(0.2872 vv 0.03012), LineTail(0.2883 vv 0.0286), LineTail(0.2898 vv 0.02839), LineTail(0.2915 vv 0.03072), LineTail(0.2908 vv 0.03177), LineTail(0.2905 vv 0.03215), LineTail(0.2872 vv 0.03284), LineTail(0.2841 vv 0.03801), LineTail(0.287 vv 0.04111), LineTail(0.2825 vv 0.04665), LineTail(0.2818 vv 0.04757), LineTail(0.2815 vv 0.04796), LineTail(0.2799 vv 0.05033), LineTail(0.272 vv 0.06239), LineTail(0.2617 vv 0.07062), LineTail(0.2617 vv 0.07061), LineTail(0.2581 vv 0.0735), LineTail(0.2581 vv 0.07351), LineTail(0.2568 vv 0.07451), LineTail(0.2513 vv 0.0801), LineTail(0.2474 vv 0.08532), LineTail(0.2469 vv 0.08644), LineTail(0.2461 vv 0.08821), LineTail(0.2437 vv 0.09334), LineTail(0.2396 vv 0.0965), LineTail(0.2363 vv 0.1002), LineTail(0.2361 vv 0.1004), LineTail(0.2292 vv 0.1097), LineTail(0.2281 vv 0.1113), LineTail(0.2264 vv 0.1123), LineTail(0.223 vv 0.1123), LineTail(0.2227 vv 0.1126), LineTail(0.2225 vv 0.1128), LineTail(0.2226 vv 0.1129), LineTail(0.2243 vv 0.1146), LineTail(0.2261 vv 0.115), LineTail(0.2269 vv 0.1169), LineTail(0.2234 vv 0.127), LineTail(0.2233 vv 0.1274), LineTail(0.2231 vv 0.1306), LineTail(0.226 vv 0.1454), LineTail(0.2263 vv 0.1472), LineTail(0.2312 vv 0.1571), LineTail(0.2342 vv 0.1596), LineTail(0.2375 vv 0.1661), LineTail(0.2403 vv 0.1702), LineTail(0.2431 vv 0.1729), LineTail(0.2435 vv 0.1731), LineTail(0.2484 vv 0.1761), LineTail(0.2525 vv 0.1767), LineTail(0.2564 vv 0.1772), LineTail(0.2633 vv 0.1751), LineTail(0.2698 vv 0.1753), LineTail(0.271 vv 0.1754), LineTail(0.274 vv 0.1757), LineTail(0.2788 vv 0.1773), LineTail(0.2811 vv 0.1787), LineTail(0.2823 vv 0.1805), LineTail(0.2848 vv 0.1888), LineTail(0.2856 vv 0.1915), LineTail(0.2871 vv 0.1943), LineTail(0.296 vv 0.2045), LineTail(0.3027 vv 0.2107), LineTail(0.3177 vv 0.2217), LineTail(0.325 vv 0.2261), LineTail(0.3288 vv 0.2284), LineTail(0.3623 vv 0.2433), LineTail(0.3711 vv 0.2521), LineTail(0.3756 vv 0.2567), LineTail(0.3836 vv 0.2621), LineTail(0.393 vv 0.2659), LineTail(0.4011 vv 0.2723), LineTail(0.4029 vv 0.2746), LineTail(0.4051 vv 0.2817), LineTail(0.407 vv 0.2822), LineTail(0.4087 vv 0.2858), LineTail(0.4091 vv 0.2868), LineTail(0.4157 vv 0.2915), LineTail(0.4165 vv 0.2919), LineTail(0.4421 vv 0.3047), LineTail(0.4459 vv 0.3042), LineTail(0.4478 vv 0.3072), LineTail(0.4553 vv 0.3084), LineTail(0.4567 vv 0.3087), LineTail(0.4585 vv 0.3096), LineTail(0.4601 vv 0.3123), LineTail(0.4596 vv 0.3123), LineTail(0.4598 vv 0.3194), LineTail(0.4614 vv 0.3213), LineTail(0.4622 vv 0.326), LineTail(0.4631 vv 0.3271), LineTail(0.4639 vv 0.3282), LineTail(0.466 vv 0.3297), LineTail(0.4657 vv 0.3306), LineTail(0.4619 vv 0.3267)).fill(Colour(0xFFd57800))
