...
class W2TileOld(val x: Int, val y: Int, val terr: WTile) extends ETileOld
{
  ...
  override def toString: String = W2TileOld.persistImplicit.strT(this)
}
...
object W2TileOld
{
  ...
  implicit val persistImplicit: Persist[W2TileOld] = new Persist3[Int, Int, WTile, W2TileOld]("W2Tile", "x", _.x , "y", _.y, "terr", _.terr, apply)
}