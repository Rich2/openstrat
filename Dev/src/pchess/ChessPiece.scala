...
{ override def rtLine100: Pt2s = Pt2s(20 pp 80, 20 pp 20, 40 pp 20, 40 pp 0)
}

object Rook extends MirrorPiece
{ override def rtLine100: Pt2s = Pt2s(5 pp 100, 5 pp 95, 10 pp 95, 10 pp 100, 25 pp 100, 25 pp 80, 20 pp 80, 20 pp 75, 15 pp 75, 20 pp 15, 30 pp 10, 30 pp 0)
...
{ override def rtLine100: Pt2s = Pt2s(0 pp 100, 15 pp 75, 20 pp 75, 20 pp 70, 15 pp 70, 20 pp 30, 30 pp 10, 30 pp 0)
}

/** Chess Queen 2D outline. */
object Queen extends MirrorPiece
{ override def rtLine100: Pt2s = Pt2s(0 pp 100, 10 pp 90, 25 pp 100, 15 pp 75, 20 pp 75, 20 pp 70, 15 pp 70, 20 pp 30, 30 pp 10, 30 pp 0)
  //override def scaled = rtLine.yMirrorClose.slateY(-50).scale(0.01)
}

/** Chess King 2D outline. */
object King extends MirrorPiece
{ override def rtLine100: Pt2s = Pt2s(0 pp 100, 25 pp 100, 15 pp 75, 20 pp 75, 20 pp 70, 15 pp 70, 20 pp 30, 30 pp 10, 30 pp 0)
}
