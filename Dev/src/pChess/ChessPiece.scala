...
{
  def apply(): PolygonImp = ??? //Square.apply
}
object Pawn extends Piece with UnScaledPolygonYMirror
{
  def rtLine100: Pt2s = Pt2s(20 vv 80, 20 vv 20, 40 vv 20, 40 vv 0)
}

object Rook extends Piece with UnScaledPolygonYMirror
{ def rtLine100: Pt2s = Pt2s(5 vv 100, 5 vv 95, 10 vv 95, 10 vv 100, 25 vv 100, 25 vv 80, 20 vv 80, 20 vv 75, 15 vv 75, 20 vv 15, 30 vv 10, 30 vv 0)
...
{ def rtLine100: Pt2s = Pt2s(0 vv 100, 10 vv 90, 25 vv 100, 15 vv 75, 20 vv 75, 20 vv 70, 15 vv 70, 20 vv 30, 30 vv 10, 30 vv 0)
  //override def scaled = rtLine.yMirrorClose.slateY(-50).scale(0.01)
}
