...
{ override implicit val gridSys: HGrid = HGridReg(2, 12, 4, 40)
  ...
  override val sTerrs: HSideOptionalLayer[VSide, VSideSome] = gridSys.newSideOptLayer[VSide, VSideSome]
...
{ override val title: String = "CivRise Scen 2"
  ...
  val help = new VTerrSetter(gridSys, terrs, sTerrs, corners)
  {
    override val rowDatas: RArr[RowBase] = RArr(
      ...
      VRow(7, MouthUp(40, River)),
      TRow(6, Plain * 3, Sea * 2, Hland(3, 4, Mountain), Sea, Plain, Plain * 2),
      VRow(5, MouthUp(30), VertInDR(38, River, River), VertInUL(40, River, River)),
      TRow(4, Sea * 5, Mountain * 3, Plain * 2),
      VRow(3, MouthDn(30), MouthDL(36, River), MouthDR(40, River)),
      TRow(2, Plain * 10),
    )
  }
  help.run
