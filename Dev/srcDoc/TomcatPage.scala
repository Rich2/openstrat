...
{ override def head: HtmlHead = HtmlHead.titleCss("Apache Tomcat Server", "https://richstrat.com/Documentation/documentation")
  ...
  def steps = HtmlOl("""Lease a VPS. A virtual private server. The price of these have dropped considerably over the years and will almost certainly continue to
