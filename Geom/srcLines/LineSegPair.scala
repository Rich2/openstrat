...
object LineSegPairArr{
  implicit def pairArrFlatBuilder[B2](implicit ct: ClassTag[B2]): BuilderFlatArrPair[LineSeg, LineSegArr,B2, LineSegPairArr[B2]] = new LineSegPairArrFlatBuilder[B2]
}
...
{
  override def b1ArrBuilder: BuilderMapArr[LineSeg, LineSegArr] = LineSeg.arrMapbuilderEv
...
BuilderFlatArrPairDbl4[LineSeg, LineSegArr, B2, LineSegPairArr[B2]]
{ override implicit def b2ClassTag: ClassTag[B2] = ct
}