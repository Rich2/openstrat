...
case class CircleCompound(shape: Circle, facets: RArr[GraphicFacet], children: RArr[Graphic2Elem] = RArr()) extends ShapeCompound, CircleGraphic, Simil2Elem//s, AxisFree
