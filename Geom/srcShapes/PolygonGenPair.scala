...
object PolygonGenPair {
  implicit def buildImplicit[A2](implicit ct: ClassTag[A2]): BuilderArrMap[PolygonGenPair[A2], PolygonPairArr[A2]] = new PolygonPairBuilder[A2]
}

final class PolygonPairArr[A2](val a1ArrayDbls: Array[Array[Double]], val a2Array: Array[A2]) extends
  PolygonLikeDbl2PairArr[Pt2, PolygonGen, PolygonArr, A2, PolygonGenPair[A2]]
...
final class PolygonPairBuilder[A2](implicit val b2ClassTag: ClassTag[A2], @unused notB: Not[SpecialT]#L[A2]) extends
  PolygonLikeDblNPairArrBuilder[Pt2, PolygonGen, PolygonArr, A2, PolygonGenPair[A2], PolygonPairArr[A2]]
{ override type BuffT = PolygonPairBuff[A2]
  ...
  override def indexSet(seqLike: PolygonPairArr[A2], index: Int, elem: PolygonGenPair[A2]): Unit =
  ...
  override def b1ArrBuilder: BuilderArrMap[PolygonGen, PolygonArr] = PolygonGen.buildArrMapEv
...
class PolygonPairBuff[A2](val b1Buffer: ArrayBuffer[Array[Double]], val b2Buffer: ArrayBuffer[A2]) extends SeqLikeDblNPairBuff[Pt2, PolygonGen, A2, PolygonGenPair[A2]]
