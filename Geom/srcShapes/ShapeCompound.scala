...
{ final override def attribs: RArr[XAtt] = shapeAttribs ++ facets.flatMap(_.attribs)
  ...
  override def mirror(lineLike: LineLike): ShapeCompound
...
{ /** Implicit [[Slate2]] type class instance / instance for [[ShapeCompound]]. */
  ...
  { override def slateT(obj: ShapeCompound, operand: VecPt2): ShapeCompound = obj.slate(operand)
  ...
  /** Implicit [[MirrorAxes]] type class instance / instance for [[ShapeCompound]]. */
  given mirrorAxesEv: MirrorAxes[ShapeCompound] = new MirrorAxes[ShapeCompound]
...
{ /** The child graphics of this compound 2-dimensional [[Length]] based graphic. */
