...
final case class LineSegLL private(startSecsLat: Double, startSecsLong: Double, endSecsLat: Double, endSecsLong: Double) extends LineSegLike[LatLong]
{ def startPt = LatLong.secs(startSecsLat, startSecsLong)
  def endPt = LatLong.secs(endSecsLat, endSecsLong)
}
