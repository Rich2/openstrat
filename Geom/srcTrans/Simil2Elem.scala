...
object Simil2Trans
{
  given transSimerImplicit[T <: SimilarPreserve]: Simil2Trans[T] = new Simil2Trans[T]
  ...
  given arrImplicit[A, AA <: Arr[A]](using build: BuilderArrMap[A, AA], ev: Simil2Trans[A]): Simil2Trans[AA] = new Simil2Trans[AA]
  ...
  given functorImplicit[A, F[_]](using evF: Functor[F], evA: Simil2Trans[A]): Simil2Trans[F[A]] = new Simil2Trans[F[A]]
  ...
  given arrayImplicit[A](using ct: ClassTag[A], ev: Simil2Trans[A]): Simil2Trans[Array[A]] = new Simil2Trans[Array[A]]
