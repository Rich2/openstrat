...
{ val el1: Ellipse = Ellipse(400, 250, -300, 0)
  ...
  val p0: RArr[GraphicSvgElem] = el1.p0.textArrow("p0")
  val p1: RArr[GraphicSvgElem] = el1.p1.textArrow("p1")
  val p2: RArr[GraphicSvgElem] = el1.p2.textArrow("p2")
  val p3: RArr[GraphicSvgElem] = el1.p3.textArrow("p3")

  val cen1: RArr[GraphicSvgElem] = el1.cen.textArrow("centre")
  val stuff = RArr(el1.fill(Red), el2.fillDraw(Colour.BurlyWood)) ++ p0 ++ p1 ++ p2 ++ p3 ++ cen1
