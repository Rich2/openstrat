...
{ override def typeStr: String = "Kilometres"
  ...
  @inline override def femtometresNum: Double = kilometresNum * 1e18
...
{ override def typeStr: String = "Megametres"
  ...
  @inline override def femtometresNum: Double = megametresNum * 1e21
...
{ override def typeStr: String = "Gigametres"
  ...
  @inline override def femtometresNum: Double = gigametresNum * 1e24
...
{ override def typeStr: String = "Millimetres"
  ...
  @inline override def femtometresNum: Double = millimetresNum * 1e12
...
{ override def typeStr: String = "Micrometres"
  ...
  @inline override def femtometresNum: Double = micrometresNum * 1e9
...
{ override def typeStr: String = "Nanometres"
  ...
  @inline override def femtometresNum: Double = nanometresNum * 1e6
...
{ override def typeStr: String = "Angstroms"
  ...
  @inline override def femtometresNum: Double = angstromsNum * 1e5
...
{ override def typeStr: String = "Picometres"
  ...
  @inline override def femtometresNum: Double = picometresNum * 1e3
...
{ override def typeStr: String = "Femtometres"
  ...
  override def endingStr: String = "pm"
  override def compare(that: Length): Int = femtometresNum.compare(that.femtometresNum)
  @inline override def metresNum: Double = femtometresNum * 1e-15
  @inline override def kilometresNum: Double = femtometresNum * 1e-18
  @inline override def megametresNum: Double = femtometresNum * 1e-21
  @inline override def gigametresNum: Double = femtometresNum * 1e-24
  @inline override def millimetresNum: Double = femtometresNum * 1e-12
  @inline override def micrometresNum: Double = femtometresNum * 1e-9
  @inline override def nanometresNum: Double = femtometresNum * 1e-6
  @inline override def angstromsNum: Double = femtometresNum * 1e-5
  @inline override def picometresNum: Double = femtometresNum * 1e-3
  override def +(operand: Length): Femtometres = Femtometres(femtometresNum + operand.femtometresNum)
  override def -(operand: Length): Femtometres = Femtometres(femtometresNum - operand.femtometresNum)
  override def unary_- : Femtometres = Femtometres(-femtometresNum)
  override def *(operand: Double): Femtometres = Femtometres(femtometresNum * operand)
  override def toRectArea(operand: Length): Millares = Millares(millimetresNum * operand.millimetresNum)
  override def /(operand: Double): Femtometres = Femtometres(femtometresNum / operand)
  override def divByLength(operand: Length): Double = femtometresNum / operand.femtometresNum
  override def max(operand: LengthMetric): Femtometres = Femtometres(femtometresNum.max(operand.femtometresNum))
  override def min(operand: LengthMetric): Femtometres = Femtometres(femtometresNum.min(operand.femtometresNum))
  override def nonNeg: Boolean = femtometresNum >= 0
  override def pos: Boolean = femtometresNum > 0
  override def neg: Boolean = femtometresNum < 0
}

object Femtometres
{ /** Factory apply method for [[Femtometres]]. */
  def apply(femtometresNum: Double): Femtometres = new Femtometres(femtometresNum)

  implicit class LengthMetricExtensions(thisLength: Femtometres)
  { /** Extension operator method to produce [[Millares]], multiplying this [[Femtometres]] by an operand [[Length]]. */
    def *(operand: Length): Millares = thisLength.toRectArea(operand)
  }
}