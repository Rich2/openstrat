...
/** A quasi line path specified in 3D metre points. The points do not have to lie within the same plane. I'm not sure how useful this class will prove. It has
 * been created for the intermediary step of converting from [[pglobe.LinePathLL]]s to [[LinePathKm2]]s on world maps. */
class LinePathKm3(val arrayUnsafe: Array[Double]) extends AnyVal, LinePathDbl3[PtKm3]
...
{ override def fromArray(array: Array[Double]): LinePathKm3 = new LinePathKm3(array)
  ...
  given persistEv: PersistSeqSpecBoth[PtKm3, LinePathKm3] = PersistSeqSpecBoth[PtKm3, LinePathKm3]("LinePathKm3")
}