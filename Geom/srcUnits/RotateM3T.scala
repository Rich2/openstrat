...
/** Type class for 3D [[Metre]] geometric rotation transformations of objects of type T. */
trait RotateM3T[T]
...
object RotateM3T
{
  implicit def arrImplicit[A, AA <: Arr[A]](implicit build: BuilderArrMap[A, AA], ev: RotateM3T[A]): RotateM3T[AA] = new RotateM3T[AA]
...
/** Implementations for Type class for 3D [[Metre]] geometric rotation transformations of objects of type T. */
