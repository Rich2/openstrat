 ...
 *  maps. */
final class PolygonM3(val unsafeArray: Array[Double]) extends AnyVal with PolygonDbl3[PtM3]
...
{ override def fromArray(array: Array[Double]): PolygonM3 = new PolygonM3(array)
  ...
  implicit val arrBuildImplicit: ArrMapBuilder[PolygonM3, PolygonM3Arr] = new ArrMapBuilder[PolygonM3, PolygonM3Arr] {
    ...
    override def indexSet(arr: PolygonM3Arr, index: Int, value: PolygonM3): Unit = arr.unsafeArrayOfArrays(index) = value.unsafeArray
