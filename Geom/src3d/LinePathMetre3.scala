...
class LinePathMetre3(val unsafeArray: Array[Double]) extends AnyVal with LinePathDbl3s[PtM3]
{
...
object LinePathMetre3 extends Dbl3SeqDefCompanion[PtM3, LinePathMetre3]
