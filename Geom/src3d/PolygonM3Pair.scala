...
class PolygonM3PairBuff[A2](val a1Buffer: ArrayBuffer[Array[Double]], val a2Buffer: ArrayBuffer[A2]) extends
  SeqLikeDblNPairBuff[PtM3, PolygonM3, A2, PolygonM3Pair[A2]]
{ override type ThisT = PolygonM3PairBuff[A2]
  override def unsafeSetElem(i: Int, value: PolygonM3Pair[A2]): Unit = { a1Buffer(i) = value.a1ArrayDbl; a2Buffer(i) = value.a2 }
  override def fElemStr: PolygonM3Pair[A2] => String = _.toString
