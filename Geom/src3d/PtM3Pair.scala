...
class PtM3PairArrBuider[A2](implicit val b2ClassTag: ClassTag[A2]) extends Dbl3PairArrBuilder[PtM3, PtM3Arr, A2, PtM3Pair[A2], PtM3PairArr[A2]]
{ override type BuffT = PtM3PairBuff[A2]
  override def b1ArrBuilder: ArrMapBuilder[PtM3, PtM3Arr] = PtM3.arrBuilderImplicit
  ...
  override def fromBuffs(a1Buff: B1BuffT, b2s: ArrayBuffer[A2]): PtM3PairArr[A2] = new PtM3PairArr[A2](a1Buff.toArray, b2s.toArray)
}