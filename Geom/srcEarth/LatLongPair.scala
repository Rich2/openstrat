...
{ override type ThisT = LatLongPairArr[A2]
  ...
  override def fromArrays(a1Array: Array[Double], a2Array: Array[A2]): LatLongPairArr[A2] = new LatLongPairArr[A2](a1ArrayDbl, a2Array)
...
{ override type BuffT = LatLongPairBuff[B2]
  ...
  override def b1ArrBuilder: BuilderArrMap[LatLong, LatLongArr] = LatLong.builderArrMapEv
  override def arrFromArrAndArray(b1Arr: LatLongArr, b2s: Array[B2]): LatLongPairArr[B2] = new LatLongPairArr[B2](b1Arr.arrayUnsafe, b2s)
