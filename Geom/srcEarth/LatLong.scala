...
{ override type ThisT = LatLong
 ...
 def andDirn(dirn: NorthSouthUp = NorthUp): LatLongDirn = LatLongDirn.milliSecs(dbl1, dbl2, dirn)
  ...
  { /** This factor reduces the value of X and Z as latitudes move towards the Poles. */
    ...
    PtM3(equatorialRadius * longSine * clat, polarRadius * latSine, equatorialRadius * longCos * clat)
  }
  ...
  { /** This factor reduces the value of X and Z as latitudes move towards the Poles. */
    val clat = latRadians.cos.abs
    PtKm3(equatorialRadius * longSine * clat, polarRadius * latSine, equatorialRadius * longCos * clat)
  }
