...
abstract class SqlignLen2[VT <: PtLen2](val width: Length, val cenX: Length, val cenY: Length) extends SquareLen2[VT], RectLen2[VT]
{ type ThisT = SqlignLen2[VT]
 ...
 // override def rotate90: PolygonLen2[VT] = ???
  //override def rotate180: PolygonLen2[VT] = ???
  //override def rotate270: PolygonLen2[VT] = ???
