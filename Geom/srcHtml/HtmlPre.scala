...
{ /** Factory apply method to create an HTML pre element. */
  ...
  def inputText(input: UpdaterInputText)(f: String => String, otherAttribs: XAtt*): HtmlPre =
  ...
  def input2Text(input1: UpdaterInputText, input2: UpdaterInputText, otherAttribs: XAtt*)(f: (String, String) => String): HtmlPre =
