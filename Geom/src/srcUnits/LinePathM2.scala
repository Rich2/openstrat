 ...
 * converting from [[pglobe.LinePathLL]]s to [[LinePath]]s on world maps. */
...
{ override def fromArray(array: Array[Double]): LinePathM2 = new LinePathM2(array)
  ...
  given persistEv: PersistSeqSpecBoth[PtM2, LinePathM2] = PersistSeqSpecBoth[PtM2, LinePathM2]("LinePathM2")
}