...
{ type ThisT = PolygonFm2
  ...
  override def revY: PolygonFm2 = map(_.negY)
...
{ /** Factory apply method for creating an empty [[PolygonFm2Buff]]. Not to be confused with a [[PtFm2Buff]]. */
...
{ override type BuffT = PolygonFm2PairBuff[A2]
  ...
  override def b1Builder: BuilderPolygonLikeMap[PtFm2, PolygonFm2] = PtFm2.polygonBuildEv
...
class PolygonFm2PairBuff[A2](val b1Buffer: ArrayBuffer[Array[Double]], val b2Buffer: ArrayBuffer[A2]) extends
  BuffPairSeqLikeDblN[PtFm2, PolygonFm2, A2, PolygonFm2Pair[A2]]
