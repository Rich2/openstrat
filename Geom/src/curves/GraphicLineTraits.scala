...
object LinesDraw
{
  implicit val persistImplicit: PersistPrec3[LineSegs, Double, Colour, LinesDraw] =
    PersistPrec3("LinesDraw", "lines", _.lines, "lineWidth", _.lineWidth, "colour", _.colour, apply)
}
