...
trait RectS2S4 extends Rectangle
{
  ...
  final override def v0: Pt2 = sd2Cen + yVec2(width2 / 2).rotate(alignAngle)
  ...
  @inline final def v2: Pt2 = sd4Cen + yVec2(-width2 / 2).rotate(alignAngle)
  ...
  final override def sd1Cen: Pt2 = v3 midPt v0
  final override def sd3Cen: Pt2 = v1 midPt v2
