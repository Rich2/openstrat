...
{ inline def startX: Double = a1Dbl1
  ...
  override def a1: LSeg2 = new LSeg2(startX, startY, endX, endY)
}

object LineSegPair
{ def apply[A2](ls: LSeg2, a2: A2): LineSegPair[A2] = new LineSegPair[A2](ls.dbl1, ls.dbl2, ls.dbl3, ls.dbl4, a2)
}
...
{ override type ThisT = LineSegPairArr[A2]
  ...
  override def a1FromDbls(dbl1: Double, dbl2: Double, dbl3: Double, dbl4: Double): LSeg2 = new LSeg2(dbl1, dbl2, dbl3, dbl4)
...
object LineSegPairArr{
  implicit def pairArrFlatBuilder[B2](implicit ct: ClassTag[B2]): BuilderFlatArrPair[LSeg2, LSeg2Arr,B2, LineSegPairArr[B2]] = new LineSegPairArrFlatBuilder[B2]
}
...
trait LineSegPairArrCommonBuilder[B2] extends BuilderArrPairDbl4[LSeg2, LSeg2Arr, B2, LineSegPairArr[B2]]
{ override type BuffT = LineSegPairBuff[B2]
  override type B1BuffT = LSeg2Buff
  override def newB1Buff(): LSeg2Buff = LSeg2Buff()
...
BuilderFlatArrPairDbl4[LSeg2, LSeg2Arr, B2, LineSegPairArr[B2]]
{ override implicit def b2ClassTag: ClassTag[B2] = ct
}