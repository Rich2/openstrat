...
{ /** Factory method for Angle from number of degrees */
  ...
  { /** Subtracting one angle of inclination from another angle of inclination returns an angle of rotation. */
    ...
    def toPtM2(operand: Metre): PtM2 = PtM2(operand * thisAngle.cos, operand * thisAngle.sin)
    def toPtM3(operand: Metre, zValue: Metre = 0.metre): PtM3 = PtM3(operand * thisAngle.cos, operand * thisAngle.sin, zValue)
  }
