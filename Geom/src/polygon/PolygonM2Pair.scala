...
class PolygonM2PairBuff[A2](val arrayDoubleBuff: ArrayBuffer[Array[Double]], val a2Buffer: ArrayBuffer[A2]) extends SeqLikePairBuff[PtM2, PolygonM2, A2, PolygonM2Pair[A2]]
