...
trait PolygonLikeDblsPair[A1V <: ElemDblN, A1 <: PolygonDblN[A1V], A2] extends PolygonLikePair[A1V, A1, A2]
{
  def unsafeArray: Array[Double]
}

trait PolygonDblsLikePairArr[A1V <: ElemDblN, A1 <: PolygonDblN[A1V], ArrA1 <: Arr[A1], A2, A <: PolygonLikeDblsPair[A1V, A1, A2]] extends
  PolygonLikePairArr[A1V, A1, ArrA1, A2, A]
{
  type ThisT <: PolygonDblsLikePairArr[A1V, A1, ArrA1, A2, A]
...
trait PolygonDblsLikePairArrBuilder[B1V <: ElemDblN, B1 <: PolygonDblN[B1V], ArrB1 <: Arr[B1], A2, B <: PolygonLikeDblsPair[B1V, B1, A2],
