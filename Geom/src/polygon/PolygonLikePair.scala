...
{
  def newArr(newPolygonArr: ArrB, a2Arr: Arr[A2]): ArrB
...
{
  override def newArr(newPolygonArr: ArrB, a2Arr: Arr[A2]): ArrB = fromArrayArrayDbl(newPolygonArr.arrayArrayDbl, a2Arr)
