...
trait PointPair[A1 <: Point, A2] extends PairNoA1ParamElem[A1, A2]

trait PointPairArr[A1 <: Point, ArrA1 <: Arr[A1], A2, A <: PointPair[A1, A2]] extends PairNoA1PramArr[A1, ArrA1, A2, A]
...
trait PointDblNPairArr[A1 <: PointDblN, ArrA1 <: ArrDblN[A1], A2, A <: PointDblNPair[A1, A2]] extends PointPairArr[A1, ArrA1, A2, A] with PairArrDblN[A1, ArrA1, A2, A]
...
trait PointDbl3PairArr[A1 <: PointDbl3, ArrA1 <: ArrDbl3[A1], A2, A <: PointDbl3Pair[A1, A2]] extends PointDblNPairArr[A1, ArrA1, A2, A] with
